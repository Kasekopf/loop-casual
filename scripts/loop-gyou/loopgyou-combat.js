...
/* harmony export */ });
/* unused harmony exports $bounty, $bounties, $class, $classes, $coinmaster, $coinmasters, $effect, $effects, $element, $elements, $familiar, $familiars, $location, $locations, $phylum, $phyla, $servant, $servants, $slots, $stats, $thrall, $thralls */
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7530);
/* harmony import */ var kolmafia__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(kolmafia__WEBPACK_IMPORTED_MODULE_0__);
...
function main() {
  libram__WEBPACK_IMPORTED_MODULE_1__/* .Macro.load */ .LE.load().submit();
}
