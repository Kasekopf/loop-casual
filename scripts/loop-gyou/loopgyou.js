...
function getRelevantEffects() {
  ...
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Clan VIP Lounge key"])))) && (!(0,property/* get */.U2)("_olympicSwimmingPool") || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Silent Running"])))))) result["-combat"].push((0,template_string/* $effect */._G)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["Silent Running"])))); // Noncombat/combat buffs

  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["Phase Shift"]))))) result["-combat"].push((0,template_string/* $effect */._G)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["Shifted Phase"]))));
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["Photonic Shroud"]))))) result["-combat"].push((0,template_string/* $effect */._G)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["Darkened Photons"]))));
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["Piezoelectric Honk"]))))) result["+combat"].push((0,template_string/* $effect */._G)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["Hooooooooonk!"]))));
...
function moodCompatible(modifier) {
  ...
  if (modifier.includes("+combat") || modifier.includes(" combat")) {
    ...
    return !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["Shifted Phase"])))) && !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["Darkened Photons"]))));
  }

  if (modifier.includes("-combat")) {
    // eslint-disable-next-line libram/verify-constants
    return !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["Hooooooooonk!"]))));
  }
...
function applyEffects(modifier, required) {
  ...
  var mpcosts = new Map([[(0,template_string/* $effect */._G)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["Shifted Phase"]))), 50], [(0,template_string/* $effect */._G)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["Hooooooooonk!"]))), 50], [(0,template_string/* $effect */._G)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["Darkened Photons"]))), 40]]); // Apply all relevant effects
...
function swapEquipmentForMp(mpgoal) {
  ...
  try {
    var _loop = function _loop() {
      ...
      if (slot === (0,template_string/* $slot */.Jh)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["weapon"]))) || slot === (0,template_string/* $slot */.Jh)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["off-hand"])))) return "continue"; // skip weapon handedness (for now)

      var item = (0,external_kolmafia_.equippedItem)(slot);
      if (item === (0,template_string/* $item */.xr)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["none"])))) return "continue"; // Find an item in the same slot that gives more max MP

      var canonical_slot = slot === (0,template_string/* $slot */.Jh)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["acc3"]))) ? (0,template_string/* $slot */.Jh)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["acc1"]))) : slot === (0,template_string/* $slot */.Jh)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["acc2"]))) ? (0,template_string/* $slot */.Jh)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["acc1"]))) : slot;
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { yellowray_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function yellowray(task, alternativeOutfit) {
  var _ref, _task$combat;

  for (var _len = arguments.length, monsters = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    monsters[_key - 2] = arguments[_key];
  }
  ...
  return _objectSpread(_objectSpread({}, task), {}, {
    ready: state => {
      ...
      return ((_task$ready = (_task$ready2 = task.ready) === null || _task$ready2 === void 0 ? void 0 : _task$ready2.call(task, state)) !== null && _task$ready !== void 0 ? _task$ready : true) && ((0,lib/* have */.lf)((0,template_string/* $effect */._G)(yellowray_templateObject || (yellowray_templateObject = yellowray_taggedTemplateLiteral(["Everything Looks Yellow"])))) || (0,external_kolmafia_.myMeat)() >= 250 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(yellowray_templateObject2 || (yellowray_templateObject2 = yellowray_taggedTemplateLiteral(["yellow rocket"])))));
    },
    acquire: () => {
      var _task$acquire;
      ...
      return [].concat(yellowray_toConsumableArray(acquire), [{
        item: (0,template_string/* $item */.xr)(yellowray_templateObject3 || (yellowray_templateObject3 = yellowray_taggedTemplateLiteral(["yellow rocket"]))),
        useful: () => !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(yellowray_templateObject4 || (yellowray_templateObject4 = yellowray_taggedTemplateLiteral(["Everything Looks Yellow"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(yellowray_templateObject5 || (yellowray_templateObject5 = yellowray_taggedTemplateLiteral(["Clan VIP Lounge key"]))))
      }]);
    },
    priority: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(yellowray_templateObject6 || (yellowray_templateObject6 = yellowray_taggedTemplateLiteral(["Everything Looks Yellow"])))) ? OverridePriority.BadYR : (0,lib/* have */.lf)((0,template_string/* $item */.xr)(yellowray_templateObject7 || (yellowray_templateObject7 = yellowray_taggedTemplateLiteral(["Clan VIP Lounge key"])))) ? OverridePriority.YR : OverridePriority.None,
    combat: (_ref = (_task$combat = task.combat) !== null && _task$combat !== void 0 ? _task$combat : new src_combat.CombatStrategy()).macro.apply(_ref, [() => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(yellowray_templateObject8 || (yellowray_templateObject8 = yellowray_taggedTemplateLiteral(["Everything Looks Yellow"])))) ? new dist_combat/* Macro */.LE() : dist_combat/* Macro.tryItem */.LE.tryItem((0,template_string/* $item */.xr)(yellowray_templateObject9 || (yellowray_templateObject9 = yellowray_taggedTemplateLiteral(["yellow rocket"]))))].concat(monsters)),
    outfit: state => {
      var spec = typeof task.outfit === "function" ? task.outfit(state) : task.outfit;
      return (0,lib/* have */.lf)((0,template_string/* $effect */._G)(yellowray_templateObject10 || (yellowray_templateObject10 = yellowray_taggedTemplateLiteral(["Everything Looks Yellow"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(yellowray_templateObject11 || (yellowray_templateObject11 = yellowray_taggedTemplateLiteral(["Clan VIP Lounge key"])))) ? alternativeOutfit : spec;
    }
  });
}
;// CONCATENATED MODULE: ./src/tasks/level12.ts
var level12_templateObject, level12_templateObject2, level12_templateObject3, level12_templateObject4, level12_templateObject5, level12_templateObject6, level12_templateObject7, level12_templateObject8, level12_templateObject9, level12_templateObject10, level12_templateObject11, _CombatStrategy, level12_templateObject12, level12_templateObject13, level12_templateObject14, level12_templateObject15, level12_templateObject16, level12_templateObject17, level12_templateObject18, level12_templateObject19, level12_templateObject20, level12_templateObject21, level12_templateObject22, level12_templateObject23, level12_templateObject24, level12_templateObject25, level12_templateObject26, level12_templateObject27, level12_templateObject28, level12_templateObject29, level12_templateObject30, level12_templateObject31, _templateObject32, _templateObject33, _templateObject34, _templateObject35, _templateObject36, _templateObject37, _templateObject38, _templateObject39, _templateObject40, _templateObject41, _templateObject42, _templateObject43, _templateObject44, _templateObject45, _templateObject46, _templateObject47, _templateObject48, _templateObject49, _templateObject50, _templateObject51, _templateObject52, _templateObject53, _templateObject54, _templateObject55, _templateObject56, _templateObject57, _templateObject58, _templateObject59, _templateObject60, _templateObject61, _templateObject62, _templateObject63, _templateObject64, _templateObject65, _templateObject66, _templateObject67, _templateObject68, _templateObject69, _templateObject70, _templateObject71, _templateObject72, _templateObject73, _templateObject74, _templateObject75, _templateObject76, _templateObject77, _templateObject78, _templateObject79, _templateObject80, _templateObject81, _templateObject82, _templateObject83, _templateObject84, _templateObject85, _templateObject86, _templateObject87, _templateObject88, _templateObject89, _templateObject90, _templateObject91, _templateObject92, _templateObject93, _templateObject94, _templateObject95, _templateObject96, _templateObject97, _templateObject98, _templateObject99, _templateObject100, _templateObject101, _templateObject102, _templateObject103, _templateObject104, _templateObject105, _templateObject106, _templateObject107, _templateObject108, _templateObject109, _templateObject110, _templateObject111, _templateObject112, _templateObject113, _templateObject114, _templateObject115, _templateObject116, _templateObject117, _templateObject118, _templateObject119, _templateObject120, _templateObject121, _templateObject122, _templateObject123, _templateObject124, _templateObject125, _templateObject126, _templateObject127, _templateObject128;
...
function flyersDone() {
  return (0,property/* get */.U2)("flyeredML") >= 10000;
}
var Flyers = [{
  name: "Flyers Start",
  after: ["Enrage"],
  ...
  do: () => {
    ...
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject4 || (level12_templateObject4 = level12_taggedTemplateLiteral(["rock band flyers"]))))) {
      debug("Mafia tracking was incorrect for rock band flyers; continuing to flyer...");
      (0,property/* set */.t8)("_loopgyou_flyeredML_buffer", (0,property/* get */.U2)("_loopgyou_flyeredML_buffer", 0) + ((0,property/* get */.U2)("flyeredML") - 9900));
      (0,property/* set */.t8)("flyeredML", 9900);
    } else if ((0,property/* get */.U2)("_loopgyou_flyeredML_buffer", 0) > 0) {
      debug("Mafia tracking was incorrect for rock band flyers; quest completed at ".concat((0,property/* get */.U2)("flyeredML") + (0,property/* get */.U2)("_loopgyou_flyeredML_buffer", 0)));
    }
  },
  freeaction: true,
  limit: {
...
var Lighthouse = [// Use CMG to replace a void monster into a Lobsterfrogman, then backup into the Boss Bat's lair
{
  ...
  completed: () => (0,property/* get */.U2)("lastCopyableMonster") === (0,template_string/* $monster */.O4)(level12_templateObject5 || (level12_templateObject5 = level12_taggedTemplateLiteral(["lobsterfrogman"]))) || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level12_templateObject6 || (level12_templateObject6 = level12_taggedTemplateLiteral(["barrel of gunpowder"])))) >= 5 || (0,property/* get */.U2)("sidequestLighthouseCompleted") !== "none" || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject7 || (level12_templateObject7 = level12_taggedTemplateLiteral(["cursed magnifying glass"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject8 || (level12_templateObject8 = level12_taggedTemplateLiteral(["Powerful Glove"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject9 || (level12_templateObject9 = level12_taggedTemplateLiteral(["backup camera"])))),
  do: (0,template_string/* $location */.PG)(level12_templateObject10 || (level12_templateObject10 = level12_taggedTemplateLiteral(["Sonofa Beach"]))),
  outfit: {
    equip: (0,template_string/* $items */.vS)(level12_templateObject11 || (level12_templateObject11 = level12_taggedTemplateLiteral(["cursed magnifying glass, Powerful Glove"])))
  },
  combat: (_CombatStrategy = new src_combat.CombatStrategy()).macro.apply(_CombatStrategy, [new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(level12_templateObject12 || (level12_templateObject12 = level12_taggedTemplateLiteral(["CHEAT CODE: Replace Enemy"]))))].concat(level12_toConsumableArray((0,template_string/* $monsters */.fr)(level12_templateObject13 || (level12_templateObject13 = level12_taggedTemplateLiteral(["void guy, void slab, void spider"])))))).kill((0,template_string/* $monster */.O4)(level12_templateObject14 || (level12_templateObject14 = level12_taggedTemplateLiteral(["lobsterfrogman"])))),
  limit: {
    tries: 1
  }
}, {
  ...
  completed: () => (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level12_templateObject15 || (level12_templateObject15 = level12_taggedTemplateLiteral(["barrel of gunpowder"])))) >= 5 || (0,property/* get */.U2)("sidequestLighthouseCompleted") !== "none",
  do: (0,template_string/* $location */.PG)(level12_templateObject16 || (level12_templateObject16 = level12_taggedTemplateLiteral(["Sonofa Beach"]))),
  outfit: {
    modifier: "+combat"
  },
  combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level12_templateObject17 || (level12_templateObject17 = level12_taggedTemplateLiteral(["lobsterfrogman"])))),
  limit: {
    soft: 40
  }
}, {
  ...
  outfit: {
    equip: (0,template_string/* $items */.vS)(level12_templateObject18 || (level12_templateObject18 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: () => {
...
var Junkyard = [{
  name: "Junkyard Start",
  after: ["Enrage"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject19 || (level12_templateObject19 = level12_taggedTemplateLiteral(["molybdenum magnet"])))) || (0,property/* get */.U2)("sidequestJunkyardCompleted") !== "none",
  outfit: {
    equip: (0,template_string/* $items */.vS)(level12_templateObject20 || (level12_templateObject20 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: () => {
  ...
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject21 || (level12_templateObject21 = level12_taggedTemplateLiteral(["molybdenum hammer"])))) || (0,property/* get */.U2)("sidequestJunkyardCompleted") !== "none",
  acquire: [{
    item: (0,template_string/* $item */.xr)(level12_templateObject22 || (level12_templateObject22 = level12_taggedTemplateLiteral(["seal tooth"])))
  }],
  outfit: {
    equip: (0,template_string/* $items */.vS)(level12_templateObject23 || (level12_templateObject23 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: (0,template_string/* $location */.PG)(level12_templateObject24 || (level12_templateObject24 = level12_taggedTemplateLiteral(["Next to that Barrel with Something Burning in it"]))),
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().while_("!match whips out && !times 28 && !hpbelow 30", new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(level12_templateObject25 || (level12_templateObject25 = level12_taggedTemplateLiteral(["seal tooth"]))))).if_("match whips out", new dist_combat/* Macro */.LE().item("molybdenum magnet")), (0,template_string/* $monster */.O4)(level12_templateObject26 || (level12_templateObject26 = level12_taggedTemplateLiteral(["batwinged gremlin (tool)"])))).banish((0,template_string/* $monster */.O4)(level12_templateObject27 || (level12_templateObject27 = level12_taggedTemplateLiteral(["A.M.C. gremlin"])))).kill((0,template_string/* $monster */.O4)(level12_templateObject28 || (level12_templateObject28 = level12_taggedTemplateLiteral(["batwinged gremlin (tool)"])))),
  limit: {
    soft: 15
  }
}, {
  ...
  after: ["Junkyard Start"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level12_templateObject29 || (level12_templateObject29 = level12_taggedTemplateLiteral(["molybdenum crescent wrench"])))) || (0,property/* get */.U2)("sidequestJunkyardCompleted") !== "none",
  acquire: [{
    item: (0,template_string/* $item */.xr)(level12_templateObject30 || (level12_templateObject30 = level12_taggedTemplateLiteral(["seal tooth"])))
  }],
  outfit: {
    equip: (0,template_string/* $items */.vS)(level12_templateObject31 || (level12_templateObject31 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: (0,template_string/* $location */.PG)(_templateObject32 || (_templateObject32 = level12_taggedTemplateLiteral(["Over Where the Old Tires Are"]))),
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().while_("!match whips out && !times 28 && !hpbelow 30", new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(_templateObject33 || (_templateObject33 = level12_taggedTemplateLiteral(["seal tooth"]))))).if_("match whips out", new dist_combat/* Macro */.LE().item("molybdenum magnet")), (0,template_string/* $monster */.O4)(_templateObject34 || (_templateObject34 = level12_taggedTemplateLiteral(["erudite gremlin (tool)"])))).banish((0,template_string/* $monster */.O4)(_templateObject35 || (_templateObject35 = level12_taggedTemplateLiteral(["A.M.C. gremlin"])))).kill((0,template_string/* $monster */.O4)(_templateObject36 || (_templateObject36 = level12_taggedTemplateLiteral(["erudite gremlin (tool)"])))),
  limit: {
    soft: 15
  }
}, {
  ...
  after: ["Junkyard Start"],
  acquire: [{
    item: (0,template_string/* $item */.xr)(_templateObject37 || (_templateObject37 = level12_taggedTemplateLiteral(["seal tooth"])))
  }],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject38 || (_templateObject38 = level12_taggedTemplateLiteral(["molybdenum pliers"])))) || (0,property/* get */.U2)("sidequestJunkyardCompleted") !== "none",
  outfit: {
    equip: (0,template_string/* $items */.vS)(_templateObject39 || (_templateObject39 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: (0,template_string/* $location */.PG)(_templateObject40 || (_templateObject40 = level12_taggedTemplateLiteral(["Near an Abandoned Refrigerator"]))),
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().while_("!match whips out && !times 28 && !hpbelow 30", new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(_templateObject41 || (_templateObject41 = level12_taggedTemplateLiteral(["seal tooth"]))))).if_("match whips out", new dist_combat/* Macro */.LE().item("molybdenum magnet")), (0,template_string/* $monster */.O4)(_templateObject42 || (_templateObject42 = level12_taggedTemplateLiteral(["spider gremlin (tool)"])))).banish((0,template_string/* $monster */.O4)(_templateObject43 || (_templateObject43 = level12_taggedTemplateLiteral(["A.M.C. gremlin"])))).kill((0,template_string/* $monster */.O4)(_templateObject44 || (_templateObject44 = level12_taggedTemplateLiteral(["spider gremlin (tool)"])))),
  limit: {
    soft: 15
  }
}, {
  ...
  after: ["Junkyard Start"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject45 || (_templateObject45 = level12_taggedTemplateLiteral(["molybdenum screwdriver"])))) || (0,property/* get */.U2)("sidequestJunkyardCompleted") !== "none",
  acquire: [{
    item: (0,template_string/* $item */.xr)(_templateObject46 || (_templateObject46 = level12_taggedTemplateLiteral(["seal tooth"])))
  }],
  outfit: {
    equip: (0,template_string/* $items */.vS)(_templateObject47 || (_templateObject47 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: (0,template_string/* $location */.PG)(_templateObject48 || (_templateObject48 = level12_taggedTemplateLiteral(["Out by that Rusted-Out Car"]))),
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().while_("!match whips out && !times 28 && !hpbelow 30", new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(_templateObject49 || (_templateObject49 = level12_taggedTemplateLiteral(["seal tooth"]))))).if_("match whips out", new dist_combat/* Macro */.LE().item("molybdenum magnet")), (0,template_string/* $monster */.O4)(_templateObject50 || (_templateObject50 = level12_taggedTemplateLiteral(["vegetable gremlin (tool)"])))).banish((0,template_string/* $monster */.O4)(_templateObject51 || (_templateObject51 = level12_taggedTemplateLiteral(["A.M.C. gremlin"])))).kill((0,template_string/* $monster */.O4)(_templateObject52 || (_templateObject52 = level12_taggedTemplateLiteral(["vegetable gremlin (tool)"])))),
  limit: {
    soft: 15
  }
}, {
  ...
  outfit: {
    equip: (0,template_string/* $items */.vS)(_templateObject53 || (_templateObject53 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: () => {
    (0,external_kolmafia_.visitUrl)("bigisland.php?action=junkman&pwd");
  },
...
var Orchard = [yellowray({
  ...
  after: ["Enrage"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject54 || (_templateObject54 = level12_taggedTemplateLiteral(["filthworm hatchling scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject55 || (_templateObject55 = level12_taggedTemplateLiteral(["Filthworm Larva Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject56 || (_templateObject56 = level12_taggedTemplateLiteral(["filthworm drone scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject57 || (_templateObject57 = level12_taggedTemplateLiteral(["Filthworm Drone Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject58 || (_templateObject58 = level12_taggedTemplateLiteral(["filthworm royal guard scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject59 || (_templateObject59 = level12_taggedTemplateLiteral(["Filthworm Guard Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject60 || (_templateObject60 = level12_taggedTemplateLiteral(["heart of the filthworm queen"])))) || (0,property/* get */.U2)("sidequestOrchardCompleted") !== "none",
  do: (0,template_string/* $location */.PG)(_templateObject61 || (_templateObject61 = level12_taggedTemplateLiteral(["The Hatching Chamber"]))),
  ...
  modifier: "item"
}, (0,template_string/* $monster */.O4)(_templateObject62 || (_templateObject62 = level12_taggedTemplateLiteral(["larval filthworm"])))), yellowray({
  name: "Orchard Feeding",
  after: ["Orchard Hatching"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject63 || (_templateObject63 = level12_taggedTemplateLiteral(["filthworm drone scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject64 || (_templateObject64 = level12_taggedTemplateLiteral(["Filthworm Drone Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject65 || (_templateObject65 = level12_taggedTemplateLiteral(["filthworm royal guard scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject66 || (_templateObject66 = level12_taggedTemplateLiteral(["Filthworm Guard Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject67 || (_templateObject67 = level12_taggedTemplateLiteral(["heart of the filthworm queen"])))) || (0,property/* get */.U2)("sidequestOrchardCompleted") !== "none",
  do: (0,template_string/* $location */.PG)(_templateObject68 || (_templateObject68 = level12_taggedTemplateLiteral(["The Feeding Chamber"]))),
  effects: (0,template_string/* $effects */.lh)(_templateObject69 || (_templateObject69 = level12_taggedTemplateLiteral(["Filthworm Larva Stench"]))),
  combat: new src_combat.CombatStrategy().killItem(),
  limit: {
    soft: 10
  }
  ...
  modifier: "item"
}, (0,template_string/* $monster */.O4)(_templateObject70 || (_templateObject70 = level12_taggedTemplateLiteral(["filthworm drone"])))), yellowray({
  name: "Orchard Guard",
  after: ["Orchard Feeding"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject71 || (_templateObject71 = level12_taggedTemplateLiteral(["filthworm royal guard scent gland"])))) || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject72 || (_templateObject72 = level12_taggedTemplateLiteral(["Filthworm Guard Stench"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject73 || (_templateObject73 = level12_taggedTemplateLiteral(["heart of the filthworm queen"])))) || (0,property/* get */.U2)("sidequestOrchardCompleted") !== "none",
  do: (0,template_string/* $location */.PG)(_templateObject74 || (_templateObject74 = level12_taggedTemplateLiteral(["The Royal Guard Chamber"]))),
  effects: (0,template_string/* $effects */.lh)(_templateObject75 || (_templateObject75 = level12_taggedTemplateLiteral(["Filthworm Drone Stench"]))),
  combat: new src_combat.CombatStrategy().killItem(),
  limit: {
    soft: 10
  }
  ...
  modifier: "item"
}, (0,template_string/* $monster */.O4)(_templateObject76 || (_templateObject76 = level12_taggedTemplateLiteral(["filthworm royal guard"])))), {
  name: "Orchard Queen",
  after: ["Orchard Guard"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject77 || (_templateObject77 = level12_taggedTemplateLiteral(["heart of the filthworm queen"])))) || (0,property/* get */.U2)("sidequestOrchardCompleted") !== "none",
  do: (0,template_string/* $location */.PG)(_templateObject78 || (_templateObject78 = level12_taggedTemplateLiteral(["The Filthworm Queen's Chamber"]))),
  outfit: {
    modifier: "items"
  },
  effects: (0,template_string/* $effects */.lh)(_templateObject79 || (_templateObject79 = level12_taggedTemplateLiteral(["Filthworm Guard Stench"]))),
  ...
  outfit: {
    equip: (0,template_string/* $items */.vS)(_templateObject80 || (_templateObject80 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
  },
  do: () => {
...
var Nuns = [{
  ...
  priority: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject81 || (_templateObject81 = level12_taggedTemplateLiteral(["Winklered"])))) ? OverridePriority.Effect : OverridePriority.None,
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject82 || (_templateObject82 = level12_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) && (0,property/* get */.U2)("boomBoxSong") !== "Total Eclipse of Your Meat") (0,external_kolmafia_.cliExecute)("boombox meat");
    if (!(0,property/* get */.U2)("concertVisited")) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(_templateObject83 || (_templateObject83 = level12_taggedTemplateLiteral(["Winklered"]))));
  },
  do: (0,template_string/* $location */.PG)(_templateObject84 || (_templateObject84 = level12_taggedTemplateLiteral(["The Themthar Hills"]))),
  outfit: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(_templateObject85 || (_templateObject85 = level12_taggedTemplateLiteral(["Trick-or-Treating Tot"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject86 || (_templateObject86 = level12_taggedTemplateLiteral(["li'l pirate costume"]))))) {
      return {
        modifier: "meat",
        familiar: (0,template_string/* $familiar */.HP)(_templateObject87 || (_templateObject87 = level12_taggedTemplateLiteral(["Trick-or-Treating Tot"]))),
        equip: (0,template_string/* $items */.vS)(_templateObject88 || (_templateObject88 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin, li'l pirate costume"])))
      };
    }

    return {
      modifier: "meat",
      equip: (0,template_string/* $items */.vS)(_templateObject89 || (_templateObject89 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin, amulet coin"]))) // Use amulet coin (if we have) to avoid using orb

    };
  },
  freecombat: true,
  // Do not equip cmg or carn plant
  combat: new src_combat.CombatStrategy(true).macro(new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(_templateObject90 || (_templateObject90 = level12_taggedTemplateLiteral(["Bowl Straight Up"])))).trySkill((0,template_string/* $skill */.tm)(_templateObject91 || (_templateObject91 = level12_taggedTemplateLiteral(["Sing Along"]))))).kill(),
  limit: {
    soft: 25
  }
}];
var WarQuest = {
  ...
  tasks: [{
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject92 || (_templateObject92 = level12_taggedTemplateLiteral(["filthy corduroys"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject93 || (_templateObject93 = level12_taggedTemplateLiteral(["filthy knitted dread sack"])))),
    do: (0,template_string/* $location */.PG)(_templateObject94 || (_templateObject94 = level12_taggedTemplateLiteral(["Hippy Camp"]))),
    limit: {
      soft: 10
    },
    outfit: {
    ...
    choices: {
      136: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject95 || (_templateObject95 = level12_taggedTemplateLiteral(["filthy corduroys"])))) ? 2 : 1,
      137: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject96 || (_templateObject96 = level12_taggedTemplateLiteral(["filthy corduroys"])))) ? 1 : 2
    },
    combat: new src_combat.CombatStrategy().killItem()
  }, {
    modifier: "item"
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject97 || (_templateObject97 = level12_taggedTemplateLiteral(["beer helmet"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject98 || (_templateObject98 = level12_taggedTemplateLiteral(["distressed denim pants"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject99 || (_templateObject99 = level12_taggedTemplateLiteral(["bejeweled pledge pin"])))),
    do: (0,template_string/* $location */.PG)(_templateObject100 || (_templateObject100 = level12_taggedTemplateLiteral(["Frat House"]))),
    limit: {
      soft: 10
    },
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject101 || (_templateObject101 = level12_taggedTemplateLiteral(["filthy corduroys, filthy knitted dread sack"]))),
      modifier: "+combat"
    },
    choices: {
      142: 3,
    ...
    equip: (0,template_string/* $items */.vS)(_templateObject102 || (_templateObject102 = level12_taggedTemplateLiteral(["filthy corduroys, filthy knitted dread sack"]))),
    modifier: "item"
  }), {
    name: "Enrage",
    ...
    completed: () => step("questL12War") >= 1,
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject103 || (_templateObject103 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"]))),
      modifier: "-combat"
    },
    do: (0,template_string/* $location */.PG)(_templateObject104 || (_templateObject104 = level12_taggedTemplateLiteral(["Wartime Hippy Camp (Frat Disguise)"]))),
    choices: {
      142: 3,
      143: 3,
      144: 3,
    ...
    acquire: [{
      item: (0,template_string/* $item */.xr)(_templateObject105 || (_templateObject105 = level12_taggedTemplateLiteral(["beer helmet"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject106 || (_templateObject106 = level12_taggedTemplateLiteral(["distressed denim pants"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject107 || (_templateObject107 = level12_taggedTemplateLiteral(["bejeweled pledge pin"])))
    }],
    completed: () => (0,property/* get */.U2)("hippiesDefeated") >= 64,
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject108 || (_templateObject108 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
    },
    do: (0,template_string/* $location */.PG)(_templateObject109 || (_templateObject109 = level12_taggedTemplateLiteral(["The Battlefield (Frat Uniform)"]))),
    ...
    acquire: [{
      item: (0,template_string/* $item */.xr)(_templateObject110 || (_templateObject110 = level12_taggedTemplateLiteral(["beer helmet"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject111 || (_templateObject111 = level12_taggedTemplateLiteral(["distressed denim pants"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject112 || (_templateObject112 = level12_taggedTemplateLiteral(["bejeweled pledge pin"])))
    }],
    completed: () => (0,property/* get */.U2)("hippiesDefeated") >= 192,
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject113 || (_templateObject113 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
    },
    do: (0,template_string/* $location */.PG)(_templateObject114 || (_templateObject114 = level12_taggedTemplateLiteral(["The Battlefield (Frat Uniform)"]))),
    combat: new src_combat.CombatStrategy().kill(),
    limit: {
      tries: 9
    }
    ...
    after: ["Nuns"],
    acquire: [{
      item: (0,template_string/* $item */.xr)(_templateObject115 || (_templateObject115 = level12_taggedTemplateLiteral(["beer helmet"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject116 || (_templateObject116 = level12_taggedTemplateLiteral(["distressed denim pants"])))
    }, {
      item: (0,template_string/* $item */.xr)(_templateObject117 || (_templateObject117 = level12_taggedTemplateLiteral(["bejeweled pledge pin"])))
    }],
    completed: () => (0,property/* get */.U2)("hippiesDefeated") >= 1000,
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject118 || (_templateObject118 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
    },
    do: (0,template_string/* $location */.PG)(_templateObject119 || (_templateObject119 = level12_taggedTemplateLiteral(["The Battlefield (Frat Uniform)"]))),
    post: dimesForGarters,
    combat: new src_combat.CombatStrategy().kill(),
    limit: {
      tries: 30
    ...
    outfit: {
      equip: (0,template_string/* $items */.vS)(_templateObject120 || (_templateObject120 = level12_taggedTemplateLiteral(["beer helmet, distressed denim pants, bejeweled pledge pin"])))
    },
...
function councilSafe() {
  ...
  return !atLevel(12) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject121 || (_templateObject121 = level12_taggedTemplateLiteral(["filthy corduroys"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject122 || (_templateObject122 = level12_taggedTemplateLiteral(["filthy knitted dread sack"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject123 || (_templateObject123 = level12_taggedTemplateLiteral(["beer helmet"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject124 || (_templateObject124 = level12_taggedTemplateLiteral(["distressed denim pants"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject125 || (_templateObject125 = level12_taggedTemplateLiteral(["bejeweled pledge pin"]))));
}

function dimesForGarters() {
  if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(_templateObject126 || (_templateObject126 = level12_taggedTemplateLiteral(["gauze garter"])))) >= 20) return;
  var to_sell = (0,template_string/* $items */.vS)(_templateObject127 || (_templateObject127 = level12_taggedTemplateLiteral(["pink clay bead, purple clay bead, green clay bead, communications windchimes, bullet-proof corduroys, round purple sunglasses, reinforced beaded headband"])));
...
var TowerQuest = {
  ...
  tasks: [{
    ...
    prepare: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject64 || (level13_templateObject64 = level13_taggedTemplateLiteral(["electric boning knife"]))))) return;

      if ((0,external_kolmafia_.haveEquipped)((0,template_string/* $item */.xr)(level13_templateObject65 || (level13_templateObject65 = level13_taggedTemplateLiteral(["Great Wolf's rocket launcher"]))))) {
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject66 || (level13_templateObject66 = level13_taggedTemplateLiteral(["moxie"])))) < 1000) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject67 || (level13_templateObject67 = level13_taggedTemplateLiteral(["Cock of the Walk"]))));
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject68 || (level13_templateObject68 = level13_taggedTemplateLiteral(["moxie"])))) < 1000) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject69 || (level13_templateObject69 = level13_taggedTemplateLiteral(["Superhuman Sarcasm"]))));
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject70 || (level13_templateObject70 = level13_taggedTemplateLiteral(["moxie"])))) < 1000) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject71 || (level13_templateObject71 = level13_taggedTemplateLiteral(["Gr8ness"]))));
        fillHp();
      } else if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject72 || (level13_templateObject72 = level13_taggedTemplateLiteral(["Drunkula's bell"]))))) {
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject73 || (level13_templateObject73 = level13_taggedTemplateLiteral(["mysticality"])))) < 2700) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject74 || (level13_templateObject74 = level13_taggedTemplateLiteral(["On the Shoulders of Giants"]))));
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject75 || (level13_templateObject75 = level13_taggedTemplateLiteral(["mysticality"])))) < 2700) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject76 || (level13_templateObject76 = level13_taggedTemplateLiteral(["Mystically Oiled"]))));
        if ((0,external_kolmafia_.myBuffedstat)((0,template_string/* $stat */.Ri)(level13_templateObject77 || (level13_templateObject77 = level13_taggedTemplateLiteral(["mysticality"])))) < 2700) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level13_templateObject78 || (level13_templateObject78 = level13_taggedTemplateLiteral(["Gr8ness"]))));
      }
    },
    do: (0,template_string/* $location */.PG)(level13_templateObject79 || (level13_templateObject79 = level13_taggedTemplateLiteral(["Tower Level 3"]))),
    outfit: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject80 || (level13_templateObject80 = level13_taggedTemplateLiteral(["Great Wolf's rocket launcher"]))))) return {
        equip: (0,template_string/* $items */.vS)(level13_templateObject81 || (level13_templateObject81 = level13_taggedTemplateLiteral(["Great Wolf's rocket launcher"]))),
        modifier: "moxie"
      };
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject82 || (level13_templateObject82 = level13_taggedTemplateLiteral(["Drunkula's bell"]))))) return {
        modifier: "myst"
      };
      return {};
    },
    combat: new src_combat.CombatStrategy(true).macro(() => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject83 || (level13_templateObject83 = level13_taggedTemplateLiteral(["electric boning knife"]))))) return dist_combat/* Macro.item */.LE.item((0,template_string/* $item */.xr)(level13_templateObject84 || (level13_templateObject84 = level13_taggedTemplateLiteral(["electric boning knife"]))));
      if ((0,external_kolmafia_.haveEquipped)((0,template_string/* $item */.xr)(level13_templateObject85 || (level13_templateObject85 = level13_taggedTemplateLiteral(["Great Wolf's rocket launcher"]))))) return dist_combat/* Macro.skill */.LE.skill((0,template_string/* $skill */.tm)(level13_templateObject86 || (level13_templateObject86 = level13_taggedTemplateLiteral(["Fire Rocket"]))));
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject87 || (level13_templateObject87 = level13_taggedTemplateLiteral(["Drunkula's bell"]))))) return dist_combat/* Macro.item */.LE.item((0,template_string/* $item */.xr)(level13_templateObject88 || (level13_templateObject88 = level13_taggedTemplateLiteral(["Drunkula's bell"]))));
    ...
    acquire: [{
      item: (0,template_string/* $item */.xr)(level13_templateObject89 || (level13_templateObject89 = level13_taggedTemplateLiteral(["Wand of Nagamar"])))
    }],
    completed: () => step("questL13Final") > 9,
    do: (0,template_string/* $location */.PG)(level13_templateObject90 || (level13_templateObject90 = level13_taggedTemplateLiteral(["Tower Level 4"]))),
    choices: {
      1015: 2
    },
    limit: {
    ...
    prepare: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject91 || (level13_templateObject91 = level13_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) && ((0,property/* get */.U2)("retroCapeSuperhero") !== "heck" || (0,property/* get */.U2)("retroCapeWashingInstructions") !== "hold")) {
    ...
    do: (0,template_string/* $location */.PG)(level13_templateObject92 || (level13_templateObject92 = level13_taggedTemplateLiteral(["Tower Level 5"]))),
    outfit: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject93 || (level13_templateObject93 = level13_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) return {
        equip: (0,template_string/* $items */.vS)(level13_templateObject94 || (level13_templateObject94 = level13_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))
      };else if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject95 || (level13_templateObject95 = level13_taggedTemplateLiteral(["attorney's badge"]))))) return {
        modifier: "HP",
        equip: (0,template_string/* $items */.vS)(level13_templateObject96 || (level13_templateObject96 = level13_taggedTemplateLiteral(["attorney's badge"]))),
        avoid: (0,template_string/* $items */.vS)(level13_templateObject97 || (level13_templateObject97 = level13_taggedTemplateLiteral(["extra-wide head candle"])))
      };else return {
        modifier: "HP",
        avoid: (0,template_string/* $items */.vS)(level13_templateObject98 || (level13_templateObject98 = level13_taggedTemplateLiteral(["extra-wide head candle"])))
      };
    },
    combat: new src_combat.CombatStrategy(true).macro(new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(level13_templateObject99 || (level13_templateObject99 = level13_taggedTemplateLiteral(["gauze garter"])))).repeat()),
    limit: {
      tries: 1
    }
  }, {
    ...
    do: (0,template_string/* $location */.PG)(level13_templateObject100 || (level13_templateObject100 = level13_taggedTemplateLiteral(["The Naughty Sorceress' Chamber"]))),
    outfit: {
      modifier: "muscle"
    },
    combat: new src_combat.CombatStrategy(true).kill(),
...
function fillHp() {
  if ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)()) {
    if (!(0,external_kolmafia_.restoreHp)((0,external_kolmafia_.myMaxhp)())) {
      ...
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level13_templateObject101 || (level13_templateObject101 = level13_taggedTemplateLiteral(["scroll of drastic healing"]))))) {
        (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level13_templateObject102 || (level13_templateObject102 = level13_taggedTemplateLiteral(["scroll of drastic healing"]))));
      ...
      while ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() && (0,external_kolmafia_.myMeat)() >= 1000 && tries < 30) {
        tries++;
        (0,external_kolmafia_.retrieveItem)((0,template_string/* $item */.xr)(level13_templateObject103 || (level13_templateObject103 = level13_taggedTemplateLiteral(["Doc Galaktik's Homeopathic Elixir"]))));
        (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level13_templateObject104 || (level13_templateObject104 = level13_taggedTemplateLiteral(["Doc Galaktik's Homeopathic Elixir"]))));
      }
    }
  }
}
...
}, // Level 4
{
  ...
  prepare: () => {
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 1) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(absorb_templateObject5 || (absorb_templateObject5 = absorb_taggedTemplateLiteral(["Red Door Syndrome"]))));
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 1) throw "Unable to ensure cold res for The Icy Peak";
  },
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject6 || (absorb_templateObject6 = absorb_taggedTemplateLiteral(["The Batrat and Ratbat Burrow"]))),
  after: ["Bat/Use Sonar 1", "Palindome/Bat Snake"],
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject7 || (absorb_templateObject7 = absorb_taggedTemplateLiteral(["Nanofur"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject8 || (absorb_templateObject8 = absorb_taggedTemplateLiteral(["The Beanbat Chamber"]))),
  after: ["Bat/Use Sonar 2", "Giant/Grow Beanstalk"]
}, // Level 5
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject9 || (absorb_templateObject9 = absorb_taggedTemplateLiteral(["The Outskirts of Cobb's Knob"]))),
  ...
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject10 || (absorb_templateObject10 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject11 || (absorb_templateObject11 = absorb_taggedTemplateLiteral(["Cobb's Knob Kitchens"]))),
  after: ["Knob/Open Knob"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject12 || (absorb_templateObject12 = absorb_taggedTemplateLiteral(["Cobb's Knob Barracks"]))),
  after: ["Knob/Open Knob"],
  choices: {
    522: 2
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject13 || (absorb_templateObject13 = absorb_taggedTemplateLiteral(["Cobb's Knob Harem"]))),
  after: ["Knob/King"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject14 || (absorb_templateObject14 = absorb_taggedTemplateLiteral(["Cobb's Knob Treasury"]))),
  after: ["Knob/Open Knob"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject15 || (absorb_templateObject15 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject16 || (absorb_templateObject16 = absorb_taggedTemplateLiteral(["Cobb's Knob Laboratory"]))),
  after: ["Knob/King"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject17 || (absorb_templateObject17 = absorb_taggedTemplateLiteral(["The Knob Shaft"]))),
  after: ["Knob/King"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject18 || (absorb_templateObject18 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject19 || (absorb_templateObject19 = absorb_taggedTemplateLiteral(["Cobb's Knob Menagerie, Level 1"]))),
  after: ["Knob/Open Menagerie"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject20 || (absorb_templateObject20 = absorb_taggedTemplateLiteral(["Cobb's Knob Menagerie, Level 2"]))),
  after: ["Knob/Open Menagerie"],
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject21 || (absorb_templateObject21 = absorb_taggedTemplateLiteral(["Fluid Dynamics Simulation"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject22 || (absorb_templateObject22 = absorb_taggedTemplateLiteral(["Cobb's Knob Menagerie, Level 3"]))),
  after: ["Knob/Open Menagerie"],
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject23 || (absorb_templateObject23 = absorb_taggedTemplateLiteral(["Phase Shift"])))
}, // Level 6
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject24 || (absorb_templateObject24 = absorb_taggedTemplateLiteral(["The Dark Heart of the Woods"]))),
  after: ["Friar/Heart"],
  ready: () => step("questL06Friar") < 999
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject25 || (absorb_templateObject25 = absorb_taggedTemplateLiteral(["The Dark Neck of the Woods"]))),
  after: ["Friar/Neck"],
  ready: () => step("questL06Friar") < 999
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject26 || (absorb_templateObject26 = absorb_taggedTemplateLiteral(["The Dark Elbow of the Woods"]))),
  after: ["Friar/Elbow"],
  ready: () => step("questL06Friar") < 999
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject27 || (absorb_templateObject27 = absorb_taggedTemplateLiteral(["Pandamonium Slums"]))),
  prepare: () => {
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject28 || (absorb_templateObject28 = absorb_taggedTemplateLiteral(["The Laugh Floor"]))),
  prepare: () => {
    if (step("questM10Azazel") === -1) {
      (0,external_kolmafia_.visitUrl)("pandamonium.php?action=temp");
      (0,external_kolmafia_.visitUrl)("pandamonium.php?action=sven");
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject29 || (absorb_templateObject29 = absorb_taggedTemplateLiteral(["Infernal Rackets Backstage"]))),
  prepare: () => {
    if (step("questM10Azazel") === -1) {
      (0,external_kolmafia_.visitUrl)("pandamonium.php?action=temp");
      (0,external_kolmafia_.visitUrl)("pandamonium.php?action=sven");
  ...
  after: ["Friar/Finish"],
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject30 || (absorb_templateObject30 = absorb_taggedTemplateLiteral(["Gravitational Compression"])))
}, // Level 7
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject31 || (absorb_templateObject31 = absorb_taggedTemplateLiteral(["The VERY Unquiet Garves"]))),
  after: ["Crypt/Start", "Crypt/Finish"]
}, // Level 8
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject32 || (absorb_templateObject32 = absorb_taggedTemplateLiteral(["Itznotyerzitz Mine"]))),
  ...
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject33 || (absorb_templateObject33 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject34 || (absorb_templateObject34 = absorb_taggedTemplateLiteral(["The Goatlet"]))),
  after: ["McLargeHuge/Goatlet"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject35 || (absorb_templateObject35 = absorb_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))),
  after: ["McLargeHuge/Climb", "Palindome/Cold Snake"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject36 || (absorb_templateObject36 = absorb_taggedTemplateLiteral(["The eXtreme Slope"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject38 || (absorb_templateObject38 = absorb_taggedTemplateLiteral(["The Icy Peak"]))),
  after: ["McLargeHuge/Peak"],
  ready: () => coldRes(true) >= 5,
  prepare: () => {
    if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(absorb_templateObject39 || (absorb_templateObject39 = absorb_taggedTemplateLiteral(["Red Door Syndrome"]))));
  ...
  outfit: {
    ...
    equip: (0,template_string/* $items */.vS)(absorb_templateObject40 || (absorb_templateObject40 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  },
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().attack().repeat(), (0,template_string/* $monster */.O4)(absorb_templateObject41 || (absorb_templateObject41 = absorb_taggedTemplateLiteral(["Snow Queen"]))))
}, // Level 9
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject42 || (absorb_templateObject42 = absorb_taggedTemplateLiteral(["The Smut Orc Logging Camp"]))),
  after: ["Orc Chasm/Bridge"],
  choices: {
    1345: 1
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject43 || (absorb_templateObject43 = absorb_taggedTemplateLiteral(["A-Boo Peak"]))),
  after: ["Orc Chasm/ABoo Clues"],
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().attack().repeat())
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject44 || (absorb_templateObject44 = absorb_taggedTemplateLiteral(["Twin Peak"]))),
  after: ["Orc Chasm/Twin Init"],
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject45 || (absorb_templateObject45 = absorb_taggedTemplateLiteral(["Overclocking"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject46 || (absorb_templateObject46 = absorb_taggedTemplateLiteral(["Oil Peak"]))),
  after: ["Orc Chasm/Oil Peak"],
  prepare: () => {
    // Unequip the umbrella if it pushes us over the cap
    if ((0,external_kolmafia_.equippedAmount)((0,template_string/* $item */.xr)(absorb_templateObject47 || (absorb_templateObject47 = absorb_taggedTemplateLiteral(["unbreakable umbrella"])))) > 0 && (0,property/* get */.U2)("umbrellaState") === "broken" && (0,external_kolmafia_.numericModifier)("Monster Level") >= 80) {
      (0,external_kolmafia_.equip)((0,template_string/* $slot */.Jh)(absorb_templateObject48 || (absorb_templateObject48 = absorb_taggedTemplateLiteral(["off-hand"]))), (0,template_string/* $item */.xr)(absorb_templateObject49 || (absorb_templateObject49 = absorb_taggedTemplateLiteral(["none"]))));
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var item = (0,external_kolmafia_.equippedItem)(slot);
        if (item === (0,template_string/* $item */.xr)(absorb_templateObject50 || (absorb_templateObject50 = absorb_taggedTemplateLiteral(["none"])))) continue;
        if ((0,external_kolmafia_.numericModifier)(item, "Monster Level") === 0) continue;
        if (item === (0,template_string/* $item */.xr)(absorb_templateObject51 || (absorb_templateObject51 = absorb_taggedTemplateLiteral(["backup camera"])))) continue; // Always keep equipped to ensure we can get to 50

        (0,external_kolmafia_.equip)(slot, (0,template_string/* $item */.xr)(absorb_templateObject52 || (absorb_templateObject52 = absorb_taggedTemplateLiteral(["none"]))));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject53 || (absorb_templateObject53 = absorb_taggedTemplateLiteral(["The Valley of Rof L'm Fao"]))),
  after: ["Orc Chasm/Finish"]
}, // Level 10
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject54 || (absorb_templateObject54 = absorb_taggedTemplateLiteral(["The Penultimate Fantasy Airship"]))),
  after: ["Giant/Airship"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject55 || (absorb_templateObject55 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  },
  choices: {
    178: 2,
    182: 2
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject56 || (absorb_templateObject56 = absorb_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Basement)"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject58 || (absorb_templateObject58 = absorb_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Ground Floor)"]))),
  after: ["Giant/Ground"],
  outfit: {
    modifier: "+combat",
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject60 || (absorb_templateObject60 = absorb_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Top Floor)"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject62 || (absorb_templateObject62 = absorb_taggedTemplateLiteral(["The Hole in the Sky"]))),
  after: ["Giant/Unlock HITS", "Keys/Star Key"]
}, // Level 11
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject63 || (absorb_templateObject63 = absorb_taggedTemplateLiteral(["The Black Forest"]))),
  ...
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject65 || (absorb_templateObject65 = absorb_taggedTemplateLiteral(["Photonic Shroud"])))
}, // Level 11: Hidden City
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject66 || (absorb_templateObject66 = absorb_taggedTemplateLiteral(["The Hidden Temple"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject68 || (absorb_templateObject68 = absorb_taggedTemplateLiteral(["The Hidden Park"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject70 || (absorb_templateObject70 = absorb_taggedTemplateLiteral(["The Hidden Apartment Building"]))),
  after: ["Hidden City/Apartment"],
  choices: {
    780: 4
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject71 || (absorb_templateObject71 = absorb_taggedTemplateLiteral(["The Hidden Office Building"]))),
  after: ["Hidden City/Office Boss"],
  choices: {
    786: 4
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject72 || (absorb_templateObject72 = absorb_taggedTemplateLiteral(["The Hidden Hospital"]))),
  after: ["Hidden City/Hospital"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject73 || (absorb_templateObject73 = absorb_taggedTemplateLiteral(["The Hidden Bowling Alley"]))),
  after: ["Hidden City/Bowling"]
}, // Level 11: Manor
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject74 || (absorb_templateObject74 = absorb_taggedTemplateLiteral(["The Haunted Pantry"]))),
  after: [],
  choices: {
    114: 2,
    115: 1,
  ...
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject75 || (absorb_templateObject75 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject76 || (absorb_templateObject76 = absorb_taggedTemplateLiteral(["The Haunted Conservatory"]))),
  after: ["Manor/Start"],
  choices: {
    899: 2
  },
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject77 || (absorb_templateObject77 = absorb_taggedTemplateLiteral(["Ponzi Apparatus"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject78 || (absorb_templateObject78 = absorb_taggedTemplateLiteral(["The Haunted Kitchen"]))),
  after: ["Manor/Kitchen"],
  choices: {
    893: 2
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject79 || (absorb_templateObject79 = absorb_taggedTemplateLiteral(["The Haunted Billiards Room"]))),
  after: ["Manor/Billiards"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject80 || (absorb_templateObject80 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  },
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().attack().repeat(), (0,template_string/* $monster */.O4)(absorb_templateObject81 || (absorb_templateObject81 = absorb_taggedTemplateLiteral(["chalkdust wraith"])))),
  choices: {
    900: 2
  },
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject82 || (absorb_templateObject82 = absorb_taggedTemplateLiteral(["Subatomic Hardening"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject83 || (absorb_templateObject83 = absorb_taggedTemplateLiteral(["The Haunted Library"]))),
  after: ["Manor/Library"],
  choices: {
    163: 4,
    888: 4,
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject84 || (absorb_templateObject84 = absorb_taggedTemplateLiteral(["The Haunted Gallery"]))),
  after: ["Manor/Gallery"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject85 || (absorb_templateObject85 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  },
  choices: {
    89: 6,
    896: 1
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject86 || (absorb_templateObject86 = absorb_taggedTemplateLiteral(["The Haunted Bathroom"]))),
  ...
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject88 || (absorb_templateObject88 = absorb_taggedTemplateLiteral(["Clammy Microcilia"])))
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject89 || (absorb_templateObject89 = absorb_taggedTemplateLiteral(["The Haunted Bedroom"]))),
  after: ["Manor/Bedroom"],
  choices: {
    876: 1,
    877: 1,
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject90 || (absorb_templateObject90 = absorb_taggedTemplateLiteral(["The Haunted Ballroom"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject92 || (absorb_templateObject92 = absorb_taggedTemplateLiteral(["The Haunted Wine Cellar"]))),
  after: ["Manor/Wine Cellar"],
  choices: {
    901: 2
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject93 || (absorb_templateObject93 = absorb_taggedTemplateLiteral(["The Haunted Laundry Room"]))),
  after: ["Manor/Laundry Room"],
  choices: {
    891: 2
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject94 || (absorb_templateObject94 = absorb_taggedTemplateLiteral(["The Haunted Boiler Room"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject95 || (absorb_templateObject95 = absorb_taggedTemplateLiteral(["The Haunted Storage Room"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject96 || (absorb_templateObject96 = absorb_taggedTemplateLiteral(["The Haunted Nursery"]))),
  after: ["Manor/Finish Floor2"],
  choices: {
    884: 6,
    898: 2
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject97 || (absorb_templateObject97 = absorb_taggedTemplateLiteral(["The Haunted Laboratory"]))),
  after: ["Manor/Finish Floor2"],
  choices: {
    884: 6,
    903: 2
...
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject98 || (absorb_templateObject98 = absorb_taggedTemplateLiteral(["The Copperhead Club"]))),
  after: ["Palindome/Copperhead"],
  choices: {
    855: 4
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject99 || (absorb_templateObject99 = absorb_taggedTemplateLiteral(["A Mob of Zeppelin Protesters"]))),
  after: ["Palindome/Protesters Finish"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject100 || (absorb_templateObject100 = absorb_taggedTemplateLiteral(["The Red Zeppelin"]))),
  after: ["Palindome/Zepplin"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject101 || (absorb_templateObject101 = absorb_taggedTemplateLiteral(["Inside the Palindome"]))),
  after: ["Palindome/Palindome Photos"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject102 || (absorb_templateObject102 = absorb_taggedTemplateLiteral(["Talisman o' Namsilat, miniature crystal ball"])))
  },
  choices: {
    2: 2,
    126: 1,
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject103 || (absorb_templateObject103 = absorb_taggedTemplateLiteral(["Whitey's Grove"]))),
  after: ["Palindome/Open Alarm"],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject104 || (absorb_templateObject104 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  },
  choices: {
    73: 3,
    74: 2,
...
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject105 || (absorb_templateObject105 = absorb_taggedTemplateLiteral(["The Arid, Extra-Dry Desert"]))),
  after: ["Macguffin/Desert"]
}, {
  priority: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(absorb_templateObject106 || (absorb_templateObject106 = absorb_taggedTemplateLiteral(["Ultrahydrated"])))) && (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(absorb_templateObject107 || (absorb_templateObject107 = absorb_taggedTemplateLiteral(["Grey Goose"])))) >= 6 ? OverridePriority.Effect : OverridePriority.None,
  do: (0,template_string/* $location */.PG)(absorb_templateObject108 || (absorb_templateObject108 = absorb_taggedTemplateLiteral(["The Oasis"]))),
  after: ["Macguffin/Desert"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject109 || (absorb_templateObject109 = absorb_taggedTemplateLiteral(["The Upper Chamber"]))),
  after: ["Macguffin/Upper Chamber"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject110 || (absorb_templateObject110 = absorb_taggedTemplateLiteral(["The Middle Chamber"]))),
  after: ["Macguffin/Middle Chamber"]
}, // Misc areas
// These are probably only worthwhile with orb
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject111 || (absorb_templateObject111 = absorb_taggedTemplateLiteral(["South of the Border"]))),
  ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(absorb_templateObject112 || (absorb_templateObject112 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))),
  ...
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject113 || (absorb_templateObject113 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject114 || (absorb_templateObject114 = absorb_taggedTemplateLiteral(["The Unquiet Garves"]))),
  after: ["Crypt/Start"]
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject115 || (absorb_templateObject115 = absorb_taggedTemplateLiteral(["The Old Landfill"]))),
  ...
  prepare: () => {
    ...
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(absorb_templateObject116 || (absorb_templateObject116 = absorb_taggedTemplateLiteral(["funky junk key"]))))) {
      (0,external_kolmafia_.putCloset)((0,template_string/* $item */.xr)(absorb_templateObject117 || (absorb_templateObject117 = absorb_taggedTemplateLiteral(["funky junk key"]))), (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(absorb_templateObject118 || (absorb_templateObject118 = absorb_taggedTemplateLiteral(["funky junk key"])))));
    }
  },
  ready: () => atLevel(6)
}, {
  do: (0,template_string/* $location */.PG)(absorb_templateObject119 || (absorb_templateObject119 = absorb_taggedTemplateLiteral(["The Skeleton Store"]))),
  after: [],
  prepare: () => {
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject120 || (absorb_templateObject120 = absorb_taggedTemplateLiteral(["The Overgrown Lot"]))),
  after: [],
  prepare: () => {
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject121 || (absorb_templateObject121 = absorb_taggedTemplateLiteral(["Madness Bakery"]))),
  after: [],
  prepare: () => {
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject122 || (absorb_templateObject122 = absorb_taggedTemplateLiteral(["The Dungeons of Doom"]))),
  skill: (0,template_string/* $skill */.tm)(absorb_templateObject123 || (absorb_templateObject123 = absorb_taggedTemplateLiteral(["Hivemindedness"]))),
  after: [],
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(absorb_templateObject124 || (absorb_templateObject124 = absorb_taggedTemplateLiteral(["plus sign"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(absorb_templateObject125 || (absorb_templateObject125 = absorb_taggedTemplateLiteral(["plus sign"]))));
  },
  ...
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(absorb_templateObject126 || (absorb_templateObject126 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, // Moon-sign zones
{
  do: (0,template_string/* $location */.PG)(absorb_templateObject127 || (absorb_templateObject127 = absorb_taggedTemplateLiteral(["The Bugbear Pen"]))),
  ...
  do: (0,template_string/* $location */.PG)(absorb_templateObject128 || (absorb_templateObject128 = absorb_taggedTemplateLiteral(["Outskirts of Camp Logging Camp"]))),
  ready: () => (0,external_kolmafia_.canadiaAvailable)(),
  after: [],
  outfit: {
    modifier: "+combat",
    equip: (0,template_string/* $items */.vS)(_templateObject129 || (_templateObject129 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
  }
}, {
  do: (0,template_string/* $location */.PG)(_templateObject130 || (_templateObject130 = absorb_taggedTemplateLiteral(["Thugnderdome"]))),
...
(0,template_string/* $monster */.O4)(_templateObject131 || (_templateObject131 = absorb_taggedTemplateLiteral(["1335 HaXx0r"]))), (0,template_string/* $monster */.O4)(_templateObject132 || (_templateObject132 = absorb_taggedTemplateLiteral(["Alphabet Giant"]))), (0,template_string/* $monster */.O4)(_templateObject133 || (_templateObject133 = absorb_taggedTemplateLiteral(["black magic woman"]))), (0,template_string/* $monster */.O4)(_templateObject134 || (_templateObject134 = absorb_taggedTemplateLiteral(["blur"]))), (0,template_string/* $monster */.O4)(_templateObject135 || (_templateObject135 = absorb_taggedTemplateLiteral(["Bob Racecar"]))), (0,template_string/* $monster */.O4)(_templateObject136 || (_templateObject136 = absorb_taggedTemplateLiteral(["coaltergeist"]))), (0,template_string/* $monster */.O4)(_templateObject137 || (_templateObject137 = absorb_taggedTemplateLiteral(["fleet woodsman"]))), (0,template_string/* $monster */.O4)(_templateObject138 || (_templateObject138 = absorb_taggedTemplateLiteral(["Iiti Kitty"]))), (0,template_string/* $monster */.O4)(_templateObject139 || (_templateObject139 = absorb_taggedTemplateLiteral(["Irritating Series of Random Encounters"]))), (0,template_string/* $monster */.O4)(_templateObject140 || (_templateObject140 = absorb_taggedTemplateLiteral(["Little Man in the Canoe"]))), (0,template_string/* $monster */.O4)(_templateObject141 || (_templateObject141 = absorb_taggedTemplateLiteral(["mad wino"]))), (0,template_string/* $monster */.O4)(_templateObject142 || (_templateObject142 = absorb_taggedTemplateLiteral(["Mob Penguin Capo"]))), (0,template_string/* $monster */.O4)(_templateObject143 || (_templateObject143 = absorb_taggedTemplateLiteral(["One-Eyed Willie"]))), (0,template_string/* $monster */.O4)(_templateObject144 || (_templateObject144 = absorb_taggedTemplateLiteral(["pygmy blowgunner"]))), (0,template_string/* $monster */.O4)(_templateObject145 || (_templateObject145 = absorb_taggedTemplateLiteral(["pygmy headhunter"]))), (0,template_string/* $monster */.O4)(_templateObject146 || (_templateObject146 = absorb_taggedTemplateLiteral(["pygmy orderlies"]))), (0,template_string/* $monster */.O4)(_templateObject147 || (_templateObject147 = absorb_taggedTemplateLiteral(["pygmy shaman"]))), (0,template_string/* $monster */.O4)(_templateObject148 || (_templateObject148 = absorb_taggedTemplateLiteral(["Racecar Bob"]))), (0,template_string/* $monster */.O4)(_templateObject149 || (_templateObject149 = absorb_taggedTemplateLiteral(["Raver Giant"]))), (0,template_string/* $monster */.O4)(_templateObject150 || (_templateObject150 = absorb_taggedTemplateLiteral(["Renaissance Giant"]))), (0,template_string/* $monster */.O4)(_templateObject151 || (_templateObject151 = absorb_taggedTemplateLiteral(["swarm of fire ants"]))), (0,template_string/* $monster */.O4)(_templateObject152 || (_templateObject152 = absorb_taggedTemplateLiteral(["tomb asp"]))), // 7 adv monsters
(0,template_string/* $monster */.O4)(_templateObject153 || (_templateObject153 = absorb_taggedTemplateLiteral(["animated rustic nightstand"]))), (0,template_string/* $monster */.O4)(_templateObject154 || (_templateObject154 = absorb_taggedTemplateLiteral(["basic lihc"]))), (0,template_string/* $monster */.O4)(_templateObject155 || (_templateObject155 = absorb_taggedTemplateLiteral(["Battlie Knight Ghost"]))), (0,template_string/* $monster */.O4)(_templateObject156 || (_templateObject156 = absorb_taggedTemplateLiteral(["Bubblemint Twins"]))), (0,template_string/* $monster */.O4)(_templateObject157 || (_templateObject157 = absorb_taggedTemplateLiteral(["CH Imp"]))), (0,template_string/* $monster */.O4)(_templateObject158 || (_templateObject158 = absorb_taggedTemplateLiteral(["chalkdust wraith"]))), (0,template_string/* $monster */.O4)(_templateObject159 || (_templateObject159 = absorb_taggedTemplateLiteral(["cloud of disembodied whiskers"]))), (0,template_string/* $monster */.O4)(_templateObject160 || (_templateObject160 = absorb_taggedTemplateLiteral(["eXtreme Orcish snowboarder"]))), (0,template_string/* $monster */.O4)(_templateObject161 || (_templateObject161 = absorb_taggedTemplateLiteral(["gluttonous ghuol"]))), (0,template_string/* $monster */.O4)(_templateObject162 || (_templateObject162 = absorb_taggedTemplateLiteral(["Grass Elemental"]))), (0,template_string/* $monster */.O4)(_templateObject163 || (_templateObject163 = absorb_taggedTemplateLiteral(["grave rober zmobie"]))), (0,template_string/* $monster */.O4)(_templateObject164 || (_templateObject164 = absorb_taggedTemplateLiteral(["guy with a pitchfork, and his wife"]))), (0,template_string/* $monster */.O4)(_templateObject165 || (_templateObject165 = absorb_taggedTemplateLiteral(["junksprite sharpener"]))), (0,template_string/* $monster */.O4)(_templateObject166 || (_templateObject166 = absorb_taggedTemplateLiteral(["Knob Goblin Very Mad Scientist"]))), (0,template_string/* $monster */.O4)(_templateObject167 || (_templateObject167 = absorb_taggedTemplateLiteral(["model skeleton"]))), (0,template_string/* $monster */.O4)(_templateObject168 || (_templateObject168 = absorb_taggedTemplateLiteral(["Ninja Snowman Janitor"]))), (0,template_string/* $monster */.O4)(_templateObject169 || (_templateObject169 = absorb_taggedTemplateLiteral(["oil baron"]))), (0,template_string/* $monster */.O4)(_templateObject170 || (_templateObject170 = absorb_taggedTemplateLiteral(["party skelteon"]))), (0,template_string/* $monster */.O4)(_templateObject171 || (_templateObject171 = absorb_taggedTemplateLiteral(["possessed silverware drawer"]))), (0,template_string/* $monster */.O4)(_templateObject172 || (_templateObject172 = absorb_taggedTemplateLiteral(["possessed toy chest"]))), (0,template_string/* $monster */.O4)(_templateObject173 || (_templateObject173 = absorb_taggedTemplateLiteral(["revolving bugbear"]))), (0,template_string/* $monster */.O4)(_templateObject174 || (_templateObject174 = absorb_taggedTemplateLiteral(["sabre-toothed goat"]))), (0,template_string/* $monster */.O4)(_templateObject175 || (_templateObject175 = absorb_taggedTemplateLiteral(["serialbus"]))), (0,template_string/* $monster */.O4)(_templateObject176 || (_templateObject176 = absorb_taggedTemplateLiteral(["sheet ghost"]))), (0,template_string/* $monster */.O4)(_templateObject177 || (_templateObject177 = absorb_taggedTemplateLiteral(["skeletal hamster"]))), (0,template_string/* $monster */.O4)(_templateObject178 || (_templateObject178 = absorb_taggedTemplateLiteral(["smut orc pipelayer"]))), (0,template_string/* $monster */.O4)(_templateObject179 || (_templateObject179 = absorb_taggedTemplateLiteral(["swarm of killer bees"]))), (0,template_string/* $monster */.O4)(_templateObject180 || (_templateObject180 = absorb_taggedTemplateLiteral(["tapdancing skeleton"]))), (0,template_string/* $monster */.O4)(_templateObject181 || (_templateObject181 = absorb_taggedTemplateLiteral(["toilet papergeist"]))), (0,template_string/* $monster */.O4)(_templateObject182 || (_templateObject182 = absorb_taggedTemplateLiteral(["upgraded ram"]))), (0,template_string/* $monster */.O4)(_templateObject183 || (_templateObject183 = absorb_taggedTemplateLiteral(["vicious gnauga"]))), (0,template_string/* $monster */.O4)(_templateObject184 || (_templateObject184 = absorb_taggedTemplateLiteral(["whitesnake"]))), (0,template_string/* $monster */.O4)(_templateObject185 || (_templateObject185 = absorb_taggedTemplateLiteral(["Booze Giant"]))), // 5 adv monsters
(0,template_string/* $monster */.O4)(_templateObject186 || (_templateObject186 = absorb_taggedTemplateLiteral(["dire pigeon"]))), (0,template_string/* $monster */.O4)(_templateObject187 || (_templateObject187 = absorb_taggedTemplateLiteral(["gingerbread murderer"]))), (0,template_string/* $monster */.O4)(_templateObject188 || (_templateObject188 = absorb_taggedTemplateLiteral(["grave rober"]))), (0,template_string/* $monster */.O4)(_templateObject189 || (_templateObject189 = absorb_taggedTemplateLiteral(["irate mariachi"]))), (0,template_string/* $monster */.O4)(_templateObject190 || (_templateObject190 = absorb_taggedTemplateLiteral(["plastered frat orc"]))), (0,template_string/* $monster */.O4)(_templateObject191 || (_templateObject191 = absorb_taggedTemplateLiteral(["swarm of skulls"]))), (0,template_string/* $monster */.O4)(_templateObject192 || (_templateObject192 = absorb_taggedTemplateLiteral(["albino bat"]))), (0,template_string/* $monster */.O4)(_templateObject193 || (_templateObject193 = absorb_taggedTemplateLiteral(["batrat"]))), (0,template_string/* $monster */.O4)(_templateObject194 || (_templateObject194 = absorb_taggedTemplateLiteral(["G imp"]))), (0,template_string/* $monster */.O4)(_templateObject195 || (_templateObject195 = absorb_taggedTemplateLiteral(["Knob Goblin Bean Counter"]))), (0,template_string/* $monster */.O4)(_templateObject196 || (_templateObject196 = absorb_taggedTemplateLiteral(["Knob Goblin Madam"]))), (0,template_string/* $monster */.O4)(_templateObject197 || (_templateObject197 = absorb_taggedTemplateLiteral(["Knob Goblin Master Chef"]))), (0,template_string/* $monster */.O4)(_templateObject198 || (_templateObject198 = absorb_taggedTemplateLiteral(["L imp"]))), (0,template_string/* $monster */.O4)(_templateObject199 || (_templateObject199 = absorb_taggedTemplateLiteral(["magical fruit bat"]))), (0,template_string/* $monster */.O4)(_templateObject200 || (_templateObject200 = absorb_taggedTemplateLiteral(["P imp"]))), (0,template_string/* $monster */.O4)(_templateObject201 || (_templateObject201 = absorb_taggedTemplateLiteral(["swarm of Knob lice"]))), (0,template_string/* $monster */.O4)(_templateObject202 || (_templateObject202 = absorb_taggedTemplateLiteral(["W imp"]))), (0,template_string/* $monster */.O4)(_templateObject203 || (_templateObject203 = absorb_taggedTemplateLiteral(["warwelf"])))]); // Other monsters that give skills

var usefulSkills = new Map([[(0,template_string/* $skill */.tm)(_templateObject204 || (_templateObject204 = absorb_taggedTemplateLiteral(["Ponzi Apparatus"]))), (0,template_string/* $monster */.O4)(_templateObject205 || (_templateObject205 = absorb_taggedTemplateLiteral(["anglerbush"])))], [(0,template_string/* $skill */.tm)(_templateObject206 || (_templateObject206 = absorb_taggedTemplateLiteral(["Ominous Substrate"]))), (0,template_string/* $monster */.O4)(_templateObject207 || (_templateObject207 = absorb_taggedTemplateLiteral(["animated ornate nightstand"])))], [(0,template_string/* $skill */.tm)(_templateObject208 || (_templateObject208 = absorb_taggedTemplateLiteral(["Innuendo Circuitry"]))), (0,template_string/* $monster */.O4)(_templateObject209 || (_templateObject209 = absorb_taggedTemplateLiteral(["Astronomer"])))], [(0,template_string/* $skill */.tm)(_templateObject210 || (_templateObject210 = absorb_taggedTemplateLiteral(["Exhaust Tubules"]))), (0,template_string/* $monster */.O4)(_templateObject211 || (_templateObject211 = absorb_taggedTemplateLiteral(["beanbat"])))], [(0,template_string/* $skill */.tm)(_templateObject212 || (_templateObject212 = absorb_taggedTemplateLiteral(["Overclocking"]))), (0,template_string/* $monster */.O4)(_templateObject213 || (_templateObject213 = absorb_taggedTemplateLiteral(["Big Wheelin' Twins"])))], [(0,template_string/* $skill */.tm)(_templateObject214 || (_templateObject214 = absorb_taggedTemplateLiteral(["Photonic Shroud"]))), (0,template_string/* $monster */.O4)(_templateObject215 || (_templateObject215 = absorb_taggedTemplateLiteral(["black panther"])))], [(0,template_string/* $skill */.tm)(_templateObject216 || (_templateObject216 = absorb_taggedTemplateLiteral(["Fluid Dynamics Simulation"]))), (0,template_string/* $monster */.O4)(_templateObject217 || (_templateObject217 = absorb_taggedTemplateLiteral(["Carnivorous Moxie Weed"])))], [(0,template_string/* $skill */.tm)(_templateObject218 || (_templateObject218 = absorb_taggedTemplateLiteral(["Ectogenesis"]))), (0,template_string/* $monster */.O4)(_templateObject219 || (_templateObject219 = absorb_taggedTemplateLiteral(["Claybender Sorcerer Ghost"])))], [(0,template_string/* $skill */.tm)(_templateObject220 || (_templateObject220 = absorb_taggedTemplateLiteral(["Microburner"]))), (0,template_string/* $monster */.O4)(_templateObject221 || (_templateObject221 = absorb_taggedTemplateLiteral(["Cobb's Knob oven"])))], [(0,template_string/* $skill */.tm)(_templateObject222 || (_templateObject222 = absorb_taggedTemplateLiteral(["Localized Vacuum"]))), (0,template_string/* $monster */.O4)(_templateObject223 || (_templateObject223 = absorb_taggedTemplateLiteral(["cubist bull"])))], [(0,template_string/* $skill */.tm)(_templateObject224 || (_templateObject224 = absorb_taggedTemplateLiteral(["Infernal Automata"]))), (0,template_string/* $monster */.O4)(_templateObject225 || (_templateObject225 = absorb_taggedTemplateLiteral(["demonic icebox"])))], [(0,template_string/* $skill */.tm)(_templateObject226 || (_templateObject226 = absorb_taggedTemplateLiteral(["Secondary Fermentation"]))), (0,template_string/* $monster */.O4)(_templateObject227 || (_templateObject227 = absorb_taggedTemplateLiteral(["drunk goat"])))], [(0,template_string/* $skill */.tm)(_templateObject228 || (_templateObject228 = absorb_taggedTemplateLiteral(["Double Nanovision"]))), (0,template_string/* $monster */.O4)(_templateObject229 || (_templateObject229 = absorb_taggedTemplateLiteral(["drunk pygmy"])))], [(0,template_string/* $skill */.tm)(_templateObject230 || (_templateObject230 = absorb_taggedTemplateLiteral(["Microweave"]))), (0,template_string/* $monster */.O4)(_templateObject231 || (_templateObject231 = absorb_taggedTemplateLiteral(["eXtreme cross-country hippy"])))], [(0,template_string/* $skill */.tm)(_templateObject232 || (_templateObject232 = absorb_taggedTemplateLiteral(["AUTOEXEC.BAT"]))), (0,template_string/* $monster */.O4)(_templateObject233 || (_templateObject233 = absorb_taggedTemplateLiteral(["Flock of Stab-bats"])))], [(0,template_string/* $skill */.tm)(_templateObject234 || (_templateObject234 = absorb_taggedTemplateLiteral(["Propagation Drive"]))), (0,template_string/* $monster */.O4)(_templateObject235 || (_templateObject235 = absorb_taggedTemplateLiteral(["junksprite bender"])))], [(0,template_string/* $skill */.tm)(_templateObject236 || (_templateObject236 = absorb_taggedTemplateLiteral(["Camp Subroutines"]))), (0,template_string/* $monster */.O4)(_templateObject237 || (_templateObject237 = absorb_taggedTemplateLiteral(["Knob Goblin Harem Girl"])))], [(0,template_string/* $skill */.tm)(_templateObject238 || (_templateObject238 = absorb_taggedTemplateLiteral(["Cryocurrency"]))), (0,template_string/* $monster */.O4)(_templateObject239 || (_templateObject239 = absorb_taggedTemplateLiteral(["Knob Goblin MBA"])))], [(0,template_string/* $skill */.tm)(_templateObject240 || (_templateObject240 = absorb_taggedTemplateLiteral(["Curses Library"]))), (0,template_string/* $monster */.O4)(_templateObject241 || (_templateObject241 = absorb_taggedTemplateLiteral(["lihc"])))], [(0,template_string/* $skill */.tm)(_templateObject242 || (_templateObject242 = absorb_taggedTemplateLiteral(["Clammy Microcilia"]))), (0,template_string/* $monster */.O4)(_templateObject243 || (_templateObject243 = absorb_taggedTemplateLiteral(["malevolent hair clog"])))], [(0,template_string/* $skill */.tm)(_templateObject244 || (_templateObject244 = absorb_taggedTemplateLiteral(["Financial Spreadsheets"]))), (0,template_string/* $monster */.O4)(_templateObject245 || (_templateObject245 = absorb_taggedTemplateLiteral(["me4t begZ0r"])))], [(0,template_string/* $skill */.tm)(_templateObject246 || (_templateObject246 = absorb_taggedTemplateLiteral(["Hivemindedness"]))), (0,template_string/* $monster */.O4)(_templateObject247 || (_templateObject247 = absorb_taggedTemplateLiteral(["mind flayer"])))], [(0,template_string/* $skill */.tm)(_templateObject248 || (_templateObject248 = absorb_taggedTemplateLiteral(["Cooling Tubules"]))), (0,template_string/* $monster */.O4)(_templateObject249 || (_templateObject249 = absorb_taggedTemplateLiteral(["Ninja Snowman Weaponmaster"])))], // [$skill`Lubricant Layer`, $monster`oil slick`],
[(0,template_string/* $skill */.tm)(_templateObject250 || (_templateObject250 = absorb_taggedTemplateLiteral(["Conifer Polymers"]))), (0,template_string/* $monster */.O4)(_templateObject251 || (_templateObject251 = absorb_taggedTemplateLiteral(["pine bat"])))], [(0,template_string/* $skill */.tm)(_templateObject252 || (_templateObject252 = absorb_taggedTemplateLiteral(["Subatomic Hardening"]))), (0,template_string/* $monster */.O4)(_templateObject253 || (_templateObject253 = absorb_taggedTemplateLiteral(["pooltergeist"])))], [(0,template_string/* $skill */.tm)(_templateObject254 || (_templateObject254 = absorb_taggedTemplateLiteral(["Legacy Code"]))), (0,template_string/* $monster */.O4)(_templateObject255 || (_templateObject255 = absorb_taggedTemplateLiteral(["possessed wine rack"])))], [(0,template_string/* $skill */.tm)(_templateObject256 || (_templateObject256 = absorb_taggedTemplateLiteral(["System Sweep"]))), (0,template_string/* $monster */.O4)(_templateObject257 || (_templateObject257 = absorb_taggedTemplateLiteral(["pygmy janitor"])))], [(0,template_string/* $skill */.tm)(_templateObject258 || (_templateObject258 = absorb_taggedTemplateLiteral(["Infinite Loop"]))), (0,template_string/* $monster */.O4)(_templateObject259 || (_templateObject259 = absorb_taggedTemplateLiteral(["pygmy witch lawyer"])))], [(0,template_string/* $skill */.tm)(_templateObject260 || (_templateObject260 = absorb_taggedTemplateLiteral(["Ire Proof"]))), (0,template_string/* $monster */.O4)(_templateObject261 || (_templateObject261 = absorb_taggedTemplateLiteral(["raging bull"])))], [(0,template_string/* $skill */.tm)(_templateObject262 || (_templateObject262 = absorb_taggedTemplateLiteral(["Nanofur"]))), (0,template_string/* $monster */.O4)(_templateObject263 || (_templateObject263 = absorb_taggedTemplateLiteral(["ratbat"])))], [(0,template_string/* $skill */.tm)(_templateObject264 || (_templateObject264 = absorb_taggedTemplateLiteral(["Procgen Ribaldry"]))), (0,template_string/* $monster */.O4)(_templateObject265 || (_templateObject265 = absorb_taggedTemplateLiteral(["smut orc screwer"])))], [(0,template_string/* $skill */.tm)(_templateObject266 || (_templateObject266 = absorb_taggedTemplateLiteral(["Snow-Cooling System"]))), (0,template_string/* $monster */.O4)(_templateObject267 || (_templateObject267 = absorb_taggedTemplateLiteral(["Snow Queen"])))], [(0,template_string/* $skill */.tm)(_templateObject268 || (_templateObject268 = absorb_taggedTemplateLiteral(["Phase Shift"]))), (0,template_string/* $monster */.O4)(_templateObject269 || (_templateObject269 = absorb_taggedTemplateLiteral(["Spectral Jellyfish"])))], [(0,template_string/* $skill */.tm)(_templateObject270 || (_templateObject270 = absorb_taggedTemplateLiteral(["Autovampirism Routines"]))), (0,template_string/* $monster */.O4)(_templateObject271 || (_templateObject271 = absorb_taggedTemplateLiteral(["spooky vampire"])))], [(0,template_string/* $skill */.tm)(_templateObject272 || (_templateObject272 = absorb_taggedTemplateLiteral(["Steam Mycelia"]))), (0,template_string/* $monster */.O4)(_templateObject273 || (_templateObject273 = absorb_taggedTemplateLiteral(["steam elemental"])))], [(0,template_string/* $skill */.tm)(_templateObject274 || (_templateObject274 = absorb_taggedTemplateLiteral(["Gravitational Compression"]))), (0,template_string/* $monster */.O4)(_templateObject275 || (_templateObject275 = absorb_taggedTemplateLiteral(["suckubus"])))], [(0,template_string/* $skill */.tm)(_templateObject276 || (_templateObject276 = absorb_taggedTemplateLiteral(["Grey Noise"]))), (0,template_string/* $monster */.O4)(_templateObject277 || (_templateObject277 = absorb_taggedTemplateLiteral(["Boss Bat"])))], [(0,template_string/* $skill */.tm)(_templateObject278 || (_templateObject278 = absorb_taggedTemplateLiteral(["Anti-Sleaze Recursion"]))), (0,template_string/* $monster */.O4)(_templateObject279 || (_templateObject279 = absorb_taggedTemplateLiteral(["werecougar"])))], [(0,template_string/* $skill */.tm)(_templateObject280 || (_templateObject280 = absorb_taggedTemplateLiteral(["Piezoelectric Honk"]))), (0,template_string/* $monster */.O4)(_templateObject281 || (_templateObject281 = absorb_taggedTemplateLiteral(["white lion"])))]]);
...
var AbsorbState = /*#__PURE__*/function () {
  function AbsorbState() {
    ...
    var needed_elem_skills = {
      hot: (0,template_string/* $skills */.nx)(_templateObject282 || (_templateObject282 = absorb_taggedTemplateLiteral(["Microburner, Infernal Automata, Steam Mycelia"]))),
      cold: (0,template_string/* $skills */.nx)(_templateObject283 || (_templateObject283 = absorb_taggedTemplateLiteral(["Cryocurrency, Cooling Tubules, Snow-Cooling System"]))),
      spooky: (0,template_string/* $skills */.nx)(_templateObject284 || (_templateObject284 = absorb_taggedTemplateLiteral(["Curses Library, Ominous Substrate, Legacy Code"]))),
      stench: (0,template_string/* $skills */.nx)(_templateObject285 || (_templateObject285 = absorb_taggedTemplateLiteral(["Exhaust Tubules, Secondary Fermentation, AUTOEXEC.BAT"]))),
      sleaze: (0,template_string/* $skills */.nx)(_templateObject286 || (_templateObject286 = absorb_taggedTemplateLiteral(["Camp Subroutines, Procgen Ribaldry, Innuendo Circuitry"])))
    };
    ...
    if (coldRes(false) >= 3) ignored_skills.add((0,template_string/* $skill */.tm)(_templateObject287 || (_templateObject287 = absorb_taggedTemplateLiteral(["Nanofur"])))); // Get at least 4 stench res for twin peaks

    if (stenchRes(false) >= 2) ignored_skills.add((0,template_string/* $skill */.tm)(_templateObject288 || (_templateObject288 = absorb_taggedTemplateLiteral(["Clammy Microcilia"])))); // Other res skills are only needed for the tower hedge maze

    var res_skills = (0,template_string/* $skills */.nx)(_templateObject289 || (_templateObject289 = absorb_taggedTemplateLiteral(["Ire Proof, Autovampirism Routines, Conifer Polymers, Anti-Sleaze Recursion, Localized Vacuum, Microweave, Ectogenesis, Lubricant Layer"])));
    ...
    if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject290 || (_templateObject290 = absorb_taggedTemplateLiteral(["frozen jeans"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject291 || (_templateObject291 = absorb_taggedTemplateLiteral(["June cleaver"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject292 || (_templateObject292 = absorb_taggedTemplateLiteral(["industrial fire extinguisher"])))) && !(0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject293 || (_templateObject293 = absorb_taggedTemplateLiteral(["Cryocurrency"])))) && !(0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject294 || (_templateObject294 = absorb_taggedTemplateLiteral(["Cooling Tubules"]))))) {
      ignored_skills.delete((0,template_string/* $skill */.tm)(_templateObject295 || (_templateObject295 = absorb_taggedTemplateLiteral(["Snow-Cooling System"]))));
    }
    ...
    var icehouse = (0,lib/* getBanishedMonsters */.$c)().get((0,template_string/* $item */.xr)(_templateObject296 || (_templateObject296 = absorb_taggedTemplateLiteral(["ice house"]))));
  ...
  absorb_createClass(AbsorbState, [{
    ...
    value: function skillCompleted(skill) {
      ...
      return (0,lib/* have */.lf)(skill) || this.ignoredSkills.has(skill);
    }
  }]);
...
var AbsorbQuest = {
  ...
  tasks: [].concat(absorb_toConsumableArray(absorbTasks.map(task => {
    ...
    if (result.outfit === undefined) result.outfit = {
      equip: (0,template_string/* $items */.vS)(_templateObject297 || (_templateObject297 = absorb_taggedTemplateLiteral(["miniature crystal ball"])))
    };
    return result;
    ...
    var result = absorb_objectSpread(absorb_objectSpread({
      ...
      completed: state => {
        ...
        return state.absorb.skillCompleted((_task$skill2 = task.skill) !== null && _task$skill2 !== void 0 ? _task$skill2 : (0,template_string/* $skill */.tm)(_templateObject298 || (_templateObject298 = absorb_taggedTemplateLiteral(["none"]))));
      }
    }, task), {}, {
...
var ReprocessQuest = {
  ...
  tasks: [].concat(absorb_toConsumableArray(absorbTasks.map(task => {
    ...
    var result = absorb_objectSpread(absorb_objectSpread({
      ...
      ready: state => (task.ready === undefined || task.ready(state)) && (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(_templateObject300 || (_templateObject300 = absorb_taggedTemplateLiteral(["Grey Goose"])))) >= 6,
...
function coldRes(with_black_paint) {
  var res = 0;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject302 || (_templateObject302 = absorb_taggedTemplateLiteral(["ice crown"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject303 || (_templateObject303 = absorb_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject304 || (_templateObject304 = absorb_taggedTemplateLiteral(["Nanofur"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject305 || (_templateObject305 = absorb_taggedTemplateLiteral(["Microweave"]))))) res += 2;
  if (with_black_paint && ((0,lib/* have */.lf)((0,template_string/* $effect */._G)(_templateObject306 || (_templateObject306 = absorb_taggedTemplateLiteral(["Red Door Syndrome"])))) || (0,external_kolmafia_.myMeat)() >= 1000 && step("questL11Black") >= 2)) res += 2;
  return res;
}
function stenchRes(with_black_paint) {
  var res = 0;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject307 || (_templateObject307 = absorb_taggedTemplateLiteral(["ice crown"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(_templateObject308 || (_templateObject308 = absorb_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject309 || (_templateObject309 = absorb_taggedTemplateLiteral(["Conifer Polymers"]))))) res += 3;
  if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(_templateObject310 || (_templateObject310 = absorb_taggedTemplateLiteral(["Clammy Microcilia"]))))) res += 2;
...
var BatQuest = {
  ...
  tasks: [{
    ...
    ready: () => ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject3 || (level4_templateObject3 = level4_taggedTemplateLiteral(["industrial fire extinguisher"])))) || (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(level4_templateObject4 || (level4_templateObject4 = level4_taggedTemplateLiteral(["Double Nanovision"]))))) && stenchRes(true) >= 1,
    prepare: () => {
      if ((0,external_kolmafia_.numericModifier)("stench resistance") < 1) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level4_templateObject5 || (level4_templateObject5 = level4_taggedTemplateLiteral(["Red Door Syndrome"]))));
      if ((0,external_kolmafia_.numericModifier)("stench resistance") < 1) throw "Unable to ensure cold res for The Icy Peak";
    },
    post: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject6 || (level4_templateObject6 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject7 || (level4_templateObject7 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))));
    },
    outfit: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject8 || (level4_templateObject8 = level4_taggedTemplateLiteral(["industrial fire extinguisher"])))) && (0,property/* get */.U2)("_fireExtinguisherCharge") >= 20 && !(0,property/* get */.U2)("fireExtinguisherBatHoleUsed")) return {
        equip: (0,template_string/* $items */.vS)(level4_templateObject9 || (level4_templateObject9 = level4_taggedTemplateLiteral(["industrial fire extinguisher"]))),
        modifier: "stench res"
      };else return {
        modifier: "item, 10 stench res"
      };
    },
    combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(level4_templateObject10 || (level4_templateObject10 = level4_taggedTemplateLiteral(["Fire Extinguisher: Zone Specific"]))))).kill((0,template_string/* $monster */.O4)(level4_templateObject11 || (level4_templateObject11 = level4_taggedTemplateLiteral(["screambat"])))).killItem(),
    limit: {
      tries: 10
    }
  }, {
    ...
    after: ["Get Sonar 1"],
    completed: () => step("questL04Bat") >= 1,
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject12 || (level4_templateObject12 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"])))),
    limit: {
      tries: 3
    },
    freeaction: true
    ...
    completed: () => step("questL04Bat") + (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level4_templateObject13 || (level4_templateObject13 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"])))) >= 2,
    do: (0,template_string/* $location */.PG)(level4_templateObject14 || (level4_templateObject14 = level4_taggedTemplateLiteral(["Guano Junction"]))),
    post: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject15 || (level4_templateObject15 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject16 || (level4_templateObject16 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))));
    },
    outfit: {
      modifier: "item, 10 stench res"
    },
    combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level4_templateObject17 || (level4_templateObject17 = level4_taggedTemplateLiteral(["screambat"])))).killItem(),
    limit: {
      tries: 10
    }
  }, {
    ...
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject18 || (level4_templateObject18 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"])))),
    limit: {
      tries: 3
    },
    freeaction: true
    ...
    name: "Get Sonar 3",
    after: ["Use Sonar 2"],
    completed: () => step("questL04Bat") + (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level4_templateObject19 || (level4_templateObject19 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"])))) >= 3,
    do: (0,template_string/* $location */.PG)(level4_templateObject20 || (level4_templateObject20 = level4_taggedTemplateLiteral(["Guano Junction"]))),
    post: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject21 || (level4_templateObject21 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject22 || (level4_templateObject22 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"]))));
    },
    outfit: {
      modifier: "item, 10 stench res"
    },
    combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level4_templateObject23 || (level4_templateObject23 = level4_taggedTemplateLiteral(["screambat"])))).killItem(),
    limit: {
      tries: 10
    }
  }, {
    ...
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level4_templateObject24 || (level4_templateObject24 = level4_taggedTemplateLiteral(["sonar-in-a-biscuit"])))),
    limit: {
      tries: 3
    },
    freeaction: true
    ...
    after: ["Use Sonar 3"],
    ready: () => (0,property/* get */.U2)("lastCopyableMonster") === (0,template_string/* $monster */.O4)(level4_templateObject25 || (level4_templateObject25 = level4_taggedTemplateLiteral(["lobsterfrogman"]))),
    priority: () => (0,property/* get */.U2)("lastCopyableMonster") === (0,template_string/* $monster */.O4)(level4_templateObject26 || (level4_templateObject26 = level4_taggedTemplateLiteral(["lobsterfrogman"]))) ? OverridePriority.LastCopyableMonster : OverridePriority.None,
    completed: () => step("questL04Bat") >= 4 || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level4_templateObject27 || (level4_templateObject27 = level4_taggedTemplateLiteral(["barrel of gunpowder"])))) >= 5 || (0,property/* get */.U2)("sidequestLighthouseCompleted") !== "none" || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level4_templateObject28 || (level4_templateObject28 = level4_taggedTemplateLiteral(["backup camera"])))),
    do: (0,template_string/* $location */.PG)(level4_templateObject29 || (level4_templateObject29 = level4_taggedTemplateLiteral(["The Boss Bat's Lair"]))),
    combat: (_CombatStrategy$macro = new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(level4_templateObject30 || (level4_templateObject30 = level4_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))))).kill.apply(_CombatStrategy$macro, level4_toConsumableArray((0,template_string/* $monsters */.fr)(level4_templateObject31 || (level4_templateObject31 = level4_taggedTemplateLiteral(["Boss Bat, lobsterfrogman"]))))),
    outfit: {
      equip: (0,template_string/* $items */.vS)(level4_templateObject32 || (level4_templateObject32 = level4_taggedTemplateLiteral(["backup camera"])))
    },
    limit: {
      tries: 4
    }
    ...
    do: (0,template_string/* $location */.PG)(level4_templateObject33 || (level4_templateObject33 = level4_taggedTemplateLiteral(["The Boss Bat's Lair"]))),
    combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level4_templateObject34 || (level4_templateObject34 = level4_taggedTemplateLiteral(["Boss Bat"])))).ignoreNoBanish(),
    limit: {
      soft: 10
    },
    delay: 6
...
var extraReprocessTargets = [{
  ...
  target: (0,template_string/* $monster */.O4)(summons_templateObject || (summons_templateObject = summons_taggedTemplateLiteral(["One-Eyed Willie"]))),
  needed: () => (0,external_kolmafia_.myAscensions)() % 2 === 1
}, {
  after: ["Absorb/The Hole in the Sky"],
  target: (0,template_string/* $monster */.O4)(summons_templateObject2 || (summons_templateObject2 = summons_taggedTemplateLiteral(["Little Man in the Canoe"]))),
  needed: () => (0,external_kolmafia_.myAscensions)() % 2 === 0
}, {
  after: ["Misc/Retune Moon"],
  target: (0,template_string/* $monster */.O4)(summons_templateObject3 || (summons_templateObject3 = summons_taggedTemplateLiteral(["revolving bugbear"]))),
  needed: () => !(0,external_kolmafia_.knollAvailable)()
}, {
  after: ["Misc/Retune Moon"],
  target: (0,template_string/* $monster */.O4)(summons_templateObject4 || (summons_templateObject4 = summons_taggedTemplateLiteral(["cloud of disembodied whiskers"]))),
  needed: () => !(0,external_kolmafia_.canadiaAvailable)()
}, {
  after: ["Misc/Retune Moon"],
  target: (0,template_string/* $monster */.O4)(summons_templateObject5 || (summons_templateObject5 = summons_taggedTemplateLiteral(["vicious gnauga"]))),
  needed: () => !(0,external_kolmafia_.gnomadsAvailable)()
}];
var summonTargets = [{
  target: (0,template_string/* $monster */.O4)(summons_templateObject6 || (summons_templateObject6 = summons_taggedTemplateLiteral(["pygmy witch lawyer"]))),
  priority: () => OverridePriority.Start,
  after: [],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(summons_templateObject7 || (summons_templateObject7 = summons_taggedTemplateLiteral(["Infinite Loop"])))),
  acquire: [{
    item: (0,template_string/* $item */.xr)(summons_templateObject8 || (summons_templateObject8 = summons_taggedTemplateLiteral(["Arr, M80"]))),
    num: 2,
    useful: () => (0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(summons_templateObject9 || (summons_templateObject9 = summons_taggedTemplateLiteral(["Vampire Vintner"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject10 || (summons_templateObject10 = summons_taggedTemplateLiteral(["cosmic bowling ball"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject11 || (summons_templateObject11 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))
  }, {
    // Backup plan if missing Vintner/bowling ball
    item: (0,template_string/* $item */.xr)(summons_templateObject12 || (summons_templateObject12 = summons_taggedTemplateLiteral(["yellow rocket"]))),
    num: 1,
    useful: () => !(0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(summons_templateObject13 || (summons_templateObject13 = summons_taggedTemplateLiteral(["Vampire Vintner"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject14 || (summons_templateObject14 = summons_taggedTemplateLiteral(["cosmic bowling ball"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject15 || (summons_templateObject15 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))
  }],
  prepare: () => {
    if (((0,external_kolmafia_.equippedAmount)((0,template_string/* $item */.xr)(summons_templateObject16 || (summons_templateObject16 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) === 0 || (0,external_kolmafia_.myFamiliar)() !== (0,template_string/* $familiar */.HP)(summons_templateObject17 || (summons_templateObject17 = summons_taggedTemplateLiteral(["Vampire Vintner"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject18 || (summons_templateObject18 = summons_taggedTemplateLiteral(["yellow rocket"]))))) (0,external_kolmafia_.abort)("Not ready for pygmy locket");
    if ((0,external_kolmafia_.equippedAmount)((0,template_string/* $item */.xr)(summons_templateObject19 || (summons_templateObject19 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))) > 0) (0,external_kolmafia_.cliExecute)("retrocape heck hold");
  ...
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().tryItem((0,template_string/* $item */.xr)(summons_templateObject20 || (summons_templateObject20 = summons_taggedTemplateLiteral(["yellow rocket"])))).tryItem((0,template_string/* $item */.xr)(summons_templateObject21 || (summons_templateObject21 = summons_taggedTemplateLiteral(["cosmic bowling ball"])))).step("if hascombatitem 10769;use Arr;endif;") // Arr, M80; "use Arr, M80" trys and fails to funksling
  .step("if hascombatitem 10769;use Arr;endif;").skill((0,template_string/* $skill */.tm)(summons_templateObject22 || (summons_templateObject22 = summons_taggedTemplateLiteral(["Pseudopod Slap"])))).repeat()),
  outfit: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(summons_templateObject23 || (summons_templateObject23 = summons_taggedTemplateLiteral(["Vampire Vintner"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject24 || (summons_templateObject24 = summons_taggedTemplateLiteral(["cosmic bowling ball"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject25 || (summons_templateObject25 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) return {
      modifier: "init",
      equip: (0,template_string/* $items */.vS)(summons_templateObject26 || (summons_templateObject26 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))),
      familiar: (0,template_string/* $familiar */.HP)(summons_templateObject27 || (summons_templateObject27 = summons_taggedTemplateLiteral(["Vampire Vintner"])))
    };else return {
      modifier: "init, -1ML"
    }; // Just use yellow rocket
  }
}, yellowray({
  target: (0,template_string/* $monster */.O4)(summons_templateObject28 || (summons_templateObject28 = summons_taggedTemplateLiteral(["mountain man"]))),
  after: [],
  completed: () => {
    if (step("questL08Trapper") >= 2) return true;
    if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject29 || (summons_templateObject29 = summons_taggedTemplateLiteral(["Clan VIP Lounge key"]))))) return true; // For now, do not do without yellow rocket

    var ore_needed = 3;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject30 || (summons_templateObject30 = summons_taggedTemplateLiteral(["Deck of Every Card"])))) && (0,property/* get */.U2)("_deckCardsDrawn") === 0) ore_needed--;
    ...
    if (!pulled.has((0,template_string/* $item */.xr)(summons_templateObject31 || (summons_templateObject31 = summons_taggedTemplateLiteral(["asbestos ore"])))) && !pulled.has((0,template_string/* $item */.xr)(summons_templateObject32 || (summons_templateObject32 = summons_taggedTemplateLiteral(["chrome ore"])))) && !pulled.has((0,template_string/* $item */.xr)(summons_templateObject33 || (summons_templateObject33 = summons_taggedTemplateLiteral(["linoleum ore"]))))) ore_needed--;
    return (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(summons_templateObject34 || (summons_templateObject34 = summons_taggedTemplateLiteral(["asbestos ore"])))) >= ore_needed || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(summons_templateObject35 || (summons_templateObject35 = summons_taggedTemplateLiteral(["chrome ore"])))) >= ore_needed || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(summons_templateObject36 || (summons_templateObject36 = summons_taggedTemplateLiteral(["linoleum ore"])))) >= ore_needed;
  },
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject37 || (summons_templateObject37 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))))) (0,external_kolmafia_.cliExecute)("retrocape heck hold");
  },
  outfit: {
    equip: (0,template_string/* $items */.vS)(summons_templateObject38 || (summons_templateObject38 = summons_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"])))
  },
  combat: new src_combat.CombatStrategy()
}, {
  modifier: "item"
  ...
  return {
    ...
    after: target.after,
    completed: state => !state.absorb.isReprocessTarget(target.target) || !target.needed(),
    priority: () => OverridePriority.GoodGoose,
    ready: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(summons_templateObject39 || (summons_templateObject39 = summons_taggedTemplateLiteral(["Grey Goose"])))) >= 6,
    outfit: () => {
      if (have() && !unlockedLocketMonsters().includes(target.target)) {
        // Store this monster in the locket for the next run
        return {
          familiar: (0,template_string/* $familiar */.HP)(summons_templateObject40 || (summons_templateObject40 = summons_taggedTemplateLiteral(["Grey Goose"]))),
          equip: (0,template_string/* $items */.vS)(summons_templateObject41 || (summons_templateObject41 = summons_taggedTemplateLiteral(["combat lover's locket"])))
        };
      } else {
        return {
          familiar: (0,template_string/* $familiar */.HP)(summons_templateObject42 || (summons_templateObject42 = summons_taggedTemplateLiteral(["Grey Goose"])))
        };
      }
    },
    combat: new src_combat.CombatStrategy().autoattack(new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(summons_templateObject43 || (summons_templateObject43 = summons_taggedTemplateLiteral(["Re-Process Matter"]))))).macro(new dist_combat/* Macro */.LE().trySkill((0,template_string/* $skill */.tm)(summons_templateObject44 || (summons_templateObject44 = summons_taggedTemplateLiteral(["Re-Process Matter"]))))).kill()
  };
})), [{
  target: (0,template_string/* $monster */.O4)(summons_templateObject45 || (summons_templateObject45 = summons_taggedTemplateLiteral(["white lion"]))),
  after: ["Hidden City/Bowling Skills"],
  ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject46 || (summons_templateObject46 = summons_taggedTemplateLiteral(["white page"])))),
  completed: () => (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(summons_templateObject47 || (summons_templateObject47 = summons_taggedTemplateLiteral(["Piezoelectric Honk"])))),
  choices: {
    940: 2
  },
  outfit: {
...
var summonSources = [{
  name: "Cargo Shorts",
  available: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject48 || (summons_templateObject48 = summons_taggedTemplateLiteral(["Cargo Cultist Shorts"])))) && !(0,property/* get */.U2)("_cargoPocketEmptied") ? 1 : 0,
  canFight: mon => mon === (0,template_string/* $monster */.O4)(summons_templateObject49 || (summons_templateObject49 = summons_taggedTemplateLiteral(["mountain man"]))),
  // Only use for mountain man
  summon: () => (0,external_kolmafia_.cliExecute)('cargo 565')
}, {
  name: "White Page",
  available: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject50 || (summons_templateObject50 = summons_taggedTemplateLiteral(["white page"])))) ? 1 : 0,
  canFight: mon => mon === (0,template_string/* $monster */.O4)(summons_templateObject51 || (summons_templateObject51 = summons_taggedTemplateLiteral(["white lion"]))),
  // Only use for mountain man
  summon: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(summons_templateObject52 || (summons_templateObject52 = summons_taggedTemplateLiteral(["white page"]))))
}, {
  name: "Fax",
  available: () => args.fax && !(0,property/* get */.U2)("_photocopyUsed") ? 1 : 0,
  canFight: mon => (0,external_kolmafia_.canFaxbot)(mon),
  summon: mon => {
    (0,external_kolmafia_.chatPrivate)("cheesefax", mon.name);
    ...
    (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(summons_templateObject53 || (summons_templateObject53 = summons_taggedTemplateLiteral(["photocopied monster"]))));
  }
}, {
  name: "Combat Locket",
  ...
  name: "Wish",
  available: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject54 || (summons_templateObject54 = summons_taggedTemplateLiteral(["genie bottle"])))) ? 3 - (0,property/* get */.U2)("_genieWishesUsed") : 0,
  canFight: () => true,
  summon: mon => {
    (0,external_kolmafia_.cliExecute)("genie monster ".concat(mon.name));
    (0,external_kolmafia_.visitUrl)("main.php");
  }
}]; // From garbo

function checkFax(mon) {
  if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(summons_templateObject55 || (summons_templateObject55 = summons_taggedTemplateLiteral(["photocopied monster"]))))) (0,external_kolmafia_.cliExecute)("fax receive");
  if ((0,property/* get */.U2)("photocopyMonster") === mon) return true;
...
var SummonStrategy = /*#__PURE__*/function () {
  ...
  summons_createClass(SummonStrategy, [{
    ...
    value: function update(state) {
      this.plan.clear();
      var targets = this.targets.filter(t => !t.completed(state)).map(t => t.target);
      ...
      if (!(0,lib/* have */.lf)((0,template_string/* $skill */.tm)(summons_templateObject56 || (summons_templateObject56 = summons_taggedTemplateLiteral(["Infinite Loop"])))) && !this.plan.has((0,template_string/* $monster */.O4)(summons_templateObject57 || (summons_templateObject57 = summons_taggedTemplateLiteral(["pygmy witch lawyer"]))))) throw "Unable to summon pygmy witch lawyer";
    }
  }, {
    key: "getSourceFor",
  ...
  tasks: summonTargets.map(task => {
    return summons_objectSpread(summons_objectSpread({}, task), {}, {
      ...
      ready: state => {
        ...
        return ((_task$ready = (_task$ready2 = task.ready) === null || _task$ready2 === void 0 ? void 0 : _task$ready2.call(task, state)) !== null && _task$ready !== void 0 ? _task$ready : true) && summonStrategy.getSourceFor(task.target) !== undefined;
      },
      do: () => {
        // Some extra safety around the Pygmy Witch Lawyer summon
        if (task.target === (0,template_string/* $monster */.O4)(summons_templateObject58 || (summons_templateObject58 = summons_taggedTemplateLiteral(["pygmy witch lawyer"])))) {
          if ((0,property/* get */.U2)("_loopgyou_fought_pygmy", false)) {
            if (!(0,external_kolmafia_.userConfirm)("We already tried to fight a pygmy witch lawyer today and lost (or failed to start the fight). Are you sure we can win this time? Consider fighting a pygymy witch lawyer yourself (buy yellow rocket; ensure you have no ML running and +50 combat initative). Press yes to let the script try the fight again, or no to abort.")) {
              throw "Abort requested";
            }
          }

          (0,property/* set */.t8)("_loopgyou_fought_pygmy", true);
...
var level8_templateObject, level8_templateObject2, level8_templateObject3, level8_templateObject4, level8_templateObject5, level8_templateObject6, level8_templateObject7, level8_templateObject8, level8_templateObject9, level8_templateObject10, _CombatStrategy$killI, level8_templateObject11, level8_templateObject12, level8_templateObject13, level8_templateObject14, level8_templateObject15, level8_templateObject16, level8_templateObject17, level8_templateObject18, level8_templateObject19, level8_templateObject20, level8_templateObject21;
...
var McLargeHugeQuest = {
  ...
  tasks: [{
    ...
    ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level8_templateObject || (level8_templateObject = level8_taggedTemplateLiteral(["11-leaf clover"])))),
    prepare: () => {
      if (!(0,lib/* have */.lf)((0,template_string/* $effect */._G)(level8_templateObject2 || (level8_templateObject2 = level8_taggedTemplateLiteral(["Lucky!"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level8_templateObject3 || (level8_templateObject3 = level8_taggedTemplateLiteral(["11-leaf clover"]))));
    },
    completed: () => (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level8_templateObject4 || (level8_templateObject4 = level8_taggedTemplateLiteral(["asbestos ore"])))) >= 3 || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level8_templateObject5 || (level8_templateObject5 = level8_taggedTemplateLiteral(["chrome ore"])))) >= 3 || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level8_templateObject6 || (level8_templateObject6 = level8_taggedTemplateLiteral(["linoleum ore"])))) >= 3 || step("questL08Trapper") >= 2 || summonStrategy.getSourceFor((0,template_string/* $monster */.O4)(level8_templateObject7 || (level8_templateObject7 = level8_taggedTemplateLiteral(["mountain man"])))) !== undefined,
    do: (0,template_string/* $location */.PG)(level8_templateObject8 || (level8_templateObject8 = level8_taggedTemplateLiteral(["Itznotyerzitz Mine"]))),
    limit: {
      tries: 2
    }
  }, {
    ...
    completed: () => (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level8_templateObject9 || (level8_templateObject9 = level8_taggedTemplateLiteral(["goat cheese"])))) >= 3 || step("questL08Trapper") >= 2,
    do: (0,template_string/* $location */.PG)(level8_templateObject10 || (level8_templateObject10 = level8_taggedTemplateLiteral(["The Goatlet"]))),
    outfit: {
      modifier: "item"
    },
    combat: (_CombatStrategy$killI = new src_combat.CombatStrategy().killItem((0,template_string/* $monster */.O4)(level8_templateObject11 || (level8_templateObject11 = level8_taggedTemplateLiteral(["dairy goat"]))))).banish.apply(_CombatStrategy$killI, level8_toConsumableArray((0,template_string/* $monsters */.fr)(level8_templateObject12 || (level8_templateObject12 = level8_taggedTemplateLiteral(["drunk goat, sabre-toothed goat"]))))),
    limit: {
      soft: 15
    }
  }, {
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level8_templateObject13 || (level8_templateObject13 = level8_taggedTemplateLiteral(["ninja rope"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level8_templateObject14 || (level8_templateObject14 = level8_taggedTemplateLiteral(["ninja carabiner"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level8_templateObject15 || (level8_templateObject15 = level8_taggedTemplateLiteral(["ninja crampons"])))) || step("questL08Trapper") >= 3,
    prepare: () => {
      fillHp();
    },
    do: (0,template_string/* $location */.PG)(level8_templateObject16 || (level8_templateObject16 = level8_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))),
    outfit: {
    ...
    combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level8_templateObject17 || (level8_templateObject17 = level8_taggedTemplateLiteral(["Frozen Solid Snake"]))), (0,template_string/* $monster */.O4)(level8_templateObject18 || (level8_templateObject18 = level8_taggedTemplateLiteral(["ninja snowman assassin"])))),
    ...
    ready: () => coldRes(true) >= 5,
    prepare: () => {
      if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level8_templateObject19 || (level8_templateObject19 = level8_taggedTemplateLiteral(["Red Door Syndrome"]))));
      if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) throw "Unable to ensure cold res for The Icy Peak";
    },
    do: () => {
    ...
    ready: () => coldRes(true) >= 5,
    prepare: () => {
      if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level8_templateObject20 || (level8_templateObject20 = level8_taggedTemplateLiteral(["Red Door Syndrome"]))));
      if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) throw "Unable to ensure cold res for The Icy Peak";
    },
    do: (0,template_string/* $location */.PG)(level8_templateObject21 || (level8_templateObject21 = level8_taggedTemplateLiteral(["Mist-Shrouded Peak"]))),
    outfit: {
      modifier: "cold res"
    },
    combat: new src_combat.CombatStrategy(true).kill(),
...
var Twin = [{
  ...
  after: ["Start Peaks"],
  ready: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level9_templateObject23 || (level9_templateObject23 = level9_taggedTemplateLiteral(["rusty hedge trimmers"])))) && stenchRes(true) >= 4,
  completed: () => !!((0,property/* get */.U2)("twinPeakProgress") & 1),
  prepare: () => {
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 4) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level9_templateObject24 || (level9_templateObject24 = level9_taggedTemplateLiteral(["Red Door Syndrome"]))));
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 4) throw "Unable to ensure cold res for The Icy Peak";
  },
  do: (0,template_string/* $location */.PG)(level9_templateObject25 || (level9_templateObject25 = level9_taggedTemplateLiteral(["Twin Peak"]))),
  choices: {
    606: 1,
    607: 1
  },
  ...
  name: "Twin Stench",
  after: ["Start Peaks"],
  ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level9_templateObject27 || (level9_templateObject27 = level9_taggedTemplateLiteral(["rusty hedge trimmers"])))) && stenchRes(true) >= 4,
  completed: () => !!((0,property/* get */.U2)("twinPeakProgress") & 1),
  prepare: () => {
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 4) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level9_templateObject28 || (level9_templateObject28 = level9_taggedTemplateLiteral(["Red Door Syndrome"]))));
    if ((0,external_kolmafia_.numericModifier)("stench resistance") < 4) throw "Unable to ensure cold res for The Icy Peak";
  },
  do: () => {
    (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level9_templateObject29 || (level9_templateObject29 = level9_taggedTemplateLiteral(["rusty hedge trimmers"]))));
  },
  choices: {
    606: 1,
    607: 1
...
var GiantQuest = {
  ...
  tasks: [{
    ...
    do: (0,template_string/* $location */.PG)(level10_templateObject6 || (level10_templateObject6 = level10_taggedTemplateLiteral(["The Penultimate Fantasy Airship"]))),
    choices: {
      178: 2,
      182: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject7 || (level10_templateObject7 = level10_taggedTemplateLiteral(["model airship"])))) ? 1 : 4
    },
    post: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $effect */._G)(level10_templateObject8 || (level10_templateObject8 = level10_taggedTemplateLiteral(["Temporary Amnesia"]))))) (0,external_kolmafia_.cliExecute)("uneffect Temporary Amnesia");
    },
    orbtargets: () => undefined,
    outfit: {
      modifier: "-combat"
    ...
    delay: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject9 || (level10_templateObject9 = level10_taggedTemplateLiteral(["Plastic Wrap Immateria"])))) ? 25 : (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject10 || (level10_templateObject10 = level10_taggedTemplateLiteral(["Gauze Immateria"])))) ? 20 : 15,
    // After that, just look for noncombats
    combat: new src_combat.CombatStrategy().killItem((0,template_string/* $monster */.O4)(level10_templateObject11 || (level10_templateObject11 = level10_taggedTemplateLiteral(["Burly Sidekick"])))).killItem((0,template_string/* $monster */.O4)(level10_templateObject12 || (level10_templateObject12 = level10_taggedTemplateLiteral(["Quiet Healer"]))))
  }, {
    modifier: "-combat, item"
  }, (0,template_string/* $monster */.O4)(level10_templateObject13 || (level10_templateObject13 = level10_taggedTemplateLiteral(["Quiet Healer"])))), {
    name: "Airship",
    after: ["Airship YR Healer"],
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject14 || (level10_templateObject14 = level10_taggedTemplateLiteral(["S.O.C.K."])))),
    do: (0,template_string/* $location */.PG)(level10_templateObject15 || (level10_templateObject15 = level10_taggedTemplateLiteral(["The Penultimate Fantasy Airship"]))),
    choices: {
      178: 2,
      182: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject16 || (level10_templateObject16 = level10_taggedTemplateLiteral(["model airship"])))) ? 1 : 4
    },
    post: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $effect */._G)(level10_templateObject17 || (level10_templateObject17 = level10_taggedTemplateLiteral(["Temporary Amnesia"]))))) (0,external_kolmafia_.cliExecute)("uneffect Temporary Amnesia");
    },
    outfit: {
      modifier: "-combat"
    },
    ...
    delay: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject18 || (level10_templateObject18 = level10_taggedTemplateLiteral(["Plastic Wrap Immateria"])))) ? 25 : (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject19 || (level10_templateObject19 = level10_taggedTemplateLiteral(["Gauze Immateria"])))) ? 20 : 15,
    // After that, just look for noncombats
    combat: new src_combat.CombatStrategy().killItem((0,template_string/* $monster */.O4)(level10_templateObject20 || (level10_templateObject20 = level10_taggedTemplateLiteral(["Quiet Healer"]))), (0,template_string/* $monster */.O4)(level10_templateObject21 || (level10_templateObject21 = level10_taggedTemplateLiteral(["Burly Sidekick"]))))
  }, {
    name: "Basement Search",
    after: ["Airship"],
    completed: () => (0,external_kolmafia_.containsText)((0,template_string/* $location */.PG)(level10_templateObject22 || (level10_templateObject22 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Basement)"]))).noncombatQueue, "Mess Around with Gym") || step("questL10Garbage") >= 8,
    do: (0,template_string/* $location */.PG)(level10_templateObject23 || (level10_templateObject23 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Basement)"]))),
    outfit: {
      modifier: "-combat"
    },
    limit: {
    ...
    do: (0,template_string/* $location */.PG)(level10_templateObject24 || (level10_templateObject24 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Basement)"]))),
    outfit: {
      equip: (0,template_string/* $items */.vS)(level10_templateObject25 || (level10_templateObject25 = level10_taggedTemplateLiteral(["amulet of extreme plot significance"])))
    },
    choices: {
      670: 4
    },
    ...
    do: (0,template_string/* $location */.PG)(level10_templateObject26 || (level10_templateObject26 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Ground Floor)"]))),
    choices: {
      672: 3,
      673: 3,
      674: 3,
    ...
    outfit: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject27 || (level10_templateObject27 = level10_taggedTemplateLiteral(["electric boning knife"]))))) return {};else return {
        modifier: "-combat"
      };
    },
    limit: {
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject28 || (level10_templateObject28 = level10_taggedTemplateLiteral(["electric boning knife"])))) || step("questL13Final") > 8 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject29 || (level10_templateObject29 = level10_taggedTemplateLiteral(["Great Wolf's rocket launcher"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject30 || (level10_templateObject30 = level10_taggedTemplateLiteral(["Drunkula's bell"])))),
    do: (0,template_string/* $location */.PG)(level10_templateObject31 || (level10_templateObject31 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Ground Floor)"]))),
    choices: {
      672: 3,
      673: 3,
      674: 3,
    ...
    do: (0,template_string/* $location */.PG)(level10_templateObject32 || (level10_templateObject32 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Top Floor)"]))),
    outfit: {
      equip: (0,template_string/* $items */.vS)(level10_templateObject33 || (level10_templateObject33 = level10_taggedTemplateLiteral(["Mohawk wig"]))),
      modifier: "-combat"
    },
    combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level10_templateObject34 || (level10_templateObject34 = level10_taggedTemplateLiteral(["Burning Snake of Fire"])))),
    choices: {
      675: 4,
      676: 4,
      677: 1,
    ...
    name: "Unlock HITS",
    after: ["Top Floor"],
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level10_templateObject35 || (level10_templateObject35 = level10_taggedTemplateLiteral(["steam-powered model rocketship"])))),
    do: (0,template_string/* $location */.PG)(level10_templateObject36 || (level10_templateObject36 = level10_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Top Floor)"]))),
    outfit: {
      modifier: "-combat"
    },
...
var Copperhead = [{
  ...
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject8 || (level11_palindome_templateObject8 = level11_palindome_taggedTemplateLiteral(["The Stankara Stone"])))) && ((0,template_string/* $location */.PG)(level11_palindome_templateObject9 || (level11_palindome_templateObject9 = level11_palindome_taggedTemplateLiteral(["The Batrat and Ratbat Burrow"]))).turnsSpent < 5 || (0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(level11_palindome_templateObject10 || (level11_palindome_templateObject10 = level11_palindome_taggedTemplateLiteral(["Moxie"])))) >= 200),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject11 || (level11_palindome_templateObject11 = level11_palindome_taggedTemplateLiteral(["The Stankara Stone"])))) || (0,external_kolmafia_.myDaycount)() === 1 && step("questL11Shen") > 1,
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject12 || (level11_palindome_templateObject12 = level11_palindome_taggedTemplateLiteral(["The Batrat and Ratbat Burrow"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject13 || (level11_palindome_templateObject13 = level11_palindome_taggedTemplateLiteral(["Batsnake"])))).killItem(),
  outfit: {
    modifier: "item"
  },
  limit: {
  ...
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject14 || (level11_palindome_templateObject14 = level11_palindome_taggedTemplateLiteral(["The First Pizza"])))),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject15 || (level11_palindome_templateObject15 = level11_palindome_taggedTemplateLiteral(["The First Pizza"])))) || (0,external_kolmafia_.myDaycount)() === 1 && step("questL11Shen") > 3,
  prepare: () => {
    (0,external_kolmafia_.restoreHp)((0,external_kolmafia_.myMaxhp)());
  },
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject16 || (level11_palindome_templateObject16 = level11_palindome_taggedTemplateLiteral(["Lair of the Ninja Snowmen"]))),
  outfit: {
    modifier: "50 combat, init"
  },
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject17 || (level11_palindome_templateObject17 = level11_palindome_taggedTemplateLiteral(["Frozen Solid Snake"]))), (0,template_string/* $monster */.O4)(level11_palindome_templateObject18 || (level11_palindome_templateObject18 = level11_palindome_taggedTemplateLiteral(["ninja snowman assassin"])))),
  orbtargets: () => [],
  ...
  acquire: [{
    item: (0,template_string/* $item */.xr)(level11_palindome_templateObject19 || (level11_palindome_templateObject19 = level11_palindome_taggedTemplateLiteral(["Mohawk wig"])))
  }],
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject20 || (level11_palindome_templateObject20 = level11_palindome_taggedTemplateLiteral(["Murphy's Rancid Black Flag"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject21 || (level11_palindome_templateObject21 = level11_palindome_taggedTemplateLiteral(["steam-powered model rocketship"])))),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject22 || (level11_palindome_templateObject22 = level11_palindome_taggedTemplateLiteral(["Murphy's Rancid Black Flag"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject23 || (level11_palindome_templateObject23 = level11_palindome_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Top Floor)"]))),
  outfit: {
    equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject24 || (level11_palindome_templateObject24 = level11_palindome_taggedTemplateLiteral(["Mohawk wig"]))),
    modifier: "-combat"
  },
  choices: {
    675: 4,
  ...
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject25 || (level11_palindome_templateObject25 = level11_palindome_taggedTemplateLiteral(["Burning Snake of Fire"])))),
  limit: {
    soft: 10
  },
  delay: 5
  ...
  after: ["Copperhead Start", "Giant/Ground"],
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject26 || (level11_palindome_templateObject26 = level11_palindome_taggedTemplateLiteral(["Murphy's Rancid Black Flag"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject27 || (level11_palindome_templateObject27 = level11_palindome_taggedTemplateLiteral(["steam-powered model rocketship"])))),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject28 || (level11_palindome_templateObject28 = level11_palindome_taggedTemplateLiteral(["Murphy's Rancid Black Flag"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject29 || (level11_palindome_templateObject29 = level11_palindome_taggedTemplateLiteral(["The Castle in the Clouds in the Sky (Top Floor)"]))),
  choices: {
    675: 4,
    676: 4,
    677: 1,
  ...
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject30 || (level11_palindome_templateObject30 = level11_palindome_taggedTemplateLiteral(["Burning Snake of Fire"])))),
  limit: {
    soft: 10
  },
  delay: 5
  ...
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject31 || (level11_palindome_templateObject31 = level11_palindome_taggedTemplateLiteral(["The Eye of the Stars"])))),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject32 || (level11_palindome_templateObject32 = level11_palindome_taggedTemplateLiteral(["The Eye of the Stars"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject33 || (level11_palindome_templateObject33 = level11_palindome_taggedTemplateLiteral(["The Hole in the Sky"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject34 || (level11_palindome_templateObject34 = level11_palindome_taggedTemplateLiteral(["The Snake With Like Ten Heads"])))),
  limit: {
    soft: 10
  },
  delay: 5
  ...
  after: ["Copperhead Start"],
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject35 || (level11_palindome_templateObject35 = level11_palindome_taggedTemplateLiteral(["The Lacrosse Stick of Lacoronado"])))),
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject36 || (level11_palindome_templateObject36 = level11_palindome_taggedTemplateLiteral(["The Lacrosse Stick of Lacoronado"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject37 || (level11_palindome_templateObject37 = level11_palindome_taggedTemplateLiteral(["The Smut Orc Logging Camp"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject38 || (level11_palindome_templateObject38 = level11_palindome_taggedTemplateLiteral(["The Frattlesnake"])))),
  limit: {
    soft: 10
  },
  delay: 5
  ...
  after: ["Copperhead Start"],
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject39 || (level11_palindome_templateObject39 = level11_palindome_taggedTemplateLiteral(["The Shield of Brook"])))) && step("questL07Cyrptic") < 999,
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject40 || (level11_palindome_templateObject40 = level11_palindome_taggedTemplateLiteral(["The Shield of Brook"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject41 || (level11_palindome_templateObject41 = level11_palindome_taggedTemplateLiteral(["The Unquiet Garves"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject42 || (level11_palindome_templateObject42 = level11_palindome_taggedTemplateLiteral(["Snakeleton"])))),
  limit: {
    soft: 10
  },
  delay: 5
  ...
  after: ["Copperhead Start"],
  ready: () => shenItem((0,template_string/* $item */.xr)(level11_palindome_templateObject43 || (level11_palindome_templateObject43 = level11_palindome_taggedTemplateLiteral(["The Shield of Brook"])))) && step("questL07Cyrptic") === 999,
  completed: () => step("questL11Shen") === 999 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject44 || (level11_palindome_templateObject44 = level11_palindome_taggedTemplateLiteral(["The Shield of Brook"])))),
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject45 || (level11_palindome_templateObject45 = level11_palindome_taggedTemplateLiteral(["The VERY Unquiet Garves"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject46 || (level11_palindome_templateObject46 = level11_palindome_taggedTemplateLiteral(["Snakeleton"])))),
  limit: {
    soft: 10
  },
  delay: 5
...
var Zepplin = [{
  ...
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject47 || (level11_palindome_templateObject47 = level11_palindome_taggedTemplateLiteral(["A Mob of Zeppelin Protesters"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject48 || (level11_palindome_templateObject48 = level11_palindome_taggedTemplateLiteral(["The Nuge"])))),
  choices: {
    856: 1,
    857: 1,
    858: 1,
  ...
  ready: () => (0,external_kolmafia_.canEquip)((0,template_string/* $item */.xr)(level11_palindome_templateObject49 || (level11_palindome_templateObject49 = level11_palindome_taggedTemplateLiteral(["transparent pants"])))) && ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level11_palindome_templateObject50 || (level11_palindome_templateObject50 = level11_palindome_taggedTemplateLiteral(["11-leaf clover"])))) > 1 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject51 || (level11_palindome_templateObject51 = level11_palindome_taggedTemplateLiteral(["Flamin' Whatshisname"])))) || step("questL11Shen") === 999),
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject52 || (level11_palindome_templateObject52 = level11_palindome_taggedTemplateLiteral(["lynyrd musk"]))))) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(level11_palindome_templateObject53 || (level11_palindome_templateObject53 = level11_palindome_taggedTemplateLiteral(["Musky"]))));
    if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level11_palindome_templateObject54 || (level11_palindome_templateObject54 = level11_palindome_taggedTemplateLiteral(["11-leaf clover"])))) > 1 && !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(level11_palindome_templateObject55 || (level11_palindome_templateObject55 = level11_palindome_taggedTemplateLiteral(["Lucky!"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(level11_palindome_templateObject56 || (level11_palindome_templateObject56 = level11_palindome_taggedTemplateLiteral(["11-leaf clover"]))));
  },
  completed: () => (0,property/* get */.U2)("zeppelinProtestors") >= 80,
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject57 || (level11_palindome_templateObject57 = level11_palindome_taggedTemplateLiteral(["A Mob of Zeppelin Protesters"]))),
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().tryItem((0,template_string/* $item */.xr)(level11_palindome_templateObject58 || (level11_palindome_templateObject58 = level11_palindome_taggedTemplateLiteral(["cigarette lighter"]))))).killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject59 || (level11_palindome_templateObject59 = level11_palindome_taggedTemplateLiteral(["The Nuge"])))).killItem((0,template_string/* $monster */.O4)(level11_palindome_templateObject60 || (level11_palindome_templateObject60 = level11_palindome_taggedTemplateLiteral(["Blue Oyster cultist"])))).killItem((0,template_string/* $monster */.O4)(level11_palindome_templateObject61 || (level11_palindome_templateObject61 = level11_palindome_taggedTemplateLiteral(["lynyrd skinner"])))).kill(),
  choices: {
    856: 1,
    857: 1,
    858: 1,
  ...
  outfit: () => {
    var sleazeitems = (0,template_string/* $items */.vS)(level11_palindome_templateObject62 || (level11_palindome_templateObject62 = level11_palindome_taggedTemplateLiteral(["deck of lewd playing cards"])));
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject63 || (level11_palindome_templateObject63 = level11_palindome_taggedTemplateLiteral(["designer sweatpants"]))))) sleazeitems.push((0,template_string/* $item */.xr)(level11_palindome_templateObject64 || (level11_palindome_templateObject64 = level11_palindome_taggedTemplateLiteral(["designer sweatpants"]))));else if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject65 || (level11_palindome_templateObject65 = level11_palindome_taggedTemplateLiteral(["transparent pants"]))))) sleazeitems.push((0,template_string/* $item */.xr)(level11_palindome_templateObject66 || (level11_palindome_templateObject66 = level11_palindome_taggedTemplateLiteral(["transparent pants"]))));
    if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(level11_palindome_templateObject67 || (level11_palindome_templateObject67 = level11_palindome_taggedTemplateLiteral(["11-leaf clover"])))) > 1 || (0,lib/* have */.lf)((0,template_string/* $effect */._G)(level11_palindome_templateObject68 || (level11_palindome_templateObject68 = level11_palindome_taggedTemplateLiteral(["Lucky!"]))))) return {
      modifier: "sleaze dmg, sleaze spell dmg",
      equip: sleazeitems,
      skipDefaults: true
    };
  ...
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject69 || (level11_palindome_templateObject69 = level11_palindome_taggedTemplateLiteral(["A Mob of Zeppelin Protesters"]))),
  combat: new src_combat.CombatStrategy().killHard((0,template_string/* $monster */.O4)(level11_palindome_templateObject70 || (level11_palindome_templateObject70 = level11_palindome_taggedTemplateLiteral(["The Nuge"])))),
  choices: {
    856: 1,
    857: 1,
    858: 1,
  ...
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject71 || (level11_palindome_templateObject71 = level11_palindome_taggedTemplateLiteral(["Red Zeppelin ticket"]))))) return;
    (0,external_kolmafia_.visitUrl)("woods.php");
    ...
    if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject72 || (level11_palindome_templateObject72 = level11_palindome_taggedTemplateLiteral(["Red Zeppelin ticket"]))))) throw "Unable to buy Red Zeppelin ticket; please buy manually";
  },
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject73 || (level11_palindome_templateObject73 = level11_palindome_taggedTemplateLiteral(["The Red Zeppelin"]))),
  combat: (_CombatStrategy$kill$ = (level11_palindome_CombatStrategy$kill = new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(level11_palindome_templateObject74 || (level11_palindome_templateObject74 = level11_palindome_taggedTemplateLiteral(["Ron \"The Weasel\" Copperhead"]))))).macro.apply(level11_palindome_CombatStrategy$kill, [() => {
    if ((0,property/* get */.U2)("_glarkCableUses") < 5) return new dist_combat/* Macro */.LE().tryItem((0,template_string/* $item */.xr)(level11_palindome_templateObject75 || (level11_palindome_templateObject75 = level11_palindome_taggedTemplateLiteral(["glark cable"]))));else return new dist_combat/* Macro */.LE();
  }].concat(level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject76 || (level11_palindome_templateObject76 = level11_palindome_taggedTemplateLiteral(["man with the red buttons, red skeleton, red butler"]))))))).banish.apply(_CombatStrategy$kill$, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject77 || (level11_palindome_templateObject77 = level11_palindome_taggedTemplateLiteral(["Red Herring, Red Snapper"]))))).kill(),
  limit: {
    soft: 13
  }
}];
var Dome = [{
  ...
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject78 || (level11_palindome_templateObject78 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"])))),
  do: () => (0,external_kolmafia_.create)((0,template_string/* $item */.xr)(level11_palindome_templateObject79 || (level11_palindome_templateObject79 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"])))),
  limit: {
    tries: 1
  },
  freeaction: true
  ...
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject80 || (level11_palindome_templateObject80 = level11_palindome_taggedTemplateLiteral(["photograph of a dog"])))) || step("questL11Palindome") >= 3,
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject81 || (level11_palindome_templateObject81 = level11_palindome_taggedTemplateLiteral(["Inside the Palindome"]))),
  outfit: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject82 || (level11_palindome_templateObject82 = level11_palindome_taggedTemplateLiteral(["stunt nuts"]))))) return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject83 || (level11_palindome_templateObject83 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat"
    };
    return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject84 || (level11_palindome_templateObject84 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat, item"
    };
  },
  combat: (_CombatStrategy$banis = (_CombatStrategy$banis2 = (level11_palindome_CombatStrategy = new src_combat.CombatStrategy()).banish.apply(level11_palindome_CombatStrategy, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject85 || (level11_palindome_templateObject85 = level11_palindome_taggedTemplateLiteral(["Evil Olive, Flock of Stab-bats, Taco Cat, Tan Gnat"])))))).macro.apply(_CombatStrategy$banis2, [new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(level11_palindome_templateObject86 || (level11_palindome_templateObject86 = level11_palindome_taggedTemplateLiteral(["disposable instant camera"]))))].concat(level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject87 || (level11_palindome_templateObject87 = level11_palindome_taggedTemplateLiteral(["Bob Racecar, Racecar Bob"]))))))).killItem.apply(_CombatStrategy$banis, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject88 || (level11_palindome_templateObject88 = level11_palindome_taggedTemplateLiteral(["Bob Racecar, Racecar Bob"]))))).kill(),
  limit: {
    soft: 20
  }
}, {
  ...
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject89 || (level11_palindome_templateObject89 = level11_palindome_taggedTemplateLiteral(["Inside the Palindome"]))),
  outfit: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject90 || (level11_palindome_templateObject90 = level11_palindome_taggedTemplateLiteral(["stunt nuts"]))))) return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject91 || (level11_palindome_templateObject91 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat"
    };
    return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject92 || (level11_palindome_templateObject92 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat, item"
    };
  },
  combat: (_CombatStrategy$banis3 = (level11_palindome_CombatStrategy2 = new src_combat.CombatStrategy()).banish.apply(level11_palindome_CombatStrategy2, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject93 || (level11_palindome_templateObject93 = level11_palindome_taggedTemplateLiteral(["Evil Olive, Flock of Stab-bats, Taco Cat, Tan Gnat"])))))).killItem.apply(_CombatStrategy$banis3, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject94 || (level11_palindome_templateObject94 = level11_palindome_taggedTemplateLiteral(["Bob Racecar, Racecar Bob"]))))).kill(),
  limit: {
    soft: 20
  }
}, {
  ...
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject95 || (level11_palindome_templateObject95 = level11_palindome_taggedTemplateLiteral(["photograph of a red nugget"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject96 || (level11_palindome_templateObject96 = level11_palindome_taggedTemplateLiteral(["photograph of God"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject97 || (level11_palindome_templateObject97 = level11_palindome_taggedTemplateLiteral(["photograph of an ostrich egg"])))) || step("questL11Palindome") >= 3,
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject98 || (level11_palindome_templateObject98 = level11_palindome_taggedTemplateLiteral(["Inside the Palindome"]))),
  outfit: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject99 || (level11_palindome_templateObject99 = level11_palindome_taggedTemplateLiteral(["stunt nuts"]))))) return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject100 || (level11_palindome_templateObject100 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat"
    };
    return {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject101 || (level11_palindome_templateObject101 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
      modifier: "-combat, item"
    };
  },
  combat: (level11_palindome_CombatStrategy3 = new src_combat.CombatStrategy()).killItem.apply(level11_palindome_CombatStrategy3, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject102 || (level11_palindome_templateObject102 = level11_palindome_taggedTemplateLiteral(["Bob Racecar, Racecar Bob"]))))),
  limit: {
    soft: 20
  }
}, {
  ...
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject103 || (level11_palindome_templateObject103 = level11_palindome_taggedTemplateLiteral(["Inside the Palindome"]))),
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject104 || (level11_palindome_templateObject104 = level11_palindome_taggedTemplateLiteral(["stunt nuts"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject105 || (level11_palindome_templateObject105 = level11_palindome_taggedTemplateLiteral(["wet stunt nut stew"])))) || step("questL11Palindome") >= 5,
  outfit: {
    equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject106 || (level11_palindome_templateObject106 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"]))),
    modifier: "item"
  },
  combat: (level11_palindome_CombatStrategy4 = new src_combat.CombatStrategy()).killItem.apply(level11_palindome_CombatStrategy4, level11_palindome_toConsumableArray((0,template_string/* $monsters */.fr)(level11_palindome_templateObject107 || (level11_palindome_templateObject107 = level11_palindome_taggedTemplateLiteral(["Bob Racecar, Racecar Bob"]))))),
  limit: {
    soft: 20
  }
}, {
  ...
  outfit: {
    equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject108 || (level11_palindome_templateObject108 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"])))
  },
  limit: {
    tries: 1
  },
  ...
  name: "Grove",
  after: ["Alarm Gem"],
  completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject109 || (level11_palindome_templateObject109 = level11_palindome_taggedTemplateLiteral(["bird rib"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject110 || (level11_palindome_templateObject110 = level11_palindome_taggedTemplateLiteral(["lion oil"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject111 || (level11_palindome_templateObject111 = level11_palindome_taggedTemplateLiteral(["wet stew"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject112 || (level11_palindome_templateObject112 = level11_palindome_taggedTemplateLiteral(["wet stunt nut stew"])))) || step("questL11Palindome") >= 5,
  do: (0,template_string/* $location */.PG)(level11_palindome_templateObject113 || (level11_palindome_templateObject113 = level11_palindome_taggedTemplateLiteral(["Whitey's Grove"]))),
  outfit: {
    modifier: "50 combat, item"
  },
  combat: new src_combat.CombatStrategy().killItem((0,template_string/* $monster */.O4)(level11_palindome_templateObject114 || (level11_palindome_templateObject114 = level11_palindome_taggedTemplateLiteral(["whitesnake"])))).killItem((0,template_string/* $monster */.O4)(level11_palindome_templateObject115 || (level11_palindome_templateObject115 = level11_palindome_taggedTemplateLiteral(["white lion"])))),
  limit: {
    soft: 15
  }
}, {
  ...
  do: () => {
    if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_palindome_templateObject116 || (level11_palindome_templateObject116 = level11_palindome_taggedTemplateLiteral(["wet stunt nut stew"]))))) (0,external_kolmafia_.create)((0,template_string/* $item */.xr)(level11_palindome_templateObject117 || (level11_palindome_templateObject117 = level11_palindome_taggedTemplateLiteral(["wet stunt nut stew"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=palindome&action=pal_mrlabel");
  },
  outfit: {
    equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject118 || (level11_palindome_templateObject118 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat"])))
  },
  limit: {
    tries: 1
  },
...
var PalindomeQuest = {
  ...
  tasks: [].concat(Copperhead, Zepplin, Dome, [{
    ...
    outfit: {
      equip: (0,template_string/* $items */.vS)(level11_palindome_templateObject119 || (level11_palindome_templateObject119 = level11_palindome_taggedTemplateLiteral(["Talisman o' Namsilat, Mega Gem"])))
    },
    choices: {
      131: 1
    },
...
var Pyramid = [{
  ...
  outfit: () => {
    if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(level11_templateObject102 || (level11_templateObject102 = level11_taggedTemplateLiteral(["Pick-O-Matic lockpicks"])))) && !towerSkip()) return {
...
var heroKeys = [{
  ...
  acquire: [{
    item: (0,template_string/* $item */.xr)(keys_templateObject3 || (keys_templateObject3 = keys_taggedTemplateLiteral(["daily dungeon malware"])))
  }, {
    item: (0,template_string/* $item */.xr)(keys_templateObject4 || (keys_templateObject4 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))),
    optional: true
  }, {
    item: (0,template_string/* $item */.xr)(keys_templateObject5 || (keys_templateObject5 = keys_taggedTemplateLiteral(["eleven-foot pole"]))),
    optional: true
  }, {
    item: (0,template_string/* $item */.xr)(keys_templateObject6 || (keys_templateObject6 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"]))),
    optional: true
  }],
  ready: () => (step("questL13Final") !== -1 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject7 || (keys_templateObject7 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject8 || (keys_templateObject8 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject9 || (keys_templateObject9 = keys_taggedTemplateLiteral(["eleven-foot pole"]))))) && towerReady(),
  after: [],
  completed: () => (0,property/* get */.U2)("dailyDungeonDone") || (0,property/* get */.U2)("_dailyDungeonMalwareUsed"),
  prepare: () => {
    (0,property/* set */.t8)("_loop_gyou_malware_amount", (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject10 || (keys_templateObject10 = keys_taggedTemplateLiteral(["daily dungeon malware"])))));
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject11 || (keys_templateObject11 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))))) return;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject12 || (keys_templateObject12 = keys_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) return;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject13 || (keys_templateObject13 = keys_taggedTemplateLiteral(["skeleton bone"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject14 || (keys_templateObject14 = keys_taggedTemplateLiteral(["loose teeth"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject15 || (keys_templateObject15 = keys_taggedTemplateLiteral(["skeleton key"]))))) (0,external_kolmafia_.cliExecute)("make skeleton key");
  },
  do: (0,template_string/* $location */.PG)(keys_templateObject16 || (keys_templateObject16 = keys_taggedTemplateLiteral(["The Daily Dungeon"]))),
  post: () => {
    if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject17 || (keys_templateObject17 = keys_taggedTemplateLiteral(["daily dungeon malware"])))) < (0,property/* get */.U2)("_loop_gyou_malware_amount", 0)) (0,property/* set */.t8)("_dailyDungeonMalwareUsed", true);
    (0,lib/* uneffect */.Lo)((0,template_string/* $effect */._G)(keys_templateObject18 || (keys_templateObject18 = keys_taggedTemplateLiteral(["Apathy"]))));
  },
  outfit: {
    equip: (0,template_string/* $items */.vS)(keys_templateObject19 || (keys_templateObject19 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"]))),
    modifier: "init"
  },
  // Avoid apathy
  combat: new src_combat.CombatStrategy().macro(new dist_combat/* Macro */.LE().item((0,template_string/* $item */.xr)(keys_templateObject20 || (keys_templateObject20 = keys_taggedTemplateLiteral(["daily dungeon malware"]))))).kill(),
  choices: {
    689: 1,
    690: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject21 || (keys_templateObject21 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) ? 2 : 3,
    691: () => 3,
    // Do not skip the second chest; there is a chance we skip all the monsters
    692: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject22 || (keys_templateObject22 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))))) return 3;
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject23 || (keys_templateObject23 = keys_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) return 7;
      if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject24 || (keys_templateObject24 = keys_taggedTemplateLiteral(["skeleton key"])))) + min((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject25 || (keys_templateObject25 = keys_taggedTemplateLiteral(["skeleton bone"])))), (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject26 || (keys_templateObject26 = keys_taggedTemplateLiteral(["loose teeth"]))))) > 1) return 2;
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject27 || (keys_templateObject27 = keys_taggedTemplateLiteral(["skeleton key"])))) && (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("skeleton key")) return 2;
      return 4;
    },
    693: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject28 || (keys_templateObject28 = keys_taggedTemplateLiteral(["eleven-foot pole"])))) ? 2 : 1
  },
  limit: {
    tries: 15
  }
  ...
  acquire: [{
    item: (0,template_string/* $item */.xr)(keys_templateObject29 || (keys_templateObject29 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))),
    optional: true
  }, {
    item: (0,template_string/* $item */.xr)(keys_templateObject30 || (keys_templateObject30 = keys_taggedTemplateLiteral(["eleven-foot pole"]))),
    optional: true
  }, {
    item: (0,template_string/* $item */.xr)(keys_templateObject31 || (keys_templateObject31 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"]))),
    optional: true
  }],
  ready: () => (step("questL13Final") !== -1 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject32 || (keys_templateObject32 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject33 || (keys_templateObject33 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject34 || (keys_templateObject34 = keys_taggedTemplateLiteral(["eleven-foot pole"]))))) && towerReady(),
  after: ["Daily Dungeon Malware"],
  completed: () => (0,property/* get */.U2)("dailyDungeonDone"),
  prepare: () => {
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject35 || (keys_templateObject35 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))))) return;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject36 || (keys_templateObject36 = keys_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) return;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject37 || (keys_templateObject37 = keys_taggedTemplateLiteral(["skeleton bone"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject38 || (keys_templateObject38 = keys_taggedTemplateLiteral(["loose teeth"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject39 || (keys_templateObject39 = keys_taggedTemplateLiteral(["skeleton key"]))))) (0,external_kolmafia_.cliExecute)("make skeleton key");
  },
  do: (0,template_string/* $location */.PG)(keys_templateObject40 || (keys_templateObject40 = keys_taggedTemplateLiteral(["The Daily Dungeon"]))),
  post: () => {
    (0,lib/* uneffect */.Lo)((0,template_string/* $effect */._G)(keys_templateObject41 || (keys_templateObject41 = keys_taggedTemplateLiteral(["Apathy"]))));
  },
  outfit: {
    equip: (0,template_string/* $items */.vS)(keys_templateObject42 || (keys_templateObject42 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"]))),
    modifier: "init"
  },
  // Avoid apathy
  combat: new src_combat.CombatStrategy().kill(),
  choices: {
    689: 1,
    690: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject43 || (keys_templateObject43 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) ? 2 : 3,
    691: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject44 || (keys_templateObject44 = keys_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) ? 2 : 3,
    692: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject45 || (keys_templateObject45 = keys_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))))) return 3;
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject46 || (keys_templateObject46 = keys_taggedTemplateLiteral(["Platinum Yendorian Express Card"]))))) return 7;
      if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject47 || (keys_templateObject47 = keys_taggedTemplateLiteral(["skeleton key"])))) + min((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject48 || (keys_templateObject48 = keys_taggedTemplateLiteral(["skeleton bone"])))), (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject49 || (keys_templateObject49 = keys_taggedTemplateLiteral(["loose teeth"]))))) > 1) return 2;
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject50 || (keys_templateObject50 = keys_taggedTemplateLiteral(["skeleton key"])))) && (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("skeleton key")) return 2;
      return 4;
    },
    693: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject51 || (keys_templateObject51 = keys_taggedTemplateLiteral(["eleven-foot pole"])))) ? 2 : 1
  },
  limit: {
    tries: 15
  }
  ...
  ready: () => (0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(keys_templateObject52 || (keys_templateObject52 = keys_taggedTemplateLiteral(["moxie"])))) >= 120,
  completed: () => (0,template_string/* $location */.PG)(keys_templateObject53 || (keys_templateObject53 = keys_taggedTemplateLiteral(["The Bandit Crossroads"]))).turnsSpent >= 5,
  do: (0,template_string/* $location */.PG)(keys_templateObject54 || (keys_templateObject54 = keys_taggedTemplateLiteral(["The Bandit Crossroads"]))),
  outfit: {
    familiar: (0,template_string/* $familiar */.HP)(keys_templateObject55 || (keys_templateObject55 = keys_taggedTemplateLiteral(["none"]))),
    equip: (0,template_string/* $items */.vS)(keys_templateObject56 || (keys_templateObject56 = keys_taggedTemplateLiteral(["FantasyRealm G. E. M."]))),
    modifier: "moxie"
  },
  combat: new src_combat.CombatStrategy().kill(),
  limit: {
  ...
  which: Keys.Zap,
  possible: () => (0,property/* get */.U2)("lastZapperWandExplosionDay") <= 0,
  after: ["Wand/Wand"],
  ready: () => towerReady(),
  completed: () => (0,property/* get */.U2)("lastZapperWandExplosionDay") >= 1 || (0,property/* get */.U2)("_zapCount") >= 1 && !(0,lib/* have */.lf)(keyStrategy.getZapChoice()),
  do: () => {
    unequipAcc(keyStrategy.getZapChoice());
    if (!(0,lib/* have */.lf)(keyStrategy.getZapChoice()) && (0,external_kolmafia_.myTurncount)() >= 1000) (0,external_kolmafia_.buy)(keyStrategy.getZapChoice(), 1, 100000);
    (0,external_kolmafia_.cliExecute)("zap ".concat(keyStrategy.getZapChoice()));
  },
  limit: {
    tries: 1
  },
...
var KeysQuest = {
  ...
  tasks: [].concat(keys_toConsumableArray(keyStrategy.tasks.map(task => {
    ...
    name: "Open 8-Bit",
    after: [],
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject57 || (keys_templateObject57 = keys_taggedTemplateLiteral(["continuum transfunctioner"])))),
    do: () => {
      if (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject58 || (keys_templateObject58 = keys_taggedTemplateLiteral(["continuum transfunctioner"]))))) {
    ...
    name: "Digital Key",
    after: ["Open 8-Bit"],
    ready: () => step("questL13Final") > 2 || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject59 || (keys_templateObject59 = keys_taggedTemplateLiteral(["Powerful Glove"])))),
    completed: () => (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("digital key") || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject60 || (keys_templateObject60 = keys_taggedTemplateLiteral(["digital key"])))) || (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject61 || (keys_templateObject61 = keys_taggedTemplateLiteral(["white pixel"])))) + Math.min((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject62 || (keys_templateObject62 = keys_taggedTemplateLiteral(["blue pixel"])))), (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject63 || (keys_templateObject63 = keys_taggedTemplateLiteral(["red pixel"])))), (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject64 || (keys_templateObject64 = keys_taggedTemplateLiteral(["green pixel"]))))) >= 30 || towerSkip(),
    do: (0,template_string/* $location */.PG)(keys_templateObject65 || (keys_templateObject65 = keys_taggedTemplateLiteral(["8-Bit Realm"]))),
    outfit: {
      equip: (0,template_string/* $items */.vS)(keys_templateObject66 || (keys_templateObject66 = keys_taggedTemplateLiteral(["continuum transfunctioner"]))),
      modifier: "item"
    },
    combat: new src_combat.CombatStrategy().kill(),
    limit: {
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject67 || (keys_templateObject67 = keys_taggedTemplateLiteral(["star chart"])))) && (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject68 || (keys_templateObject68 = keys_taggedTemplateLiteral(["star"])))) >= 8 && (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject69 || (keys_templateObject69 = keys_taggedTemplateLiteral(["line"])))) >= 7 || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject70 || (keys_templateObject70 = keys_taggedTemplateLiteral(["Richard's star key"])))) || (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("Richard's star key") || towerSkip(),
    do: (0,template_string/* $location */.PG)(keys_templateObject71 || (keys_templateObject71 = keys_taggedTemplateLiteral(["The Hole in the Sky"]))),
    outfit: {
      modifier: "item"
    },
    combat: new src_combat.CombatStrategy().kill((0,template_string/* $monster */.O4)(keys_templateObject72 || (keys_templateObject72 = keys_taggedTemplateLiteral(["Astronomer"])))).killItem(),
    limit: {
      soft: 20
    },
    orbtargets: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject73 || (keys_templateObject73 = keys_taggedTemplateLiteral(["star chart"])))) ? [(0,template_string/* $monster */.O4)(keys_templateObject74 || (keys_templateObject74 = keys_taggedTemplateLiteral(["Astronomer"])))] : []
  }, {
    name: "Skeleton Key",
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject75 || (keys_templateObject75 = keys_taggedTemplateLiteral(["skeleton bone"])))) && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject76 || (keys_templateObject76 = keys_taggedTemplateLiteral(["loose teeth"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject77 || (keys_templateObject77 = keys_taggedTemplateLiteral(["skeleton key"])))) || (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("skeleton key") || towerSkip(),
    outfit: {
      modifier: "item"
    },
    combat: (keys_CombatStrategy = new src_combat.CombatStrategy()).killItem.apply(keys_CombatStrategy, keys_toConsumableArray((0,template_string/* $monsters */.fr)(keys_templateObject78 || (keys_templateObject78 = keys_taggedTemplateLiteral(["factory-irregular skeleton, remaindered skeleton, swarm of skulls"]))))).banish((0,template_string/* $monster */.O4)(keys_templateObject79 || (keys_templateObject79 = keys_taggedTemplateLiteral(["novelty tropical skeleton"])))),
    do: (0,template_string/* $location */.PG)(keys_templateObject80 || (keys_templateObject80 = keys_taggedTemplateLiteral(["The Skeleton Store"]))),
    limit: {
      soft: 10
    }
  }])
...
function keyCount() {
  var count = (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(keys_templateObject81 || (keys_templateObject81 = keys_taggedTemplateLiteral(["fat loot token"]))));
  if (towerSkip()) count += (0,external_kolmafia_.storageAmount)((0,template_string/* $item */.xr)(keys_templateObject82 || (keys_templateObject82 = keys_taggedTemplateLiteral(["fat loot token"]))));
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject83 || (keys_templateObject83 = keys_taggedTemplateLiteral(["Boris's key"])))) || (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("Boris")) count++;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject84 || (keys_templateObject84 = keys_taggedTemplateLiteral(["Jarlsberg's key"])))) || (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("Jarlsberg")) count++;
  if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(keys_templateObject85 || (keys_templateObject85 = keys_taggedTemplateLiteral(["Sneaky Pete's key"])))) || (0,property/* get */.U2)("nsTowerDoorKeysUsed").includes("Sneaky Pete")) count++;
  return count;
}
...
function unequipAcc(acc) {
  ...
  var _iterator2 = keys_createForOfIteratorHelper((0,template_string/* $slots */.ei)(keys_templateObject86 || (keys_templateObject86 = keys_taggedTemplateLiteral(["acc1, acc2, acc3"])))),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var slot = _step2.value;
      if ((0,external_kolmafia_.equippedItem)(slot) === acc) (0,external_kolmafia_.equip)(slot, (0,template_string/* $item */.xr)(keys_templateObject87 || (keys_templateObject87 = keys_taggedTemplateLiteral(["none"]))));
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
...
function makeZapChoice() {
  var options = (0,template_string/* $items */.vS)(keys_templateObject88 || (keys_templateObject88 = keys_taggedTemplateLiteral(["Boris's ring, Jarlsberg's earring, Sneaky Pete's breath spray"])));
  ...
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      ...
      if ((0,lib/* have */.lf)(option)) return option;
    }
  } catch (err) {
    _iterator3.e(err);
  } finally {
  ...
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      ...
      if ((0,external_kolmafia_.storageAmount)(_option) > 0) return _option;
  ...
  return options.sort((i, j) => (0,external_kolmafia_.mallPrice)(i) - (0,external_kolmafia_.mallPrice)(j))[0];
}
...
var Outfit = /*#__PURE__*/function () {
  ...
  outfit_createClass(Outfit, [{
    ...
    value: function equip(item) {
      ...
      if (!(0,lib/* have */.lf)(item) && item !== (0,template_string/* $familiar */.HP)(outfit_templateObject || (outfit_templateObject = outfit_taggedTemplateLiteral(["none"])))) return false;
      ...
      if (item instanceof external_kolmafia_.Item) {
        ...
        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject2 || (outfit_templateObject2 = outfit_taggedTemplateLiteral(["familiar"]))) && this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject3 || (outfit_templateObject3 = outfit_taggedTemplateLiteral(["none"])))) {
          return false;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject4 || (outfit_templateObject4 = outfit_taggedTemplateLiteral(["acc1"])))) {
          if (this.accesories.length >= 3) return false;
          this.accesories.push(item);
          return true;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject5 || (outfit_templateObject5 = outfit_taggedTemplateLiteral(["off-hand"])))) {
          var weapon = this.equips.get((0,template_string/* $slot */.Jh)(outfit_templateObject6 || (outfit_templateObject6 = outfit_taggedTemplateLiteral(["weapon"]))));
        ...
        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject7 || (outfit_templateObject7 = outfit_taggedTemplateLiteral(["weapon"]))) && !this.equips.has((0,template_string/* $slot */.Jh)(outfit_templateObject8 || (outfit_templateObject8 = outfit_taggedTemplateLiteral(["off-hand"])))) && (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(outfit_templateObject9 || (outfit_templateObject9 = outfit_taggedTemplateLiteral(["Double-Fisted Skull Smashing"])))) && (0,external_kolmafia_.weaponHands)(item)) {
          this.equips.set((0,template_string/* $slot */.Jh)(outfit_templateObject10 || (outfit_templateObject10 = outfit_taggedTemplateLiteral(["off-hand"]))), item);
          return true;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject11 || (outfit_templateObject11 = outfit_taggedTemplateLiteral(["off-hand"]))) && (0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(outfit_templateObject12 || (outfit_templateObject12 = outfit_taggedTemplateLiteral(["Left-Hand Man"])))) && this.familiar === undefined && !this.equips.has((0,template_string/* $slot */.Jh)(outfit_templateObject13 || (outfit_templateObject13 = outfit_taggedTemplateLiteral(["familiar"]))))) {
          if (item === (0,template_string/* $item */.xr)(outfit_templateObject14 || (outfit_templateObject14 = outfit_taggedTemplateLiteral(["cursed magnifying glass"]))) && !canChargeVoid()) {
            var _this$equips$get;

            // Cursed magnifying glass cannot trigger in Lefty
            this.equips.set((0,template_string/* $slot */.Jh)(outfit_templateObject15 || (outfit_templateObject15 = outfit_taggedTemplateLiteral(["familiar"]))), (_this$equips$get = this.equips.get((0,template_string/* $slot */.Jh)(outfit_templateObject16 || (outfit_templateObject16 = outfit_taggedTemplateLiteral(["off-hand"]))))) !== null && _this$equips$get !== void 0 ? _this$equips$get : (0,template_string/* $item */.xr)(outfit_templateObject17 || (outfit_templateObject17 = outfit_taggedTemplateLiteral(["none"]))));
            this.equips.set((0,template_string/* $slot */.Jh)(outfit_templateObject18 || (outfit_templateObject18 = outfit_taggedTemplateLiteral(["off-hand"]))), item);
          } else {
            this.familiar = (0,template_string/* $familiar */.HP)(outfit_templateObject19 || (outfit_templateObject19 = outfit_taggedTemplateLiteral(["Left-Hand Man"])));
            this.equips.set((0,template_string/* $slot */.Jh)(outfit_templateObject20 || (outfit_templateObject20 = outfit_taggedTemplateLiteral(["familiar"]))), item);
          }
    ...
    value: function canEquip(item) {
      ...
      if (!(0,lib/* have */.lf)(item) && item !== (0,template_string/* $familiar */.HP)(outfit_templateObject21 || (outfit_templateObject21 = outfit_taggedTemplateLiteral(["none"])))) return false;
      if (item instanceof external_kolmafia_.Item && !(0,external_kolmafia_.canEquip)(item)) return false;
      if (this.avoid && this.avoid.find(i => i === item) !== undefined) return false;
      ...
      if (item instanceof external_kolmafia_.Item) {
        ...
        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject22 || (outfit_templateObject22 = outfit_taggedTemplateLiteral(["familiar"]))) && this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject23 || (outfit_templateObject23 = outfit_taggedTemplateLiteral(["none"])))) {
          return false;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject24 || (outfit_templateObject24 = outfit_taggedTemplateLiteral(["acc1"])))) {
          if (this.accesories.length >= 3) return false;
          return true;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject25 || (outfit_templateObject25 = outfit_taggedTemplateLiteral(["off-hand"])))) {
          var weapon = this.equips.get((0,template_string/* $slot */.Jh)(outfit_templateObject26 || (outfit_templateObject26 = outfit_taggedTemplateLiteral(["weapon"]))));
          if (weapon && (0,external_kolmafia_.weaponHands)(weapon) === 2) return false;
        }
        ...
        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject27 || (outfit_templateObject27 = outfit_taggedTemplateLiteral(["weapon"]))) && !this.equips.has((0,template_string/* $slot */.Jh)(outfit_templateObject28 || (outfit_templateObject28 = outfit_taggedTemplateLiteral(["off-hand"])))) && (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(outfit_templateObject29 || (outfit_templateObject29 = outfit_taggedTemplateLiteral(["Double-Fisted Skull Smashing"])))) && (0,external_kolmafia_.weaponHands)(item)) {
          return true;
        }

        if (slot === (0,template_string/* $slot */.Jh)(outfit_templateObject30 || (outfit_templateObject30 = outfit_taggedTemplateLiteral(["off-hand"]))) && (0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(outfit_templateObject31 || (outfit_templateObject31 = outfit_taggedTemplateLiteral(["Left-Hand Man"])))) && this.familiar === undefined && !this.equips.has((0,template_string/* $slot */.Jh)(outfit_templateObject32 || (outfit_templateObject32 = outfit_taggedTemplateLiteral(["familiar"]))))) {
          return true;
        }
    ...
    value: function dress() {
      if (this.familiar !== undefined) (0,external_kolmafia_.useFamiliar)(this.familiar);
      var targetEquipment = Array.from(this.equips.values());
      var accessorySlots = (0,template_string/* $slots */.ei)(outfit_templateObject33 || (outfit_templateObject33 = outfit_taggedTemplateLiteral(["acc1, acc2, acc3"])));

      var _iterator3 = outfit_createForOfIteratorHelper((0,template_string/* $slots */.ei)(outfit_templateObject40 || (outfit_templateObject40 = outfit_taggedTemplateLiteral(["weapon, off-hand, hat, shirt, pants, familiar, buddy-bjorn, crown-of-thrones, back"])))),
          _step3;

      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var slot = _step3.value;
          if (targetEquipment.includes((0,external_kolmafia_.equippedItem)(slot)) && this.equips.get(slot) !== (0,external_kolmafia_.equippedItem)(slot)) (0,external_kolmafia_.equip)(slot, (0,template_string/* $item */.xr)(outfit_templateObject41 || (outfit_templateObject41 = outfit_taggedTemplateLiteral(["none"]))));
      ...
      var _iterator4 = outfit_createForOfIteratorHelper((0,template_string/* $slots */.ei)(outfit_templateObject42 || (outfit_templateObject42 = outfit_taggedTemplateLiteral(["weapon, off-hand, hat, back, shirt, pants, familiar, buddy-bjorn, crown-of-thrones"])))),
          _step4;
      ...
      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          ...
          if (equipment) {
            if (_slot === (0,template_string/* $slot */.Jh)(outfit_templateObject43 || (outfit_templateObject43 = outfit_taggedTemplateLiteral(["off-hand"]))) && !this.equips.has((0,template_string/* $slot */.Jh)(outfit_templateObject44 || (outfit_templateObject44 = outfit_taggedTemplateLiteral(["weapon"])))) && (0,external_kolmafia_.weaponHands)((0,external_kolmafia_.equippedItem)((0,template_string/* $slot */.Jh)(outfit_templateObject45 || (outfit_templateObject45 = outfit_taggedTemplateLiteral(["weapon"]))))) > 1) {
              (0,external_kolmafia_.equip)((0,template_string/* $item */.xr)(outfit_templateObject46 || (outfit_templateObject46 = outfit_taggedTemplateLiteral(["none"]))), (0,template_string/* $slot */.Jh)(outfit_templateObject47 || (outfit_templateObject47 = outfit_taggedTemplateLiteral(["weapon"])))); // can't equip an off-hand with a two-handed weapon
            }

            (0,external_kolmafia_.equip)(_slot, equipment);
            if ((0,external_kolmafia_.equippedItem)(_slot) !== equipment) throw "Failed to equip ".concat(equipment);
          }
      ...
      try {
        var _loop = function _loop() {
          ...
          if (currentEquip === (0,template_string/* $item */.xr)(outfit_templateObject48 || (outfit_templateObject48 = outfit_taggedTemplateLiteral(["none"]))) || (0,external_kolmafia_.equippedAmount)(currentEquip) > accessoryEquips.filter(accessory => accessory === currentEquip).length) {
            (0,external_kolmafia_.equip)(slot, toEquip);
            if ((0,external_kolmafia_.equippedItem)(slot) !== toEquip) throw "Failed to equip ".concat(toEquip);
          }
        };
      ...
      if (this.modifier) {
        ...
        var fam_equip = this.equips.get((0,template_string/* $slot */.Jh)(outfit_templateObject34 || (outfit_templateObject34 = outfit_taggedTemplateLiteral(["familiar"]))));
        ...
        if (fam_equip !== undefined) {
          requirements = Requirement.merge([requirements, new Requirement([], {
            preventSlot: [(0,template_string/* $slot */.Jh)(outfit_templateObject35 || (outfit_templateObject35 = outfit_taggedTemplateLiteral(["familiar"])))]
          })]);
        }
        ...
        if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(outfit_templateObject36 || (outfit_templateObject36 = outfit_taggedTemplateLiteral(["cursed magnifying glass"])))) && (0,property/* get */.U2)("cursedMagnifyingGlassCount") >= 13 && !targetEquipment.includes((0,template_string/* $item */.xr)(outfit_templateObject37 || (outfit_templateObject37 = outfit_taggedTemplateLiteral(["cursed magnifying glass"]))))) {
          // Avoid burning CMG void fight just for the modifier
          requirements = Requirement.merge([requirements, new Requirement([], {
            preventEquip: [(0,template_string/* $item */.xr)(outfit_templateObject38 || (outfit_templateObject38 = outfit_taggedTemplateLiteral(["cursed magnifying glass"])))]
          })]);
        }
      ...
      if ((0,external_kolmafia_.equippedAmount)((0,template_string/* $item */.xr)(outfit_templateObject39 || (outfit_templateObject39 = outfit_taggedTemplateLiteral(["backup camera"])))) > 0 && (!this.modifier || !this.modifier.includes("ML")) && (0,property/* get */.U2)("backupCameraMode").toLowerCase() === "ml") {
    ...
    value: function equipCharging() {
      ...
      if ((_this$modifier = this.modifier) !== null && _this$modifier !== void 0 && _this$modifier.includes("-combat")) {
        ...
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject49 || (outfit_templateObject49 = outfit_taggedTemplateLiteral(["unbreakable umbrella"]))));
      }

      if ((0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(outfit_templateObject50 || (outfit_templateObject50 = outfit_taggedTemplateLiteral(["Grey Goose"])))) < 6 || (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(outfit_templateObject51 || (outfit_templateObject51 = outfit_taggedTemplateLiteral(["Grey Goose"])))) >= 6 && outfit_toConsumableArray(this.equips.values()).includes((0,template_string/* $item */.xr)(outfit_templateObject52 || (outfit_templateObject52 = outfit_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"])))) && (0,lib/* getKramcoWandererChance */.ve)() === 1) {
        if (this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject53 || (outfit_templateObject53 = outfit_taggedTemplateLiteral(["Grey Goose"]))))) {
          this.equip((0,template_string/* $item */.xr)(outfit_templateObject54 || (outfit_templateObject54 = outfit_taggedTemplateLiteral(["yule hatchet"]))));
          this.equip((0,template_string/* $item */.xr)(outfit_templateObject55 || (outfit_templateObject55 = outfit_taggedTemplateLiteral(["ghostly reins"]))));
          this.equip((0,template_string/* $item */.xr)(outfit_templateObject56 || (outfit_templateObject56 = outfit_taggedTemplateLiteral(["teacher's pen"]))));
          this.equip((0,template_string/* $item */.xr)(outfit_templateObject57 || (outfit_templateObject57 = outfit_taggedTemplateLiteral(["familiar scrapbook"]))));
        }
      } else if ((!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(outfit_templateObject58 || (outfit_templateObject58 = outfit_taggedTemplateLiteral(["eleven-foot pole"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(outfit_templateObject59 || (outfit_templateObject59 = outfit_taggedTemplateLiteral(["ring of Detect Boring Doors"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(outfit_templateObject60 || (outfit_templateObject60 = outfit_taggedTemplateLiteral(["Pick-O-Matic lockpicks"]))))) && keyStrategy.useful(Keys.Dungeon) !== false && !towerSkip()) {
        this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject61 || (outfit_templateObject61 = outfit_taggedTemplateLiteral(["Gelatinous Cubeling"]))));
      } else if ((0,property/* get */.U2)("camelSpit") < 100 && (0,property/* get */.U2)("zeppelinProtestors") < 80) {
        this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject62 || (outfit_templateObject62 = outfit_taggedTemplateLiteral(["Melodramedary"]))));
      }
    }
  }, {
    key: "equipDefaults",
    value: function equipDefaults() {
      ...
      if ((_this$modifier2 = this.modifier) !== null && _this$modifier2 !== void 0 && _this$modifier2.includes("-combat")) this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject63 || (outfit_templateObject63 = outfit_taggedTemplateLiteral(["Disgeist"])))); // low priority

      if ((0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(outfit_templateObject64 || (outfit_templateObject64 = outfit_taggedTemplateLiteral(["Temporal Riftlet"]))))) {
        this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject65 || (outfit_templateObject65 = outfit_taggedTemplateLiteral(["Temporal Riftlet"]))));
      } else if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(outfit_templateObject66 || (outfit_templateObject66 = outfit_taggedTemplateLiteral(["gnomish housemaid's kgnee"]))))) {
        this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject67 || (outfit_templateObject67 = outfit_taggedTemplateLiteral(["Reagnimated Gnome"]))));
      } else this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject68 || (outfit_templateObject68 = outfit_taggedTemplateLiteral(["Galloping Grill"]))));

      this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject69 || (outfit_templateObject69 = outfit_taggedTemplateLiteral(["Melodramedary"]))));
      if (this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject70 || (outfit_templateObject70 = outfit_taggedTemplateLiteral(["Grey Goose"]))) && (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(outfit_templateObject71 || (outfit_templateObject71 = outfit_taggedTemplateLiteral(["Grey Goose"])))) < 6) this.equip((0,template_string/* $item */.xr)(outfit_templateObject72 || (outfit_templateObject72 = outfit_taggedTemplateLiteral(["grey down vest"]))));
      if (this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject73 || (outfit_templateObject73 = outfit_taggedTemplateLiteral(["Melodramedary"]))) && (0,property/* get */.U2)("camelSpit") < 100) this.equip((0,template_string/* $item */.xr)(outfit_templateObject74 || (outfit_templateObject74 = outfit_taggedTemplateLiteral(["dromedary drinking helmet"]))));
      if (this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject75 || (outfit_templateObject75 = outfit_taggedTemplateLiteral(["Reagnimated Gnome"])))) this.equip((0,template_string/* $item */.xr)(outfit_templateObject76 || (outfit_templateObject76 = outfit_taggedTemplateLiteral(["gnomish housemaid's kgnee"]))));
      if ((0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(outfit_templateObject77 || (outfit_templateObject77 = outfit_taggedTemplateLiteral(["muscle"])))) >= 40) this.equip((0,template_string/* $item */.xr)(outfit_templateObject78 || (outfit_templateObject78 = outfit_taggedTemplateLiteral(["mafia thumb ring"]))));

      if (!this.modifier) {
        // Default outfit
        if ((0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(outfit_templateObject79 || (outfit_templateObject79 = outfit_taggedTemplateLiteral(["moxie"])))) >= 47) this.equip((0,template_string/* $item */.xr)(outfit_templateObject80 || (outfit_templateObject80 = outfit_taggedTemplateLiteral(["giant yellow hat"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject81 || (outfit_templateObject81 = outfit_taggedTemplateLiteral(["ice crown"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject82 || (outfit_templateObject82 = outfit_taggedTemplateLiteral(["June cleaver"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject83 || (outfit_templateObject83 = outfit_taggedTemplateLiteral(["industrial fire extinguisher"]))));
        if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(outfit_templateObject84 || (outfit_templateObject84 = outfit_taggedTemplateLiteral(["Torso Awareness"]))))) this.equip((0,template_string/* $item */.xr)(outfit_templateObject85 || (outfit_templateObject85 = outfit_taggedTemplateLiteral(["fresh coat of paint"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject86 || (outfit_templateObject86 = outfit_taggedTemplateLiteral(["familiar scrapbook"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject87 || (outfit_templateObject87 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject88 || (outfit_templateObject88 = outfit_taggedTemplateLiteral(["unwrapped knock-off retro superhero cape"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject89 || (outfit_templateObject89 = outfit_taggedTemplateLiteral(["designer sweatpants"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject90 || (outfit_templateObject90 = outfit_taggedTemplateLiteral(["Cargo Cultist Shorts"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject91 || (outfit_templateObject91 = outfit_taggedTemplateLiteral(["Powerful Glove"]))));
        if (this.familiar === (0,template_string/* $familiar */.HP)(outfit_templateObject92 || (outfit_templateObject92 = outfit_taggedTemplateLiteral(["Grey Goose"]))) && (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(outfit_templateObject93 || (outfit_templateObject93 = outfit_taggedTemplateLiteral(["Grey Goose"])))) < 6 && (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(outfit_templateObject94 || (outfit_templateObject94 = outfit_taggedTemplateLiteral(["teacher's pen"])))) >= 2) this.equip((0,template_string/* $item */.xr)(outfit_templateObject95 || (outfit_templateObject95 = outfit_taggedTemplateLiteral(["teacher's pen"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject96 || (outfit_templateObject96 = outfit_taggedTemplateLiteral(["backup camera"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject97 || (outfit_templateObject97 = outfit_taggedTemplateLiteral(["birch battery"]))));
        this.equip((0,template_string/* $item */.xr)(outfit_templateObject98 || (outfit_templateObject98 = outfit_taggedTemplateLiteral(["combat lover's locket"]))));
      }

      this.equip((0,template_string/* $item */.xr)(outfit_templateObject99 || (outfit_templateObject99 = outfit_taggedTemplateLiteral(["miniature crystal ball"])))); // If we never found a better familiar, just keep charging the goose

      this.equip((0,template_string/* $familiar */.HP)(outfit_templateObject100 || (outfit_templateObject100 = outfit_taggedTemplateLiteral(["Grey Goose"]))));
    }
  }], [{
    key: "create",
    value: function create(task, state) {
      ...
      if ((spec === null || spec === void 0 ? void 0 : spec.familiar) !== undefined) outfit.equip(spec.familiar);
      outfit.avoid = spec === null || spec === void 0 ? void 0 : spec.avoid;

      if (spec !== null && spec !== void 0 && spec.modifier) {
        // Run maximizer
        if (spec.modifier.includes("item")) {
          outfit.equip((0,template_string/* $familiar */.HP)(outfit_templateObject101 || (outfit_templateObject101 = outfit_taggedTemplateLiteral(["Grey Goose"]))));
          if (!spec.modifier.includes("+combat") && !spec.modifier.includes(" combat")) outfit.equip((0,template_string/* $item */.xr)(outfit_templateObject102 || (outfit_templateObject102 = outfit_taggedTemplateLiteral(["protonic accelerator pack"]))));
        } // if (spec.modifier.includes("+combat")) outfit.equip($familiar`Jumpsuited Hound Dog`);


        if (spec.modifier.includes("meat")) {
          outfit.equip((0,template_string/* $familiar */.HP)(outfit_templateObject103 || (outfit_templateObject103 = outfit_taggedTemplateLiteral(["Hobo Monkey"]))));
          outfit.equip((0,template_string/* $familiar */.HP)(outfit_templateObject104 || (outfit_templateObject104 = outfit_taggedTemplateLiteral(["Leprechaun"])))); // backup
        }

        if (spec.modifier.includes("+combat") && !spec.modifier.includes("res")) outfit.equip((0,template_string/* $item */.xr)(outfit_templateObject105 || (outfit_templateObject105 = outfit_taggedTemplateLiteral(["thermal blanket"]))));
...
var Engine = /*#__PURE__*/function () {
  function Engine(tasks, ignoreTasks, completedTasks) {
    ...
    engine_defineProperty(this, "ignoreTasks", void 0);

    engine_defineProperty(this, "completedTasks", void 0);
    ...
    this.ignoreTasks = new Set(ignoreTasks.map(n => n.trim()));
    this.completedTasks = new Set(completedTasks.map(n => n.trim()));

    var _iterator2 = engine_createForOfIteratorHelper(this.ignoreTasks),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var _task = _step2.value;
        if (!this.tasks_by_name.has(_task)) debug("Warning: Unknown ignoretask ".concat(_task));
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
    ...
    var _iterator3 = engine_createForOfIteratorHelper(this.completedTasks),
        _step3;

    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var _task2 = _step3.value;
        if (!this.tasks_by_name.has(_task2)) debug("Warning: Unknown completedtask ".concat(_task2));
      }
    } catch (err) {
      _iterator3.e(err);
    } finally {
  ...
  engine_createClass(Engine, [{
    ...
    value: function available(task, state) {
      ...
      var _iterator4 = engine_createForOfIteratorHelper(task.after),
          _step4;

      try {
        for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
          var after = _step4.value;
    ...
    value: function execute(task, priority, state) {
      var _task$acquire, _task$ready, _task$ready2;
      ...
      var _iterator5 = engine_createForOfIteratorHelper(acquire),
          _step5;
      ...
      var _iterator6 = engine_createForOfIteratorHelper(wanderers),
          _step6;

      try {
        for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
          var wanderer = _step6.value;
      ...
      if (!freeaction) {
        ...
        var _iterator7 = engine_createForOfIteratorHelper(absorb_targets),
            _step7;
      ...
      if (typeof task.do === "function") {
        ...
        if (wanderingNCs.has((0,property/* get */.U2)("lastEncounter"))) {
          ...
          start_advs = (0,external_kolmafia_.myAdventures)();
      ...
      var _iterator8 = engine_createForOfIteratorHelper((0,template_string/* $effects */.lh)(engine_templateObject28 || (engine_templateObject28 = engine_taggedTemplateLiteral(["Hardly Poisoned at All, A Little Bit Poisoned, Somewhat Poisoned, Really Quite Poisoned, Majorly Poisoned, Toad In The Hole"])))),
          _step8;

      try {
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
          var poisoned = _step8.value;
...
function autosellJunk() {
  ...
  var _iterator10 = engine_createForOfIteratorHelper(partial_junk),
      _step10;
  ...
  var _iterator11 = engine_createForOfIteratorHelper(wallets),
      _step11;
...
function absorbConsumables() {
  ...
  for (var item_name in (0,external_kolmafia_.getInventory)()) {
    ...
    if (item.fullness > 0 && !absorbed.has(item_id)) {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(engine_templateObject35 || (engine_templateObject35 = engine_taggedTemplateLiteral(["Special Seasoning"]))))) (0,external_kolmafia_.putCloset)((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(engine_templateObject36 || (engine_templateObject36 = engine_taggedTemplateLiteral(["Special Seasoning"])))), (0,template_string/* $item */.xr)(engine_templateObject37 || (engine_templateObject37 = engine_taggedTemplateLiteral(["Special Seasoning"]))));
...
function getExtros() {
  if ((0,external_kolmafia_.getWorkshed)() !== (0,template_string/* $item */.xr)(engine_templateObject38 || (engine_templateObject38 = engine_taggedTemplateLiteral(["cold medicine cabinet"])))) return;
  ...
  while ((match = regexp.exec(options)) !== null) {
    ...
    if (item === (0,template_string/* $item */.xr)(engine_templateObject39 || (engine_templateObject39 = engine_taggedTemplateLiteral(["Extrovermectin\u2122"])))) {
  ...
  tasks: [{
    ...
    ready: () => {
      ...
      switch ((0,property/* get */.U2)("ghostLocation")) {
        case (0,template_string/* $location */.PG)(misc_templateObject34 || (misc_templateObject34 = misc_taggedTemplateLiteral(["Cobb's Knob Treasury"]))):
          return step("questL05Goblin") >= 1;

        case (0,template_string/* $location */.PG)(misc_templateObject35 || (misc_templateObject35 = misc_taggedTemplateLiteral(["The Haunted Conservatory"]))):
          return step("questM20Necklace") >= 0;

        case (0,template_string/* $location */.PG)(misc_templateObject36 || (misc_templateObject36 = misc_taggedTemplateLiteral(["The Haunted Gallery"]))):
          return step("questM21Dance") >= 1;

        case (0,template_string/* $location */.PG)(misc_templateObject37 || (misc_templateObject37 = misc_taggedTemplateLiteral(["The Haunted Kitchen"]))):
          return step("questM20Necklace") >= 0;

        case (0,template_string/* $location */.PG)(misc_templateObject38 || (misc_templateObject38 = misc_taggedTemplateLiteral(["The Haunted Wine Cellar"]))):
          return step("questL11Manor") >= 1;

        case (0,template_string/* $location */.PG)(misc_templateObject39 || (misc_templateObject39 = misc_taggedTemplateLiteral(["The Icy Peak"]))):
          return step("questL08Trapper") === 999;

        case (0,template_string/* $location */.PG)(misc_templateObject40 || (misc_templateObject40 = misc_taggedTemplateLiteral(["Inside the Palindome"]))):
          return (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject41 || (misc_templateObject41 = misc_taggedTemplateLiteral(["Talisman o' Namsilat"]))));

        case (0,template_string/* $location */.PG)(misc_templateObject42 || (misc_templateObject42 = misc_taggedTemplateLiteral(["The Old Landfill"]))):
          return (0,external_kolmafia_.myBasestat)((0,external_kolmafia_.myPrimestat)()) >= 25 && step("questL02Larva") >= 0;

        case (0,template_string/* $location */.PG)(misc_templateObject43 || (misc_templateObject43 = misc_taggedTemplateLiteral(["Madness Bakery"]))):
        case (0,template_string/* $location */.PG)(misc_templateObject44 || (misc_templateObject44 = misc_taggedTemplateLiteral(["The Overgrown Lot"]))):
        case (0,template_string/* $location */.PG)(misc_templateObject45 || (misc_templateObject45 = misc_taggedTemplateLiteral(["The Skeleton Store"]))):
          return true;
        // Can freely start quest

        case (0,template_string/* $location */.PG)(misc_templateObject46 || (misc_templateObject46 = misc_taggedTemplateLiteral(["The Smut Orc Logging Camp"]))):
          return step("questL09Topping") >= 0;

        case (0,template_string/* $location */.PG)(misc_templateObject47 || (misc_templateObject47 = misc_taggedTemplateLiteral(["The Spooky Forest"]))):
    ...
    prepare: () => {
      ...
      switch ((0,property/* get */.U2)("ghostLocation")) {
        case (0,template_string/* $location */.PG)(misc_templateObject48 || (misc_templateObject48 = misc_taggedTemplateLiteral(["Madness Bakery"]))):
          if (step("questM25Armorer") === -1) {
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=armory");
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=armory&action=talk");
            (0,external_kolmafia_.visitUrl)("choice.php?pwd=&whichchoice=1065&option=1");
        ...
        case (0,template_string/* $location */.PG)(misc_templateObject49 || (misc_templateObject49 = misc_taggedTemplateLiteral(["The Old Landfill"]))):
          if (step("questM19Hippy") === -1) {
            (0,external_kolmafia_.visitUrl)("place.php?whichplace=woods&action=woods_smokesignals");
            (0,external_kolmafia_.visitUrl)("choice.php?pwd=&whichchoice=798&option=1");
            (0,external_kolmafia_.visitUrl)("choice.php?pwd=&whichchoice=798&option=2");
        ...
        case (0,template_string/* $location */.PG)(misc_templateObject50 || (misc_templateObject50 = misc_taggedTemplateLiteral(["The Overgrown Lot"]))):
          if (step("questM24Doc") === -1) {
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=doc");
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=doc&action=talk");
            (0,external_kolmafia_.runChoice)(1);
        ...
        case (0,template_string/* $location */.PG)(misc_templateObject51 || (misc_templateObject51 = misc_taggedTemplateLiteral(["The Skeleton Store"]))):
          if (step("questM23Meatsmith") === -1) {
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=meatsmith");
            (0,external_kolmafia_.visitUrl)("shop.php?whichshop=meatsmith&action=talk");
            (0,external_kolmafia_.runChoice)(1);
        ...
        case (0,template_string/* $location */.PG)(misc_templateObject52 || (misc_templateObject52 = misc_taggedTemplateLiteral(["The Icy Peak"]))):
          if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) (0,lib/* ensureEffect */.pq)((0,template_string/* $effect */._G)(misc_templateObject53 || (misc_templateObject53 = misc_taggedTemplateLiteral(["Red Door Syndrome"]))));
          if ((0,external_kolmafia_.numericModifier)("cold resistance") < 5) throw "Unable to ensure cold res for The Icy Peak";
          return;
    ...
    do: () => {
      ...
      (0,external_kolmafia_.adv1)((_get = (0,property/* get */.U2)("ghostLocation")) !== null && _get !== void 0 ? _get : (0,template_string/* $location */.PG)(misc_templateObject54 || (misc_templateObject54 = misc_taggedTemplateLiteral(["none"]))), 0, "");

      if (wanderingNCs.has((0,property/* get */.U2)("lastEncounter"))) {
        var _get2;

        (0,external_kolmafia_.adv1)((_get2 = (0,property/* get */.U2)("ghostLocation")) !== null && _get2 !== void 0 ? _get2 : (0,template_string/* $location */.PG)(misc_templateObject55 || (misc_templateObject55 = misc_taggedTemplateLiteral(["none"]))), 0, "");
      }
    },
    outfit: () => {
      if ((0,property/* get */.U2)("ghostLocation") === (0,template_string/* $location */.PG)(misc_templateObject56 || (misc_templateObject56 = misc_taggedTemplateLiteral(["Inside the Palindome"])))) return {
        equip: (0,template_string/* $items */.vS)(misc_templateObject57 || (misc_templateObject57 = misc_taggedTemplateLiteral(["Talisman o' Namsilat, protonic accelerator pack"]))),
        modifier: "DA, DR"
      };
      if ((0,property/* get */.U2)("ghostLocation") === (0,template_string/* $location */.PG)(misc_templateObject58 || (misc_templateObject58 = misc_taggedTemplateLiteral(["The Icy Peak"])))) return {
        equip: (0,template_string/* $items */.vS)(misc_templateObject59 || (misc_templateObject59 = misc_taggedTemplateLiteral(["protonic accelerator pack"]))),
        modifier: "1000 cold res, DA, DR"
      };
      return {
        equip: (0,template_string/* $items */.vS)(misc_templateObject60 || (misc_templateObject60 = misc_taggedTemplateLiteral(["protonic accelerator pack"]))),
        modifier: "DA, DR"
      };
    },
    combat: new src_combat.CombatStrategy().macro(() => {
      if ((0,external_kolmafia_.myHp)() < (0,external_kolmafia_.myMaxhp)() || (0,property/* get */.U2)("ghostLocation") === (0,template_string/* $location */.PG)(misc_templateObject61 || (misc_templateObject61 = misc_taggedTemplateLiteral(["The Haunted Wine Cellar"]))) || (0,property/* get */.U2)("ghostLocation") === (0,template_string/* $location */.PG)(misc_templateObject62 || (misc_templateObject62 = misc_taggedTemplateLiteral(["The Overgrown Lot"])))) return new dist_combat/* Macro */.LE().attack().repeat();else return new dist_combat/* Macro */.LE().skill((0,template_string/* $skill */.tm)(misc_templateObject63 || (misc_templateObject63 = misc_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,template_string/* $skill */.tm)(misc_templateObject64 || (misc_templateObject64 = misc_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,template_string/* $skill */.tm)(misc_templateObject65 || (misc_templateObject65 = misc_taggedTemplateLiteral(["Shoot Ghost"])))).skill((0,template_string/* $skill */.tm)(misc_templateObject66 || (misc_templateObject66 = misc_taggedTemplateLiteral(["Trap Ghost"]))));
    }),
    post: () => {
    ...
    after: [],
    priority: () => OverridePriority.Free,
    ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject67 || (misc_templateObject67 = misc_taggedTemplateLiteral(["SpinMaster\u2122 lathe"])))) && (!(0,property/* get */.U2)("_spinmasterLatheVisited") || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject68 || (misc_templateObject68 = misc_taggedTemplateLiteral(["flimsy hardwood scraps"]))))),
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject69 || (misc_templateObject69 = misc_taggedTemplateLiteral(["birch battery"])))),
    do: () => {
    ...
    after: [],
    priority: () => OverridePriority.Free,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject70 || (misc_templateObject70 = misc_taggedTemplateLiteral(["sombrero-mounted sparkler"])))) || (0,property/* get */.U2)("_fireworksShopHatBought") || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject71 || (misc_templateObject71 = misc_taggedTemplateLiteral(["Clan VIP Lounge key"])))),
    do: () => {
    ...
    after: [],
    priority: () => OverridePriority.Free,
    completed: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject72 || (misc_templateObject72 = misc_taggedTemplateLiteral(["Grey Goose"])))) >= 9 || (0,property/* get */.U2)("_loop_gyou_chef_goose") === "true" || !(0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(misc_templateObject73 || (misc_templateObject73 = misc_taggedTemplateLiteral(["Shorter-Order Cook"])))),
    do: () => {
      (0,property/* set */.t8)("_loop_gyou_chef_goose", "true");
    },
    outfit: {
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject74 || (misc_templateObject74 = misc_taggedTemplateLiteral(["Grey Goose"])))
    },
    limit: {
      tries: 1
    },
    ...
    do: () => {
      (0,external_kolmafia_.hermit)((0,template_string/* $item */.xr)(misc_templateObject75 || (misc_templateObject75 = misc_taggedTemplateLiteral(["11-leaf clover"]))), 3);
    ...
    name: "Fortune",
    after: ["Hidden City/Open City"],
    completed: () => (0,property/* get */.U2)("_clanFortuneBuffUsed") || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject76 || (misc_templateObject76 = misc_taggedTemplateLiteral(["Clan VIP Lounge key"])))),
    priority: () => OverridePriority.Free,
    do: () => {
    ...
    ready: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject77 || (misc_templateObject77 = misc_taggedTemplateLiteral(["Grey Goose"])))) < 6,
    priority: () => OverridePriority.Free,
    do: () => {
    ...
    name: "Dog Chow",
    after: [],
    ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject78 || (misc_templateObject78 = misc_taggedTemplateLiteral(["Ghost Dog Chow"])))) && (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject79 || (misc_templateObject79 = misc_taggedTemplateLiteral(["Grey Goose"])))) < 6,
    completed: state => state.absorb.remainingReprocess().length === 0,
    do: () => {
      (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject80 || (misc_templateObject80 = misc_taggedTemplateLiteral(["Ghost Dog Chow"]))));
      if ((0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject81 || (misc_templateObject81 = misc_taggedTemplateLiteral(["Grey Goose"])))) < 6 && (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject82 || (misc_templateObject82 = misc_taggedTemplateLiteral(["Ghost Dog Chow"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject83 || (misc_templateObject83 = misc_taggedTemplateLiteral(["Ghost Dog Chow"]))));
    },
    outfit: {
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject84 || (misc_templateObject84 = misc_taggedTemplateLiteral(["Grey Goose"])))
    },
    freeaction: true,
    limit: {
      soft: 20
    ...
    after: [],
    ready: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject85 || (misc_templateObject85 = misc_taggedTemplateLiteral(["Grey Goose"])))) < 6 && (0,external_kolmafia_.myMeat)() >= 100,
    completed: state => state.absorb.remainingReprocess().length === 0,
    do: arenaFight,
    outfit: {
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject86 || (misc_templateObject86 = misc_taggedTemplateLiteral(["Grey Goose"]))),
    ...
    name: "Amulet Coin",
    after: [],
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject87 || (misc_templateObject87 = misc_taggedTemplateLiteral(["amulet coin"])))) || !(0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject88 || (misc_templateObject88 = misc_taggedTemplateLiteral(["Summon Clip Art"])))) || (0,property/* get */.U2)("tomeSummons") >= 3 || !(0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(misc_templateObject89 || (misc_templateObject89 = misc_taggedTemplateLiteral(["Cornbeefadon"])))),
    priority: () => OverridePriority.Free,
    do: () => {
      (0,external_kolmafia_.retrieveItem)((0,template_string/* $item */.xr)(misc_templateObject90 || (misc_templateObject90 = misc_taggedTemplateLiteral(["box of Familiar Jacks"]))));
      (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject91 || (misc_templateObject91 = misc_taggedTemplateLiteral(["box of Familiar Jacks"]))));
    },
    outfit: {
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject92 || (misc_templateObject92 = misc_taggedTemplateLiteral(["Cornbeefadon"])))
    },
    freeaction: true,
    limit: {
      tries: 1
    ...
    after: [],
    priority: () => OverridePriority.Free,
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject93 || (misc_templateObject93 = misc_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) || (0,property/* get */.U2)("boomBoxSong") === "Total Eclipse of Your Meat" || (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject94 || (misc_templateObject94 = misc_taggedTemplateLiteral(["System Sweep"])))) && (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject95 || (misc_templateObject95 = misc_taggedTemplateLiteral(["Double Nanovision"])))) || (0,property/* get */.U2)("_boomBoxSongsLeft") === 0,
    ...
    after: [],
    priority: () => OverridePriority.Free,
    ready: () => (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject96 || (misc_templateObject96 = misc_taggedTemplateLiteral(["System Sweep"])))) && (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject97 || (misc_templateObject97 = misc_taggedTemplateLiteral(["Double Nanovision"])))) && ((0,property/* get */.U2)("currentNunneryMeat") === 0 || (0,property/* get */.U2)("currentNunneryMeat") === 100000),
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject98 || (misc_templateObject98 = misc_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"])))) || (0,property/* get */.U2)("boomBoxSong") === "Food Vibrations" || (0,property/* get */.U2)("_boomBoxSongsLeft") === 0,
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject99 || (misc_templateObject99 = misc_taggedTemplateLiteral(["Torso Awareness"])))),
    priority: () => OverridePriority.Free,
    freeaction: true,
    do: () => {
    ...
    after: ["Gnome Shirt"],
    ready: () => (0,external_kolmafia_.myMeat)() >= 11000 && (0,external_kolmafia_.gnomadsAvailable)(),
    completed: () => (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(misc_templateObject100 || (misc_templateObject100 = misc_taggedTemplateLiteral(["Powers of Observatiogn"])))),
    priority: () => OverridePriority.Free,
    freeaction: true,
    do: () => {
    ...
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject101 || (misc_templateObject101 = misc_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || args.tune === undefined || (0,property/* get */.U2)("moonTuned", false),
    priority: () => OverridePriority.Free,
    freeaction: true,
    ...
    ready: () => (0,external_kolmafia_.canadiaAvailable)(),
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject102 || (misc_templateObject102 = misc_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || args.tune === undefined || (0,property/* get */.U2)("moonTuned", false),
    priority: () => OverridePriority.Free,
    freeaction: true,
    do: () => (0,external_kolmafia_.cliExecute)("spoon ".concat(args.tune)),
    limit: {
    ...
    ready: () => (0,external_kolmafia_.gnomadsAvailable)(),
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject103 || (misc_templateObject103 = misc_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || args.tune === undefined || (0,property/* get */.U2)("moonTuned", false),
    priority: () => OverridePriority.Free,
    freeaction: true,
    do: () => (0,external_kolmafia_.cliExecute)("spoon ".concat(args.tune)),
    limit: {
    ...
    ready: () => false,
    completed: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject104 || (misc_templateObject104 = misc_taggedTemplateLiteral(["hewn moon-rune spoon"])))) || args.tune === undefined || (0,property/* get */.U2)("moonTuned", false),
    do: () => false,
    limit: {
      tries: 1
    }
    ...
    priority: () => OverridePriority.Free,
    completed: () => !(0,property/* get */.U2)("hasMaydayContract") || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject105 || (misc_templateObject105 = misc_taggedTemplateLiteral(["MayDay\u2122 supply package"])))) && atLevel(11),
    ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject106 || (misc_templateObject106 = misc_taggedTemplateLiteral(["MayDay\u2122 supply package"])))) && (0,external_kolmafia_.myTurncount)() < 1000,
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject107 || (misc_templateObject107 = misc_taggedTemplateLiteral(["MayDay\u2122 supply package"])))),
    limit: {
      tries: 1
    },
    freeaction: true
    ...
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject108 || (misc_templateObject108 = misc_taggedTemplateLiteral(["FantasyRealm G. E. M."])))),
    do: () => {
...
var WandQuest = {
  ...
  tasks: [{
    name: "Plus Sign",
    after: [],
    ready: () => (0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(misc_templateObject109 || (misc_templateObject109 = misc_taggedTemplateLiteral(["muscle"])))) >= 45 && (0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(misc_templateObject110 || (misc_templateObject110 = misc_taggedTemplateLiteral(["mysticality"])))) >= 45 && (0,external_kolmafia_.myBasestat)((0,template_string/* $stat */.Ri)(misc_templateObject111 || (misc_templateObject111 = misc_taggedTemplateLiteral(["moxie"])))) >= 45,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject112 || (misc_templateObject112 = misc_taggedTemplateLiteral(["plus sign"])))) || (0,property/* get */.U2)("lastPlusSignUnlock") === (0,external_kolmafia_.myAscensions)(),
    do: (0,template_string/* $location */.PG)(misc_templateObject113 || (misc_templateObject113 = misc_taggedTemplateLiteral(["The Enormous Greater-Than Sign"]))),
    outfit: {
      modifier: "-combat"
    },
    choices: {
    ...
    (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject114 || (misc_templateObject114 = misc_taggedTemplateLiteral(["Grey Goose"])))) >= 6 && // Goose exp for potential absorbs during teleportits
    (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject115 || (misc_templateObject115 = misc_taggedTemplateLiteral(["soft green echo eyedrop antidote"])))),
    // Antitdote to remove teleportitis afterwards
    priority: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject116 || (misc_templateObject116 = misc_taggedTemplateLiteral(["Grey Goose"])))) >= 6 ? OverridePriority.GoodGoose : OverridePriority.None,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject117 || (misc_templateObject117 = misc_taggedTemplateLiteral(["Teleportitis"])))) || (0,property/* get */.U2)("lastPlusSignUnlock") === (0,external_kolmafia_.myAscensions)(),
    do: (0,template_string/* $location */.PG)(misc_templateObject118 || (misc_templateObject118 = misc_taggedTemplateLiteral(["The Enormous Greater-Than Sign"]))),
    outfit: {
      modifier: "-combat"
    },
    choices: {
    ...
    ready: () => (0,external_kolmafia_.myMeat)() >= 5000,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject119 || (misc_templateObject119 = misc_taggedTemplateLiteral(["dead mimic"])))) || (0,property/* get */.U2)("lastZapperWand") === (0,external_kolmafia_.myAscensions)() || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject120 || (misc_templateObject120 = misc_taggedTemplateLiteral(["aluminum wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject121 || (misc_templateObject121 = misc_taggedTemplateLiteral(["ebony wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject122 || (misc_templateObject122 = misc_taggedTemplateLiteral(["hexagonal wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject123 || (misc_templateObject123 = misc_taggedTemplateLiteral(["marble wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject124 || (misc_templateObject124 = misc_taggedTemplateLiteral(["pine wand"])))) || keyStrategy.useful(Keys.Zap) === false,
    prepare: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject125 || (misc_templateObject125 = misc_taggedTemplateLiteral(["plus sign"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject126 || (misc_templateObject126 = misc_taggedTemplateLiteral(["plus sign"]))));
    },
    do: (0,template_string/* $location */.PG)(misc_templateObject127 || (misc_templateObject127 = misc_taggedTemplateLiteral(["The Dungeons of Doom"]))),
    outfit: {
      modifier: "-combat, init",
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject128 || (misc_templateObject128 = misc_taggedTemplateLiteral(["Grey Goose"])))
    },
    combat: (misc_CombatStrategy$banis = new src_combat.CombatStrategy().banish((0,template_string/* $monster */.O4)(misc_templateObject129 || (misc_templateObject129 = misc_taggedTemplateLiteral(["Quantum Mechanic"]))))).kill.apply(misc_CombatStrategy$banis, misc_toConsumableArray((0,template_string/* $monsters */.fr)(misc_templateObject130 || (misc_templateObject130 = misc_taggedTemplateLiteral(["mimic, The Master Of Thieves"]))))),
    ...
    name: "Wand",
    after: ["Mimic"],
    completed: () => (0,property/* get */.U2)("lastZapperWand") === (0,external_kolmafia_.myAscensions)() || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject131 || (misc_templateObject131 = misc_taggedTemplateLiteral(["aluminum wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject132 || (misc_templateObject132 = misc_taggedTemplateLiteral(["ebony wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject133 || (misc_templateObject133 = misc_taggedTemplateLiteral(["hexagonal wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject134 || (misc_templateObject134 = misc_taggedTemplateLiteral(["marble wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject135 || (misc_templateObject135 = misc_taggedTemplateLiteral(["pine wand"])))) || keyStrategy.useful(Keys.Zap) === false,
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject136 || (misc_templateObject136 = misc_taggedTemplateLiteral(["dead mimic"])))),
    freeaction: true,
    limit: {
      tries: 1
    }
...
function teleportitisTask(engine, tasks, state) {
  ...
  return {
    ...
    ready: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject137 || (misc_templateObject137 = misc_taggedTemplateLiteral(["Teleportitis"])))),
    ...
    outfit: {
      equip: (0,template_string/* $items */.vS)(misc_templateObject139 || (misc_templateObject139 = misc_taggedTemplateLiteral(["antique machete"])))
    },
    choices: choices,
    limit: {
      soft: 20
...
var removeTeleportitis = {
  ...
  after: [],
  ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject140 || (misc_templateObject140 = misc_taggedTemplateLiteral(["soft green echo eyedrop antidote"])))),
  completed: () => !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject141 || (misc_templateObject141 = misc_taggedTemplateLiteral(["Teleportitis"])))),
  do: () => {
    (0,lib/* uneffect */.Lo)((0,template_string/* $effect */._G)(misc_templateObject142 || (misc_templateObject142 = misc_taggedTemplateLiteral(["Teleportitis"]))));
  },
  limit: {
    soft: 2
  },
...
var houseFamiliars = new Map([[(0,template_string/* $familiar */.HP)(misc_templateObject143 || (misc_templateObject143 = misc_taggedTemplateLiteral(["Angry Goat"]))), [3, 0, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject144 || (misc_templateObject144 = misc_taggedTemplateLiteral(["Baby Gravy Fairy"]))), [0, 3, 1, 2]], // mafia and wiki disagree
[(0,template_string/* $familiar */.HP)(misc_templateObject145 || (misc_templateObject145 = misc_taggedTemplateLiteral(["Barrrnacle"]))), [0, 2, 1, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject146 || (misc_templateObject146 = misc_taggedTemplateLiteral(["Blood-Faced Volleyball"]))), [0, 1, 3, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject147 || (misc_templateObject147 = misc_taggedTemplateLiteral(["Clockwork Grapefruit"]))), [3, 2, 0, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject148 || (misc_templateObject148 = misc_taggedTemplateLiteral(["Cocoabo"]))), [2, 3, 0, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject149 || (misc_templateObject149 = misc_taggedTemplateLiteral(["Fuzzy Dice"]))), [2, 2, 2, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject150 || (misc_templateObject150 = misc_taggedTemplateLiteral(["Ghuol Whelp"]))), [1, 2, 0, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject151 || (misc_templateObject151 = misc_taggedTemplateLiteral(["Grue"]))), [2, 0, 1, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject152 || (misc_templateObject152 = misc_taggedTemplateLiteral(["Hanukkimbo Dreidl"]))), [2, 1, 3, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject153 || (misc_templateObject153 = misc_taggedTemplateLiteral(["Hovering Sombrero"]))), [0, 3, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject154 || (misc_templateObject154 = misc_taggedTemplateLiteral(["Howling Balloon Monkey"]))), [1, 3, 2, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject155 || (misc_templateObject155 = misc_taggedTemplateLiteral(["Killer Bee"]))), [3, 1, 2, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject156 || (misc_templateObject156 = misc_taggedTemplateLiteral(["Leprechaun"]))), [1, 3, 0, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject157 || (misc_templateObject157 = misc_taggedTemplateLiteral(["Levitating Potato"]))), [0, 1, 2, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject158 || (misc_templateObject158 = misc_taggedTemplateLiteral(["MagiMechTech MicroMechaMech"]))), [3, 0, 1, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject159 || (misc_templateObject159 = misc_taggedTemplateLiteral(["Mosquito"]))), [2, 1, 3, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject160 || (misc_templateObject160 = misc_taggedTemplateLiteral(["Sabre-Toothed Lime"]))), [3, 0, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject161 || (misc_templateObject161 = misc_taggedTemplateLiteral(["Spooky Pirate Skeleton"]))), [2, 3, 1, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject162 || (misc_templateObject162 = misc_taggedTemplateLiteral(["Stab Bat"]))), [3, 2, 1, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject163 || (misc_templateObject163 = misc_taggedTemplateLiteral(["Star Starfish"]))), [2, 1, 3, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject164 || (misc_templateObject164 = misc_taggedTemplateLiteral(["Whirling Maple Leaf"]))), [3, 1, 2, 0]], // Along with our non-house familiar
[(0,template_string/* $familiar */.HP)(misc_templateObject165 || (misc_templateObject165 = misc_taggedTemplateLiteral(["Grey Goose"]))), [1, 2, 3, 3]]]);
...
function arenaFight() {
  ...
  do {
    ...
    if (match) {
      ...
      if (Number.isNaN(opponent) || Number.isNaN(weight) || weight === 0 || familiar === (0,template_string/* $familiar */.HP)(misc_templateObject166 || (misc_templateObject166 = misc_taggedTemplateLiteral(["none"])))) {
      ...
      for (var _i = 0, _arr = [1, 2, 3, 4]; _i < _arr.length; _i++) {
        ...
        options.push({
          ...
          familiar: familiar,
          event: event,
          delta: arenaStrength((0,template_string/* $familiar */.HP)(misc_templateObject167 || (misc_templateObject167 = misc_taggedTemplateLiteral(["Grey Goose"]))), (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject168 || (misc_templateObject168 = misc_taggedTemplateLiteral(["Grey Goose"])))) + (0,external_kolmafia_.weightAdjustment)(), event) - arenaStrength(familiar, weight, event)
        });
      }
    }
  ...
  if (bestOption === undefined) {
    ...
    var start_exp = (0,template_string/* $familiar */.HP)(misc_templateObject169 || (misc_templateObject169 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience;
    (0,external_kolmafia_.visitUrl)("arena.php?action=go&whichopp=".concat(bestOption.opponent, "&event=").concat(bestOption.event), true);
    if (start_exp === (0,template_string/* $familiar */.HP)(misc_templateObject170 || (misc_templateObject170 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience) throw "Lost training in cake-shaped arena";
    debug("Experience gained: ".concat((0,template_string/* $familiar */.HP)(misc_templateObject171 || (misc_templateObject171 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience - start_exp));
  }
}
...
var pulls = [// Always pull the key items first
{
  ...
  useful: () => {
    if ((0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(pulls_templateObject2 || (pulls_templateObject2 = pulls_taggedTemplateLiteral(["asbestos ore"])))) >= 3 && (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(pulls_templateObject3 || (pulls_templateObject3 = pulls_taggedTemplateLiteral(["linoleum ore"])))) >= 3 && (0,external_kolmafia_.itemAmount)((0,template_string/* $item */.xr)(pulls_templateObject4 || (pulls_templateObject4 = pulls_taggedTemplateLiteral(["chrome ore"])))) >= 3) return false;
    if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject5 || (pulls_templateObject5 = pulls_taggedTemplateLiteral(["Deck of Every Card"]))))) return false;
  ...
  pull: (0,template_string/* $item */.xr)(pulls_templateObject6 || (pulls_templateObject6 = pulls_taggedTemplateLiteral(["1,970 carat gold"]))),
  useful: () => {
    if ((0,external_kolmafia_.myMeat)() < 200 && step("questM05Toot") > 0 && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject7 || (pulls_templateObject7 = pulls_taggedTemplateLiteral(["letter from King Ralph XI"]))))) return true;
    if ((0,external_kolmafia_.myMeat)() < 4000 && step("questL11Black") === 2 && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject8 || (pulls_templateObject8 = pulls_taggedTemplateLiteral(["forged identification documents"]))))) return true;
    if ((0,lib/* have */.lf)((0,template_string/* $skill */.tm)(pulls_templateObject9 || (pulls_templateObject9 = pulls_taggedTemplateLiteral(["System Sweep"])))) && (0,lib/* have */.lf)((0,template_string/* $skill */.tm)(pulls_templateObject10 || (pulls_templateObject10 = pulls_taggedTemplateLiteral(["Double Nanovision"]))))) return false; // early run is over

    return undefined;
  }
}, {
  pull: (0,template_string/* $items */.vS)(pulls_templateObject11 || (pulls_templateObject11 = pulls_taggedTemplateLiteral(["Greatest American Pants, navel ring of navel gazing"]))),
  optional: true,
  name: "Runaway IoTM"
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject12 || (pulls_templateObject12 = pulls_taggedTemplateLiteral(["ring of conflict"]))),
  // Last chance for -5% combat frequency
  useful: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject13 || (pulls_templateObject13 = pulls_taggedTemplateLiteral(["unbreakable umbrella"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject14 || (pulls_templateObject14 = pulls_taggedTemplateLiteral(["Space Trip safety headphones"])))) && (0,external_kolmafia_.storageAmount)((0,template_string/* $item */.xr)(pulls_templateObject15 || (pulls_templateObject15 = pulls_taggedTemplateLiteral(["Space Trip safety headphones"])))) === 0 && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject16 || (pulls_templateObject16 = pulls_taggedTemplateLiteral(["protonic accelerator pack"]))))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject17 || (pulls_templateObject17 = pulls_taggedTemplateLiteral(["white page"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject18 || (pulls_templateObject18 = pulls_taggedTemplateLiteral(["portable cassette player"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject19 || (pulls_templateObject19 = pulls_taggedTemplateLiteral(["antique machete"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject20 || (pulls_templateObject20 = pulls_taggedTemplateLiteral(["book of matches"])))
}, {
  pull: (0,template_string/* $items */.vS)(pulls_templateObject21 || (pulls_templateObject21 = pulls_taggedTemplateLiteral(["Space Trip safety headphones, HOA regulation book"]))),
  name: "-ML",
  optional: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject22 || (pulls_templateObject22 = pulls_taggedTemplateLiteral(["yule hatchet"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject23 || (pulls_templateObject23 = pulls_taggedTemplateLiteral(["grey down vest"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject24 || (pulls_templateObject24 = pulls_taggedTemplateLiteral(["teacher's pen"]))),
  duplicate: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject25 || (pulls_templateObject25 = pulls_taggedTemplateLiteral(["blackberry galoshes"]))),
  useful: () => step("questL11Black") < 2
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject26 || (pulls_templateObject26 = pulls_taggedTemplateLiteral(["killing jar"]))),
  useful: () => !(0,lib/* have */.lf)((0,template_string/* $familiar */.HP)(pulls_templateObject27 || (pulls_templateObject27 = pulls_taggedTemplateLiteral(["Melodramedary"]))))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject28 || (pulls_templateObject28 = pulls_taggedTemplateLiteral(["old patched suit-pants"]))),
  optional: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject29 || (pulls_templateObject29 = pulls_taggedTemplateLiteral(["transparent pants"]))),
  optional: true,
  useful: () => !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject30 || (pulls_templateObject30 = pulls_taggedTemplateLiteral(["designer sweatpants"]))))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject31 || (pulls_templateObject31 = pulls_taggedTemplateLiteral(["deck of lewd playing cards"]))),
  optional: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject32 || (pulls_templateObject32 = pulls_taggedTemplateLiteral(["mafia thumb ring"]))),
  optional: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject33 || (pulls_templateObject33 = pulls_taggedTemplateLiteral(["giant yellow hat"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject34 || (pulls_templateObject34 = pulls_taggedTemplateLiteral(["gravy boat"])))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject35 || (pulls_templateObject35 = pulls_taggedTemplateLiteral(["Mohawk wig"]))),
  useful: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject36 || (pulls_templateObject36 = pulls_taggedTemplateLiteral(["S.O.C.K."])))) ? !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject37 || (pulls_templateObject37 = pulls_taggedTemplateLiteral(["Mohawk wig"])))) : undefined // if one didn't drop naturally

}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject38 || (pulls_templateObject38 = pulls_taggedTemplateLiteral(["11-leaf clover"]))),
  duplicate: true
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject39 || (pulls_templateObject39 = pulls_taggedTemplateLiteral(["wet stew"]))),
  useful: () => step("questL11Palindome") < 5 && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject40 || (pulls_templateObject40 = pulls_taggedTemplateLiteral(["wet stunt nut stew"])))) && !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject41 || (pulls_templateObject41 = pulls_taggedTemplateLiteral(["wet stew"])))) && (!(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject42 || (pulls_templateObject42 = pulls_taggedTemplateLiteral(["lion oil"])))) || !(0,lib/* have */.lf)((0,template_string/* $item */.xr)(pulls_templateObject43 || (pulls_templateObject43 = pulls_taggedTemplateLiteral(["bird rib"])))))
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject44 || (pulls_templateObject44 = pulls_taggedTemplateLiteral(["ninja rope"]))),
  useful: () => step("questL08Trapper") < 3 && step("questL11Shen") > 3
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject45 || (pulls_templateObject45 = pulls_taggedTemplateLiteral(["ninja carabiner"]))),
  useful: () => step("questL08Trapper") < 3 && step("questL11Shen") > 3
}, {
  pull: (0,template_string/* $item */.xr)(pulls_templateObject46 || (pulls_templateObject46 = pulls_taggedTemplateLiteral(["ninja crampons"]))),
  useful: () => step("questL08Trapper") < 3 && step("questL11Shen") > 3
}];

var Pull = /*#__PURE__*/function () {
  function Pull(spec) {
    var _spec$duplicate, _spec$optional, _spec$useful;
    ...
    value: function wasPulled(pulled) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (!this.duplicate && (0,lib/* have */.lf)(item)) return true;
...
var PullStrategy = /*#__PURE__*/function () {
  ...
  pulls_createClass(PullStrategy, [{
    ...
    value: function update() {
      var pulled = new Set((0,property/* get */.U2)("_roninStoragePulls").split(",").map(id => parseInt(id)).filter(id => id > 0).map(id => external_kolmafia_.Item.get(id)));
      var count = (0,external_kolmafia_.pullsRemaining)() - (20 - args.pulls);
...
function buildIotmList() {
  return [{
    ...
    thing: (0,template_string/* $item */.xr)(sim_templateObject18 || (sim_templateObject18 = sim_taggedTemplateLiteral(["miniature crystal ball"]))),
    why: "Monster prediction",
    optional: true
  }, {
    thing: (0,template_string/* $item */.xr)(sim_templateObject19 || (sim_templateObject19 = sim_taggedTemplateLiteral(["unbreakable umbrella"]))),
    why: "-combat modifier, ML",
    optional: true
  }, {
    thing: new Hardcoded((0,lib/* have */.lf)((0,template_string/* $item */.xr)(sim_templateObject20 || (sim_templateObject20 = sim_taggedTemplateLiteral(["cosmic bowling ball"])))) || (0,property/* get */.U2)("cosmicBowlingBallReturnCombats", -1) >= 0, "Cosmic bowling ball"),
    why: "Banishes, Pygmy killing",
    optional: true
  }, {
    thing: (0,template_string/* $familiar */.HP)(sim_templateObject21 || (sim_templateObject21 = sim_taggedTemplateLiteral(["Vampire Vintner"]))),
    why: "Pygmy killing",
    optional: true
  }, {
    thing: (0,template_string/* $skill */.tm)(sim_templateObject22 || (sim_templateObject22 = sim_taggedTemplateLiteral(["Summon Clip Art"]))),
    why: "Amulet coin",
    optional: true
  }, {
    ...
    thing: (0,template_string/* $item */.xr)(sim_templateObject23 || (sim_templateObject23 = sim_taggedTemplateLiteral(["SongBoom\u2122 BoomBox"]))),
    why: "Meat and special seasonings",
    optional: true
  }, {
    thing: (0,template_string/* $item */.xr)(sim_templateObject24 || (sim_templateObject24 = sim_taggedTemplateLiteral(["hewn moon-rune spoon"]))),
    ...
    thing: (0,template_string/* $item */.xr)(sim_templateObject25 || (sim_templateObject25 = sim_taggedTemplateLiteral(["June cleaver"]))),
    why: "Cold damage, QoL, sometimes +famexp and +adv",
    optional: true
  }, {
    thing: (0,template_string/* $item */.xr)(sim_templateObject26 || (sim_templateObject26 = sim_taggedTemplateLiteral(["designer sweatpants"]))),
    why: "Sleaze damage",
    optional: true
  }];
}
...
function buildLocketList() {
  return [{
    thing: (0,template_string/* $monster */.O4)(sim_templateObject27 || (sim_templateObject27 = sim_taggedTemplateLiteral(["pygmy witch lawyer"]))),
    why: "Infinite Loop",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject28 || (sim_templateObject28 = sim_taggedTemplateLiteral(["mountain man"]))),
    why: "Ore",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject29 || (sim_templateObject29 = sim_taggedTemplateLiteral(["One-Eyed Willie"]))),
    why: "Absorbing adventures",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject30 || (sim_templateObject30 = sim_taggedTemplateLiteral(["Little Man in the Canoe"]))),
    why: "Absorbing adventures",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject31 || (sim_templateObject31 = sim_taggedTemplateLiteral(["revolving bugbear"]))),
    why: "Absorbing adventures",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject32 || (sim_templateObject32 = sim_taggedTemplateLiteral(["cloud of disembodied whiskers"]))),
    why: "Absorbing adventures",
    optional: true
  }, {
    thing: (0,template_string/* $monster */.O4)(sim_templateObject33 || (sim_templateObject33 = sim_taggedTemplateLiteral(["vicious gnauga"]))),
    why: "Absorbing adventures",
    optional: true
  }];
}
...
function buildMiscList() {
  return [{
    thing: (0,template_string/* $familiar */.HP)(sim_templateObject34 || (sim_templateObject34 = sim_taggedTemplateLiteral(["Oily Woim"]))),
    why: "Bonus initiative",
    optional: true
  }, {
    thing: (0,template_string/* $familiar */.HP)(sim_templateObject35 || (sim_templateObject35 = sim_taggedTemplateLiteral(["Hobo Monkey"]))),
    why: "Meat drops",
    optional: true
  }, {
    thing: (0,template_string/* $familiar */.HP)(sim_templateObject36 || (sim_templateObject36 = sim_taggedTemplateLiteral(["Cornbeefadon"]))),
    why: "Amulet coin, with clip art",
    optional: true
  }, {
    thing: (0,template_string/* $items */.vS)(sim_templateObject37 || (sim_templateObject37 = sim_taggedTemplateLiteral(["Great Wolf's rocket launcher, Drunkula's bell"]))),
...
function main(command) {
  ...
  var engine = new Engine(tasks, (_args$ignoretasks$spl = (_args$ignoretasks = args.ignoretasks) === null || _args$ignoretasks === void 0 ? void 0 : _args$ignoretasks.split(",")) !== null && _args$ignoretasks$spl !== void 0 ? _args$ignoretasks$spl : [], (_args$completedtasks$ = (_args$completedtasks = args.completedtasks) === null || _args$completedtasks === void 0 ? void 0 : _args$completedtasks.split(",")) !== null && _args$completedtasks$ !== void 0 ? _args$completedtasks$ : []);
  ...
  try {
    ...
    while ((0,external_kolmafia_.myAdventures)() > 0) {
      ...
      summonStrategy.update(_state2); // Update summon plan with current state
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 3685);
