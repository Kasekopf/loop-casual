...
var WandQuest = {
  ...
  tasks: [{
    name: "Plus Sign",
    after: [],
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject127 || (misc_templateObject127 = misc_taggedTemplateLiteral(["plus sign"])))) || (0,property/* get */.U2)("lastPlusSignUnlock") === (0,external_kolmafia_.myAscensions)(),
    do: (0,template_string/* $location */.PG)(misc_templateObject128 || (misc_templateObject128 = misc_taggedTemplateLiteral(["The Enormous Greater-Than Sign"]))),
    outfit: {
      modifier: "-combat"
    },
    choices: {
    ...
    (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject129 || (misc_templateObject129 = misc_taggedTemplateLiteral(["Grey Goose"])))) >= 6 && // Goose exp for potential absorbs during teleportits
    (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject130 || (misc_templateObject130 = misc_taggedTemplateLiteral(["soft green echo eyedrop antidote"])))),
    // Antitdote to remove teleportitis afterwards
    priority: () => (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject131 || (misc_templateObject131 = misc_taggedTemplateLiteral(["Grey Goose"])))) >= 6 ? OverridePriority.GoodGoose : OverridePriority.None,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject132 || (misc_templateObject132 = misc_taggedTemplateLiteral(["Teleportitis"])))) || (0,property/* get */.U2)("lastPlusSignUnlock") === (0,external_kolmafia_.myAscensions)(),
    do: (0,template_string/* $location */.PG)(misc_templateObject133 || (misc_templateObject133 = misc_taggedTemplateLiteral(["The Enormous Greater-Than Sign"]))),
    outfit: {
      modifier: "-combat"
    },
    choices: {
    ...
    ready: () => (0,external_kolmafia_.myMeat)() >= 5000,
    completed: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject134 || (misc_templateObject134 = misc_taggedTemplateLiteral(["dead mimic"])))) || (0,property/* get */.U2)("lastZapperWand") === (0,external_kolmafia_.myAscensions)() || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject135 || (misc_templateObject135 = misc_taggedTemplateLiteral(["aluminum wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject136 || (misc_templateObject136 = misc_taggedTemplateLiteral(["ebony wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject137 || (misc_templateObject137 = misc_taggedTemplateLiteral(["hexagonal wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject138 || (misc_templateObject138 = misc_taggedTemplateLiteral(["marble wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject139 || (misc_templateObject139 = misc_taggedTemplateLiteral(["pine wand"])))) || keyStrategy.useful(Keys.ZapBoris) === false && keyStrategy.useful(Keys.ZapJarlsberg) === false && keyStrategy.useful(Keys.ZapSneaky) === false,
    prepare: () => {
      if ((0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject140 || (misc_templateObject140 = misc_taggedTemplateLiteral(["plus sign"]))))) (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject141 || (misc_templateObject141 = misc_taggedTemplateLiteral(["plus sign"]))));
    },
    do: (0,template_string/* $location */.PG)(misc_templateObject142 || (misc_templateObject142 = misc_taggedTemplateLiteral(["The Dungeons of Doom"]))),
    outfit: {
      modifier: "-combat, init",
      familiar: (0,template_string/* $familiar */.HP)(misc_templateObject143 || (misc_templateObject143 = misc_taggedTemplateLiteral(["Grey Goose"])))
    },
    combat: (misc_CombatStrategy$banis = new src_combat.CombatStrategy().banish((0,template_string/* $monster */.O4)(misc_templateObject144 || (misc_templateObject144 = misc_taggedTemplateLiteral(["Quantum Mechanic"]))))).kill.apply(misc_CombatStrategy$banis, misc_toConsumableArray((0,template_string/* $monsters */.fr)(misc_templateObject145 || (misc_templateObject145 = misc_taggedTemplateLiteral(["mimic, The Master Of Thieves"]))))),
    ...
    name: "Wand",
    after: ["Mimic"],
    completed: () => (0,property/* get */.U2)("lastZapperWand") === (0,external_kolmafia_.myAscensions)() || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject146 || (misc_templateObject146 = misc_taggedTemplateLiteral(["aluminum wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject147 || (misc_templateObject147 = misc_taggedTemplateLiteral(["ebony wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject148 || (misc_templateObject148 = misc_taggedTemplateLiteral(["hexagonal wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject149 || (misc_templateObject149 = misc_taggedTemplateLiteral(["marble wand"])))) || (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject150 || (misc_templateObject150 = misc_taggedTemplateLiteral(["pine wand"])))) || keyStrategy.useful(Keys.ZapBoris) === false && keyStrategy.useful(Keys.ZapJarlsberg) === false && keyStrategy.useful(Keys.ZapSneaky) === false,
    do: () => (0,external_kolmafia_.use)((0,template_string/* $item */.xr)(misc_templateObject151 || (misc_templateObject151 = misc_taggedTemplateLiteral(["dead mimic"])))),
    freeaction: true,
    limit: {
      tries: 1
    }
...
function teleportitisTask(engine, tasks, state) {
  ...
  return {
    ...
    ready: () => (0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject152 || (misc_templateObject152 = misc_taggedTemplateLiteral(["Teleportitis"])))),
    completed: () => (0,property/* get */.U2)("lastPlusSignUnlock") === (0,external_kolmafia_.myAscensions)(),
    do: (0,template_string/* $location */.PG)(misc_templateObject153 || (misc_templateObject153 = misc_taggedTemplateLiteral(["The Enormous Greater-Than Sign"]))),
    post: () => {
    ...
    outfit: {
      equip: (0,template_string/* $items */.vS)(misc_templateObject154 || (misc_templateObject154 = misc_taggedTemplateLiteral(["antique machete"])))
    },
    choices: choices,
    limit: {
      soft: 20
...
var removeTeleportitis = {
  ...
  after: [],
  ready: () => (0,lib/* have */.lf)((0,template_string/* $item */.xr)(misc_templateObject155 || (misc_templateObject155 = misc_taggedTemplateLiteral(["soft green echo eyedrop antidote"])))),
  completed: () => !(0,lib/* have */.lf)((0,template_string/* $effect */._G)(misc_templateObject156 || (misc_templateObject156 = misc_taggedTemplateLiteral(["Teleportitis"])))),
  do: () => {
    (0,lib/* uneffect */.Lo)((0,template_string/* $effect */._G)(misc_templateObject157 || (misc_templateObject157 = misc_taggedTemplateLiteral(["Teleportitis"]))));
  },
  limit: {
    soft: 2
  },
...
var houseFamiliars = new Map([[(0,template_string/* $familiar */.HP)(misc_templateObject158 || (misc_templateObject158 = misc_taggedTemplateLiteral(["Angry Goat"]))), [3, 0, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject159 || (misc_templateObject159 = misc_taggedTemplateLiteral(["Baby Gravy Fairy"]))), [0, 3, 1, 2]], // mafia and wiki disagree
[(0,template_string/* $familiar */.HP)(misc_templateObject160 || (misc_templateObject160 = misc_taggedTemplateLiteral(["Barrrnacle"]))), [0, 2, 1, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject161 || (misc_templateObject161 = misc_taggedTemplateLiteral(["Blood-Faced Volleyball"]))), [0, 1, 3, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject162 || (misc_templateObject162 = misc_taggedTemplateLiteral(["Clockwork Grapefruit"]))), [3, 2, 0, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject163 || (misc_templateObject163 = misc_taggedTemplateLiteral(["Cocoabo"]))), [2, 3, 0, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject164 || (misc_templateObject164 = misc_taggedTemplateLiteral(["Fuzzy Dice"]))), [2, 2, 2, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject165 || (misc_templateObject165 = misc_taggedTemplateLiteral(["Ghuol Whelp"]))), [1, 2, 0, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject166 || (misc_templateObject166 = misc_taggedTemplateLiteral(["Grue"]))), [2, 0, 1, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject167 || (misc_templateObject167 = misc_taggedTemplateLiteral(["Hanukkimbo Dreidl"]))), [2, 1, 3, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject168 || (misc_templateObject168 = misc_taggedTemplateLiteral(["Hovering Sombrero"]))), [0, 3, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject169 || (misc_templateObject169 = misc_taggedTemplateLiteral(["Howling Balloon Monkey"]))), [1, 3, 2, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject170 || (misc_templateObject170 = misc_taggedTemplateLiteral(["Killer Bee"]))), [3, 1, 2, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject171 || (misc_templateObject171 = misc_taggedTemplateLiteral(["Leprechaun"]))), [1, 3, 0, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject172 || (misc_templateObject172 = misc_taggedTemplateLiteral(["Levitating Potato"]))), [0, 1, 2, 3]], [(0,template_string/* $familiar */.HP)(misc_templateObject173 || (misc_templateObject173 = misc_taggedTemplateLiteral(["MagiMechTech MicroMechaMech"]))), [3, 0, 1, 2]], [(0,template_string/* $familiar */.HP)(misc_templateObject174 || (misc_templateObject174 = misc_taggedTemplateLiteral(["Mosquito"]))), [2, 1, 3, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject175 || (misc_templateObject175 = misc_taggedTemplateLiteral(["Sabre-Toothed Lime"]))), [3, 0, 2, 1]], [(0,template_string/* $familiar */.HP)(misc_templateObject176 || (misc_templateObject176 = misc_taggedTemplateLiteral(["Spooky Pirate Skeleton"]))), [2, 3, 1, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject177 || (misc_templateObject177 = misc_taggedTemplateLiteral(["Stab Bat"]))), [3, 2, 1, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject178 || (misc_templateObject178 = misc_taggedTemplateLiteral(["Star Starfish"]))), [2, 1, 3, 0]], [(0,template_string/* $familiar */.HP)(misc_templateObject179 || (misc_templateObject179 = misc_taggedTemplateLiteral(["Whirling Maple Leaf"]))), [3, 1, 2, 0]], // Along with our non-house familiar
[(0,template_string/* $familiar */.HP)(misc_templateObject180 || (misc_templateObject180 = misc_taggedTemplateLiteral(["Grey Goose"]))), [1, 2, 3, 3]]]);
...
function arenaFight() {
  ...
  do {
    ...
    if (match) {
      ...
      if (Number.isNaN(opponent) || Number.isNaN(weight) || weight === 0 || familiar === (0,template_string/* $familiar */.HP)(misc_templateObject181 || (misc_templateObject181 = misc_taggedTemplateLiteral(["none"])))) {
      ...
      for (var _i = 0, _arr = [1, 2, 3, 4]; _i < _arr.length; _i++) {
        ...
        options.push({
          ...
          familiar: familiar,
          event: event,
          delta: arenaStrength((0,template_string/* $familiar */.HP)(misc_templateObject182 || (misc_templateObject182 = misc_taggedTemplateLiteral(["Grey Goose"]))), (0,external_kolmafia_.familiarWeight)((0,template_string/* $familiar */.HP)(misc_templateObject183 || (misc_templateObject183 = misc_taggedTemplateLiteral(["Grey Goose"])))) + (0,external_kolmafia_.weightAdjustment)(), event) - arenaStrength(familiar, weight, event)
        });
      }
    }
  ...
  if (bestOption === undefined) {
    ...
    var start_exp = (0,template_string/* $familiar */.HP)(misc_templateObject184 || (misc_templateObject184 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience;
    (0,external_kolmafia_.visitUrl)("arena.php?action=go&whichopp=".concat(bestOption.opponent, "&event=").concat(bestOption.event), true);
    if (start_exp === (0,template_string/* $familiar */.HP)(misc_templateObject185 || (misc_templateObject185 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience) throw "Lost training in cake-shaped arena";
    debug("Experience gained: ".concat((0,template_string/* $familiar */.HP)(misc_templateObject186 || (misc_templateObject186 = misc_taggedTemplateLiteral(["Grey Goose"]))).experience - start_exp));
  }
}
